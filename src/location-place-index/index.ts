// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/location_place_index
...
export class LocationPlaceIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationPlaceIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/location_place_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/location_place_index aws_location_place_index} Resource
  *
  * @param scope The scope in which to define this construct
