...
// https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/vpclattice_listener
...
export class VpclatticeListener extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/vpclattice_listener#import import section} in the documentation of this resource for the id to use
