// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/qldb_stream
...
export class QldbStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QldbStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/qldb_stream#import import section} in the documentation of this resource for the id to use
