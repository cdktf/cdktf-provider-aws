// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/controltower_landing_zone
...
export class ControltowerLandingZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ControltowerLandingZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/controltower_landing_zone#import import section} in the documentation of this resource for the id to use
