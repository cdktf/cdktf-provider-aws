// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/quicksight_account_subscription
...
export class QuicksightAccountSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightAccountSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/quicksight_account_subscription#import import section} in the documentation of this resource for the id to use
