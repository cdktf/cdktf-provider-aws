...
// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/globalaccelerator_accelerator
...
export class DataAwsGlobalacceleratorAccelerator extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlobalacceleratorAccelerator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/globalaccelerator_accelerator#import import section} in the documentation of this resource for the id to use
