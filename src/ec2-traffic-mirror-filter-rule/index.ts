// https://registry.terraform.io/providers/hashicorp/aws/5.42.0/docs/resources/ec2_traffic_mirror_filter_rule
...
export class Ec2TrafficMirrorFilterRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2TrafficMirrorFilterRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.42.0/docs/resources/ec2_traffic_mirror_filter_rule#import import section} in the documentation of this resource for the id to use
