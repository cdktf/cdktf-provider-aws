...
// https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/ebs_snapshot_import
...
export class EbsSnapshotImport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsSnapshotImport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/ebs_snapshot_import#import import section} in the documentation of this resource for the id to use
