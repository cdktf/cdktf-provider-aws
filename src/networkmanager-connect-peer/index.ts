...
// https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/networkmanager_connect_peer
...
export class NetworkmanagerConnectPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerConnectPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/networkmanager_connect_peer#import import section} in the documentation of this resource for the id to use
