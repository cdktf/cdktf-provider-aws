...
export interface OpsworksMemcachedLayerConfig extends TerraformMetaArguments {
...
export class OpsworksMemcachedLayer extends TerraformResource {
  ...
  public synthesizeAttributes(): { [name: string]: any } {
    return {
      allocated_memory: this._allocatedMemory,
