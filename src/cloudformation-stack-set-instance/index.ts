// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/cloudformation_stack_set_instance
...
export class CloudformationStackSetInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudformationStackSetInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/cloudformation_stack_set_instance#import import section} in the documentation of this resource for the id to use
