// https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/data-sources/servicecatalog_launch_paths
...
export class DataAwsServicecatalogLaunchPaths extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsServicecatalogLaunchPaths that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/data-sources/servicecatalog_launch_paths#import import section} in the documentation of this resource for the id to use
