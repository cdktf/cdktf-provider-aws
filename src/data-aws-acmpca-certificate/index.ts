// https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/acmpca_certificate
...
export class DataAwsAcmpcaCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAcmpcaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/data-sources/acmpca_certificate#import import section} in the documentation of this resource for the id to use
