// https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/devicefarm_device_pool
...
export class DevicefarmDevicePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevicefarmDevicePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/devicefarm_device_pool#import import section} in the documentation of this resource for the id to use
