// https://registry.terraform.io/providers/hashicorp/aws/5.27.0/docs/resources/ssm_maintenance_window_task
...
export class SsmMaintenanceWindowTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmMaintenanceWindowTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.27.0/docs/resources/ssm_maintenance_window_task#import import section} in the documentation of this resource for the id to use
