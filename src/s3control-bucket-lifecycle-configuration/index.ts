// https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/s3control_bucket_lifecycle_configuration
...
export class S3ControlBucketLifecycleConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlBucketLifecycleConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/s3control_bucket_lifecycle_configuration#import import section} in the documentation of this resource for the id to use
