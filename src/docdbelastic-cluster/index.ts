...
// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/docdbelastic_cluster
...
export class DocdbelasticCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbelasticCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/docdbelastic_cluster#import import section} in the documentation of this resource for the id to use
