// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/efs_mount_target
...
export class EfsMountTarget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EfsMountTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/efs_mount_target#import import section} in the documentation of this resource for the id to use
