...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/pinpoint_apns_voip_sandbox_channel
...
export class PinpointApnsVoipSandboxChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointApnsVoipSandboxChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/pinpoint_apns_voip_sandbox_channel#import import section} in the documentation of this resource for the id to use
