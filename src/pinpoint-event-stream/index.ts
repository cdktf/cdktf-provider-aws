// https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/pinpoint_event_stream
...
export class PinpointEventStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointEventStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/pinpoint_event_stream#import import section} in the documentation of this resource for the id to use
