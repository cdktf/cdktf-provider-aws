...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/storagegateway_smb_file_share
...
export class StoragegatewaySmbFileShare extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StoragegatewaySmbFileShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/storagegateway_smb_file_share#import import section} in the documentation of this resource for the id to use
