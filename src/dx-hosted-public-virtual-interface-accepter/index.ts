// https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/dx_hosted_public_virtual_interface_accepter
...
export class DxHostedPublicVirtualInterfaceAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxHostedPublicVirtualInterfaceAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/dx_hosted_public_virtual_interface_accepter#import import section} in the documentation of this resource for the id to use
