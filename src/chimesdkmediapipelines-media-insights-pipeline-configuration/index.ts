// https://www.terraform.io/docs/providers/aws/r/chimesdkmediapipelines_media_insights_pipeline_configuration
...
export function chimesdkmediapipelinesMediaInsightsPipelineConfigurationTimeoutsToTerraform(struct?: ChimesdkmediapipelinesMediaInsightsPipelineConfigurationTimeoutsOutputReference | ChimesdkmediapipelinesMediaInsightsPipelineConfigurationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
