// https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/lex_bot_alias
...
export class LexBotAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LexBotAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/lex_bot_alias#import import section} in the documentation of this resource for the id to use
