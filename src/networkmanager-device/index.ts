...
// https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/networkmanager_device
...
export class NetworkmanagerDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/networkmanager_device#import import section} in the documentation of this resource for the id to use
