...
// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/data-sources/ssmcontacts_contact_channel
...
export class DataAwsSsmcontactsContactChannel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsmcontactsContactChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/data-sources/ssmcontacts_contact_channel#import import section} in the documentation of this resource for the id to use
