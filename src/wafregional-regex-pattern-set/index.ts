...
// https://registry.terraform.io/providers/hashicorp/aws/5.36.0/docs/resources/wafregional_regex_pattern_set
...
export class WafregionalRegexPatternSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalRegexPatternSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.36.0/docs/resources/wafregional_regex_pattern_set#import import section} in the documentation of this resource for the id to use
