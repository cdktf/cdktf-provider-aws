// https://registry.terraform.io/providers/hashicorp/aws/5.47.0/docs/resources/verifiedpermissions_policy_template
...
export class VerifiedpermissionsPolicyTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedpermissionsPolicyTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.47.0/docs/resources/verifiedpermissions_policy_template#import import section} in the documentation of this resource for the id to use
