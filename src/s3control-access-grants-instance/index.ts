// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/s3control_access_grants_instance
...
export class S3ControlAccessGrantsInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlAccessGrantsInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/s3control_access_grants_instance#import import section} in the documentation of this resource for the id to use
