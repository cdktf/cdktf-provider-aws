// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/detective_invitation_accepter
...
export class DetectiveInvitationAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DetectiveInvitationAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/detective_invitation_accepter#import import section} in the documentation of this resource for the id to use
