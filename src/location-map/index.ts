// https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/resources/location_map
...
export class LocationMap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/resources/location_map#import import section} in the documentation of this resource for the id to use
