// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/placement_group
...
export class PlacementGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlacementGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/placement_group#import import section} in the documentation of this resource for the id to use
