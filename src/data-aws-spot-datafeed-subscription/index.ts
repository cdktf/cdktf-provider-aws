...
// https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/data-sources/spot_datafeed_subscription
...
export class DataAwsSpotDatafeedSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSpotDatafeedSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/data-sources/spot_datafeed_subscription#import import section} in the documentation of this resource for the id to use
