// https://registry.terraform.io/providers/hashicorp/aws/5.61.0/docs/resources/codedeploy_deployment_group
...
export class CodedeployDeploymentGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodedeployDeploymentGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.61.0/docs/resources/codedeploy_deployment_group#import import section} in the documentation of this resource for the id to use
