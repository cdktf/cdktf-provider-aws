...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/ram_resource_share_accepter
...
export class RamResourceShareAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RamResourceShareAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/ram_resource_share_accepter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/ram_resource_share_accepter aws_ram_resource_share_accepter} Resource
  *
  * @param scope The scope in which to define this construct
