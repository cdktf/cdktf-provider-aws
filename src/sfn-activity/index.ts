...
// https://registry.terraform.io/providers/hashicorp/aws/5.74.0/docs/resources/sfn_activity
...
export class SfnActivity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SfnActivity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.74.0/docs/resources/sfn_activity#import import section} in the documentation of this resource for the id to use
