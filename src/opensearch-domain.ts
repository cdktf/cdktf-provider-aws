...
export class OpensearchDomainAutoTuneOptionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _maintenanceSchedule?: OpensearchDomainAutoTuneOptionsMaintenanceSchedule[] | cdktf.IResolvable; 
  ...
  public set maintenanceSchedule(value: OpensearchDomainAutoTuneOptionsMaintenanceSchedule[] | cdktf.IResolvable) {
...
export class OpensearchDomainTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OpensearchDomainTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: OpensearchDomainTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class OpensearchDomain extends cdktf.TerraformResource {
  ...
  */
  ...
  private _logPublishingOptions?: OpensearchDomainLogPublishingOptions[] | cdktf.IResolvable; 
  ...
  public set logPublishingOptions(value: OpensearchDomainLogPublishingOptions[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      log_publishing_options: cdktf.listMapper(opensearchDomainLogPublishingOptionsToTerraform)(this._logPublishingOptions),
