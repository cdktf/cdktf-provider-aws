// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/data-sources/ssm_parameters_by_path
...
export class DataAwsSsmParametersByPath extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsmParametersByPath that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/data-sources/ssm_parameters_by_path#import import section} in the documentation of this resource for the id to use
