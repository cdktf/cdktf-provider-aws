...
// https://registry.terraform.io/providers/hashicorp/aws/5.86.1/docs/resources/prometheus_scraper
...
export class PrometheusScraper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrometheusScraper that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.1/docs/resources/prometheus_scraper#import import section} in the documentation of this resource for the id to use
