// https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/data-sources/db_instances
...
export class DataAwsDbInstances extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDbInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/data-sources/db_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/data-sources/db_instances aws_db_instances} Data Source
  *
  * @param scope The scope in which to define this construct
