...
export class RdsGlobalClusterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RdsGlobalClusterTimeouts | undefined {
  ...
  public set internalValue(value: RdsGlobalClusterTimeouts | undefined) {
    if (value === undefined) {
...
export class RdsGlobalCluster extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new RdsGlobalClusterTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
