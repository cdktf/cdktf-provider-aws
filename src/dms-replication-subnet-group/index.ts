// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/dms_replication_subnet_group
...
export class DmsReplicationSubnetGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsReplicationSubnetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/dms_replication_subnet_group#import import section} in the documentation of this resource for the id to use
