...
// https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/ssmcontacts_rotation
...
export class SsmcontactsRotation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmcontactsRotation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/ssmcontacts_rotation#import import section} in the documentation of this resource for the id to use
