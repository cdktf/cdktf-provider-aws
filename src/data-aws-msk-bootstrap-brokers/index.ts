...
// https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/msk_bootstrap_brokers
...
export class DataAwsMskBootstrapBrokers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMskBootstrapBrokers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/msk_bootstrap_brokers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/msk_bootstrap_brokers aws_msk_bootstrap_brokers} Data Source
  *
  * @param scope The scope in which to define this construct
