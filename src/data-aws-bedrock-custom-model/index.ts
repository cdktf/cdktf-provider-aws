...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/data-sources/bedrock_custom_model
...
export class DataAwsBedrockCustomModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBedrockCustomModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/data-sources/bedrock_custom_model#import import section} in the documentation of this resource for the id to use
