// https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/data-sources/vpc_security_group_rules
...
export class DataAwsVpcSecurityGroupRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcSecurityGroupRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/data-sources/vpc_security_group_rules#import import section} in the documentation of this resource for the id to use
