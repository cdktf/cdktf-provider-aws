...
// https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/quicksight_user
...
export class DataAwsQuicksightUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsQuicksightUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/quicksight_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/quicksight_user aws_quicksight_user} Data Source
  *
  * @param scope The scope in which to define this construct
