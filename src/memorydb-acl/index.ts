...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/memorydb_acl
...
export class MemorydbAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MemorydbAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/memorydb_acl#import import section} in the documentation of this resource for the id to use
