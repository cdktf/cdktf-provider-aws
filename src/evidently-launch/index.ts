...
// https://registry.terraform.io/providers/hashicorp/aws/5.65.0/docs/resources/evidently_launch
...
export class EvidentlyLaunch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EvidentlyLaunch that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.65.0/docs/resources/evidently_launch#import import section} in the documentation of this resource for the id to use
