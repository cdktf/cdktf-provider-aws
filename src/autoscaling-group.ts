...
export class AutoscalingGroup extends TerraformResource {
  ...
  public set instanceRefresh(value: AutoscalingGroupInstanceRefresh[] | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      capacity_rebalance: this._capacityRebalance,
      ...
      instance_refresh: this._instanceRefresh,
