...
// https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/route53_records_exclusive
...
export class Route53RecordsExclusive extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53RecordsExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/route53_records_exclusive#import import section} in the documentation of this resource for the id to use
