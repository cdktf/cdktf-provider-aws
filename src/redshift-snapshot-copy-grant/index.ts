// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/redshift_snapshot_copy_grant
...
export class RedshiftSnapshotCopyGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftSnapshotCopyGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/redshift_snapshot_copy_grant#import import section} in the documentation of this resource for the id to use
