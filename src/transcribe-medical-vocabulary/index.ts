// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/transcribe_medical_vocabulary
...
export class TranscribeMedicalVocabulary extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TranscribeMedicalVocabulary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/transcribe_medical_vocabulary#import import section} in the documentation of this resource for the id to use
