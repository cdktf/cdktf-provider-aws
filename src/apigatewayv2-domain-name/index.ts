...
// https://registry.terraform.io/providers/hashicorp/aws/5.56.1/docs/resources/apigatewayv2_domain_name
...
export class Apigatewayv2DomainName extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Apigatewayv2DomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.1/docs/resources/apigatewayv2_domain_name#import import section} in the documentation of this resource for the id to use
