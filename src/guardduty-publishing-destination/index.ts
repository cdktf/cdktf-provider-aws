// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/guardduty_publishing_destination
...
export class GuarddutyPublishingDestination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyPublishingDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/guardduty_publishing_destination#import import section} in the documentation of this resource for the id to use
