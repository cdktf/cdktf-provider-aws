// https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/auditmanager_control
...
export class AuditmanagerControl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditmanagerControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/auditmanager_control#import import section} in the documentation of this resource for the id to use
