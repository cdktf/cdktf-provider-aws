// https://registry.terraform.io/providers/hashicorp/aws/5.63.1/docs/resources/lightsail_domain_entry
...
export class LightsailDomainEntry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailDomainEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.1/docs/resources/lightsail_domain_entry#import import section} in the documentation of this resource for the id to use
