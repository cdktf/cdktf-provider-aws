...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/xray_encryption_config
...
export class XrayEncryptionConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing XrayEncryptionConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/xray_encryption_config#import import section} in the documentation of this resource for the id to use
