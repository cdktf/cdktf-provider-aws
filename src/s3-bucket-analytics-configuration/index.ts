...
// https://registry.terraform.io/providers/hashicorp/aws/5.38.0/docs/resources/s3_bucket_analytics_configuration
...
export class S3BucketAnalyticsConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketAnalyticsConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.38.0/docs/resources/s3_bucket_analytics_configuration#import import section} in the documentation of this resource for the id to use
