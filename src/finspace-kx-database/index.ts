// https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/finspace_kx_database
...
export class FinspaceKxDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FinspaceKxDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/finspace_kx_database#import import section} in the documentation of this resource for the id to use
