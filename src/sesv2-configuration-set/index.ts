...
// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/sesv2_configuration_set
...
export class Sesv2ConfigurationSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2ConfigurationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/sesv2_configuration_set#import import section} in the documentation of this resource for the id to use
