// https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/waf_geo_match_set
...
export class WafGeoMatchSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafGeoMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/waf_geo_match_set#import import section} in the documentation of this resource for the id to use
