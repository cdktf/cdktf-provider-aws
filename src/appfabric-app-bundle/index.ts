...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/appfabric_app_bundle
...
export class AppfabricAppBundle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppfabricAppBundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/appfabric_app_bundle#import import section} in the documentation of this resource for the id to use
