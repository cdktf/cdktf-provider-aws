// https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/vpc_peering_connection_accepter
...
export class VpcPeeringConnectionAccepterA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPeeringConnectionAccepterA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/vpc_peering_connection_accepter#import import section} in the documentation of this resource for the id to use
