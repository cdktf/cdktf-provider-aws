...
// https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/wafregional_web_acl
...
export class WafregionalWebAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalWebAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/wafregional_web_acl#import import section} in the documentation of this resource for the id to use
