// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/data-sources/ec2_local_gateway_route_tables
...
export class DataAwsEc2LocalGatewayRouteTables extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2LocalGatewayRouteTables that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/data-sources/ec2_local_gateway_route_tables#import import section} in the documentation of this resource for the id to use
