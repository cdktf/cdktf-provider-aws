// https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/comprehend_entity_recognizer
...
export class ComprehendEntityRecognizer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComprehendEntityRecognizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/comprehend_entity_recognizer#import import section} in the documentation of this resource for the id to use
