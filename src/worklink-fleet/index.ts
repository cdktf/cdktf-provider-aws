...
// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/worklink_fleet
...
export class WorklinkFleet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorklinkFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/worklink_fleet#import import section} in the documentation of this resource for the id to use
