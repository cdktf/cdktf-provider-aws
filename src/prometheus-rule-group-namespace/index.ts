// https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/prometheus_rule_group_namespace
...
export class PrometheusRuleGroupNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrometheusRuleGroupNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/prometheus_rule_group_namespace#import import section} in the documentation of this resource for the id to use
