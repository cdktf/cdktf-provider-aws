...
// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/iot_role_alias
...
export class IotRoleAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotRoleAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/iot_role_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/iot_role_alias aws_iot_role_alias} Resource
  *
  * @param scope The scope in which to define this construct
