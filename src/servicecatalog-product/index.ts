// https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/servicecatalog_product
...
export class ServicecatalogProduct extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicecatalogProduct that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/servicecatalog_product#import import section} in the documentation of this resource for the id to use
