...
// https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/transfer_certificate
...
export class TransferCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/transfer_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/transfer_certificate aws_transfer_certificate} Resource
  *
  * @param scope The scope in which to define this construct
