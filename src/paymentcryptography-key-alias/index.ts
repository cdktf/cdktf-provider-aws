...
// https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/paymentcryptography_key_alias
...
export class PaymentcryptographyKeyAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PaymentcryptographyKeyAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/paymentcryptography_key_alias#import import section} in the documentation of this resource for the id to use
