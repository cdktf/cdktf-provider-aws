...
// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ec2_host
...
export class DataAwsEc2Host extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2Host that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ec2_host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ec2_host aws_ec2_host} Data Source
  *
  * @param scope The scope in which to define this construct
