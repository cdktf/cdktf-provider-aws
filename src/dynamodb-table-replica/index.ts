// https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/dynamodb_table_replica
...
export class DynamodbTableReplicaA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbTableReplicaA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/dynamodb_table_replica#import import section} in the documentation of this resource for the id to use
