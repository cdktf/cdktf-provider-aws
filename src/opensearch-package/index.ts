// https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/opensearch_package
...
export class OpensearchPackage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/opensearch_package#import import section} in the documentation of this resource for the id to use
