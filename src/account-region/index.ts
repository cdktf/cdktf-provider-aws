...
// https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/account_region
...
export class AccountRegion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/account_region#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/account_region aws_account_region} Resource
  *
  * @param scope The scope in which to define this construct
