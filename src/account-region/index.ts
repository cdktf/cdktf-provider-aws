...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/account_region
...
export class AccountRegion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/account_region#import import section} in the documentation of this resource for the id to use
