// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/wafregional_sql_injection_match_set
...
export class WafregionalSqlInjectionMatchSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalSqlInjectionMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/wafregional_sql_injection_match_set#import import section} in the documentation of this resource for the id to use
