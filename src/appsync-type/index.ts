// https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/resources/appsync_type
...
export class AppsyncType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/resources/appsync_type#import import section} in the documentation of this resource for the id to use
