...
// https://registry.terraform.io/providers/hashicorp/aws/5.70.0/docs/resources/verifiedaccess_group
...
export class VerifiedaccessGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedaccessGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.70.0/docs/resources/verifiedaccess_group#import import section} in the documentation of this resource for the id to use
