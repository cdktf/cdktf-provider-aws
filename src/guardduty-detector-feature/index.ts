...
// https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/guardduty_detector_feature
...
export class GuarddutyDetectorFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyDetectorFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/guardduty_detector_feature#import import section} in the documentation of this resource for the id to use
