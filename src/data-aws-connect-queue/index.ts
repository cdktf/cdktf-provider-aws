// https://registry.terraform.io/providers/hashicorp/aws/5.86.1/docs/data-sources/connect_queue
...
export class DataAwsConnectQueue extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsConnectQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.1/docs/data-sources/connect_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.1/docs/data-sources/connect_queue aws_connect_queue} Data Source
  *
  * @param scope The scope in which to define this construct
