// https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/lambda_function_event_invoke_config
...
export class LambdaFunctionEventInvokeConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaFunctionEventInvokeConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/lambda_function_event_invoke_config#import import section} in the documentation of this resource for the id to use
