...
// https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/redshiftserverless_snapshot
...
export class RedshiftserverlessSnapshot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftserverlessSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/redshiftserverless_snapshot#import import section} in the documentation of this resource for the id to use
