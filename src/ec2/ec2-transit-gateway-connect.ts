...
export class Ec2TransitGatewayConnectTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Ec2TransitGatewayConnectTimeouts | undefined {
  ...
  public set internalValue(value: Ec2TransitGatewayConnectTimeouts | undefined) {
    if (value === undefined) {
...
export class Ec2TransitGatewayConnect extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new Ec2TransitGatewayConnectTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
