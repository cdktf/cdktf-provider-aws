...
// https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/data-sources/location_tracker_association
...
export class DataAwsLocationTrackerAssociation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationTrackerAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/data-sources/location_tracker_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/data-sources/location_tracker_association aws_location_tracker_association} Data Source
  *
  * @param scope The scope in which to define this construct
