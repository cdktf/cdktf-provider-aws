...
// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/sagemaker_model_package_group
...
export class SagemakerModelPackageGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerModelPackageGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/sagemaker_model_package_group#import import section} in the documentation of this resource for the id to use
