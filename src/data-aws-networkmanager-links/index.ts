...
// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/networkmanager_links
...
export class DataAwsNetworkmanagerLinks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerLinks that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/networkmanager_links#import import section} in the documentation of this resource for the id to use
