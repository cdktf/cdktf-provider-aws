...
// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/sns_topic_policy
...
export interface SnsTopicPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/sns_topic_policy#arn SnsTopicPolicy#arn}
  */
  readonly arn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/sns_topic_policy#id SnsTopicPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/sns_topic_policy#policy SnsTopicPolicy#policy}
  */
...
export class SnsTopicPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnsTopicPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/sns_topic_policy#import import section} in the documentation of this resource for the id to use
