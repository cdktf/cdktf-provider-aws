...
// https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/s3_bucket_logging
...
export class S3BucketLoggingA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketLoggingA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/s3_bucket_logging#import import section} in the documentation of this resource for the id to use
