...
// https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/resources/rekognition_project
...
export class RekognitionProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RekognitionProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/resources/rekognition_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/resources/rekognition_project aws_rekognition_project} Resource
  *
  * @param scope The scope in which to define this construct
