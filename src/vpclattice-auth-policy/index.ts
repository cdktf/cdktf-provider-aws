...
// https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/vpclattice_auth_policy
...
export class VpclatticeAuthPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeAuthPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/vpclattice_auth_policy#import import section} in the documentation of this resource for the id to use
