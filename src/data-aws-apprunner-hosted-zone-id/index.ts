// https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/data-sources/apprunner_hosted_zone_id
...
export class DataAwsApprunnerHostedZoneId extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApprunnerHostedZoneId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/data-sources/apprunner_hosted_zone_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/data-sources/apprunner_hosted_zone_id aws_apprunner_hosted_zone_id} Data Source
  *
  * @param scope The scope in which to define this construct
