...
// https://registry.terraform.io/providers/hashicorp/aws/5.56.1/docs/resources/servicecatalog_tag_option
...
export class ServicecatalogTagOption extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicecatalogTagOption that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.1/docs/resources/servicecatalog_tag_option#import import section} in the documentation of this resource for the id to use
