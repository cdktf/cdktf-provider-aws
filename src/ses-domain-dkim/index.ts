...
// https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/ses_domain_dkim
...
export class SesDomainDkim extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesDomainDkim that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/ses_domain_dkim#import import section} in the documentation of this resource for the id to use
