...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/vpc_route_server_vpc_association
...
export class VpcRouteServerVpcAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcRouteServerVpcAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/vpc_route_server_vpc_association#import import section} in the documentation of this resource for the id to use
