...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/sns_topic_data_protection_policy
...
export class SnsTopicDataProtectionPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnsTopicDataProtectionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/sns_topic_data_protection_policy#import import section} in the documentation of this resource for the id to use
