...
// https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/shield_application_layer_automatic_response
...
export class ShieldApplicationLayerAutomaticResponse extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldApplicationLayerAutomaticResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/shield_application_layer_automatic_response#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/shield_application_layer_automatic_response aws_shield_application_layer_automatic_response} Resource
  *
  * @param scope The scope in which to define this construct
