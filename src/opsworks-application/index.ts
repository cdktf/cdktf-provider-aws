...
// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/opsworks_application
...
export class OpsworksApplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/opsworks_application#import import section} in the documentation of this resource for the id to use
