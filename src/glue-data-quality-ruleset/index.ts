...
// https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/glue_data_quality_ruleset
...
export class GlueDataQualityRuleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueDataQualityRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/glue_data_quality_ruleset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/glue_data_quality_ruleset aws_glue_data_quality_ruleset} Resource
  *
  * @param scope The scope in which to define this construct
