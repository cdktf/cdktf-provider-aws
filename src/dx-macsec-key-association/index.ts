// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/dx_macsec_key_association
...
export class DxMacsecKeyAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxMacsecKeyAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/dx_macsec_key_association#import import section} in the documentation of this resource for the id to use
