// https://www.terraform.io/docs/providers/aws/r/vpclattice_service
...
export function vpclatticeServiceTimeoutsToTerraform(struct?: VpclatticeServiceTimeoutsOutputReference | VpclatticeServiceTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VpclatticeService extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/aws/r/vpclattice_service aws_vpclattice_service} Resource
  *
