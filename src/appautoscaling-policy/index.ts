...
// https://registry.terraform.io/providers/hashicorp/aws/5.36.0/docs/resources/appautoscaling_policy
...
export class AppautoscalingPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppautoscalingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.36.0/docs/resources/appautoscaling_policy#import import section} in the documentation of this resource for the id to use
