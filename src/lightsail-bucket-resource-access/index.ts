...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/lightsail_bucket_resource_access
...
export class LightsailBucketResourceAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailBucketResourceAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/lightsail_bucket_resource_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/lightsail_bucket_resource_access aws_lightsail_bucket_resource_access} Resource
  *
  * @param scope The scope in which to define this construct
