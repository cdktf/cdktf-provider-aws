...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/ses_email_identity
...
export class SesEmailIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesEmailIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/ses_email_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/ses_email_identity aws_ses_email_identity} Resource
  *
  * @param scope The scope in which to define this construct
