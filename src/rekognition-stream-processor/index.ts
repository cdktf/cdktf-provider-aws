// https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/rekognition_stream_processor
...
export class RekognitionStreamProcessor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RekognitionStreamProcessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/rekognition_stream_processor#import import section} in the documentation of this resource for the id to use
