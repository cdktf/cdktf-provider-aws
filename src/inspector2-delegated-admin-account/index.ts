// https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/resources/inspector2_delegated_admin_account
...
export class Inspector2DelegatedAdminAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Inspector2DelegatedAdminAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/resources/inspector2_delegated_admin_account#import import section} in the documentation of this resource for the id to use
