// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/ssm_patch_baselines
...
export class DataAwsSsmPatchBaselines extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsmPatchBaselines that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/ssm_patch_baselines#import import section} in the documentation of this resource for the id to use
