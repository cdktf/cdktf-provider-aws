...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/snapshot_create_volume_permission
...
export class SnapshotCreateVolumePermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnapshotCreateVolumePermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/snapshot_create_volume_permission#import import section} in the documentation of this resource for the id to use
