...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/kendra_thesaurus
...
export class KendraThesaurus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KendraThesaurus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/kendra_thesaurus#import import section} in the documentation of this resource for the id to use
