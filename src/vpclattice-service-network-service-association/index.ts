...
// https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/resources/vpclattice_service_network_service_association
...
export class VpclatticeServiceNetworkServiceAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeServiceNetworkServiceAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/resources/vpclattice_service_network_service_association#import import section} in the documentation of this resource for the id to use
