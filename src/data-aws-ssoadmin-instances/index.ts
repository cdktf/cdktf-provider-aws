...
// https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/data-sources/ssoadmin_instances
...
export class DataAwsSsoadminInstances extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsoadminInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/data-sources/ssoadmin_instances#import import section} in the documentation of this resource for the id to use
