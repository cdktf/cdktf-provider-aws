...
// https://registry.terraform.io/providers/hashicorp/aws/5.77.0/docs/resources/fis_experiment_template
...
export class FisExperimentTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FisExperimentTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.77.0/docs/resources/fis_experiment_template#import import section} in the documentation of this resource for the id to use
