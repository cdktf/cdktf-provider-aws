...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/db_event_categories
...
export class DataAwsDbEventCategories extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDbEventCategories that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/db_event_categories#import import section} in the documentation of this resource for the id to use
