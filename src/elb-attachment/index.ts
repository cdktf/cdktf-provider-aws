...
// https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/resources/elb_attachment
...
export class ElbAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElbAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/resources/elb_attachment#import import section} in the documentation of this resource for the id to use
