...
export class NetworkmanagerLinkTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkmanagerLinkTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: NetworkmanagerLinkTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class NetworkmanagerLink extends cdktf.TerraformResource {
  ...
  */
  ...
  private _bandwidth = new NetworkmanagerLinkBandwidthOutputReference(this, "bandwidth", true);
  ...
  private _timeouts = new NetworkmanagerLinkTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
