...
export function internetGatewayTimeoutsToTerraform(struct?: InternetGatewayTimeoutsOutputReference | InternetGatewayTimeouts | cdktf.IResolvable): any {
...
export class InternetGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): InternetGatewayTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: InternetGatewayTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class InternetGateway extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new InternetGatewayTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: InternetGatewayTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: internetGatewayTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
