...
export class DataAwsNatGateways extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _filter?: DataAwsNatGatewaysFilter[] | cdktf.IResolvable; 
  public get filter() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('filter')));
  }
  public set filter(value: DataAwsNatGatewaysFilter[] | cdktf.IResolvable) {
    this._filter = value;
  }
  public resetFilter() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataAwsNatGatewaysFilterToTerraform)(this._filter),
    };
  }
}
