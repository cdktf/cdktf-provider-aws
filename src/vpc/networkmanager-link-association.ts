...
export class NetworkmanagerLinkAssociationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkmanagerLinkAssociationTimeouts | undefined {
  ...
  public set internalValue(value: NetworkmanagerLinkAssociationTimeouts | undefined) {
    if (value === undefined) {
...
export class NetworkmanagerLinkAssociation extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "aws_networkmanager_link_association";
  ...
  */
  ...
  private _timeouts = new NetworkmanagerLinkAssociationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
