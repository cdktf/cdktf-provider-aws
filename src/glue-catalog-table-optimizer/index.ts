// https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/glue_catalog_table_optimizer
...
export class GlueCatalogTableOptimizer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueCatalogTableOptimizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/glue_catalog_table_optimizer#import import section} in the documentation of this resource for the id to use
