// https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/data-sources/storagegateway_local_disk
...
export class DataAwsStoragegatewayLocalDisk extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsStoragegatewayLocalDisk that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/data-sources/storagegateway_local_disk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/data-sources/storagegateway_local_disk aws_storagegateway_local_disk} Data Source
  *
  * @param scope The scope in which to define this construct
