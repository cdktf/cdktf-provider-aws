// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/oam_sink
...
export class OamSink extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OamSink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/oam_sink#import import section} in the documentation of this resource for the id to use
