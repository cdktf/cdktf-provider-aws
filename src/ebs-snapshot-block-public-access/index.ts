// https://registry.terraform.io/providers/hashicorp/aws/5.62.0/docs/resources/ebs_snapshot_block_public_access
...
export class EbsSnapshotBlockPublicAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsSnapshotBlockPublicAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.62.0/docs/resources/ebs_snapshot_block_public_access#import import section} in the documentation of this resource for the id to use
