...
// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/service_discovery_service
...
export class DataAwsServiceDiscoveryService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsServiceDiscoveryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/service_discovery_service#import import section} in the documentation of this resource for the id to use
