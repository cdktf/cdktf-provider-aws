...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/sesv2_contact_list
...
export class Sesv2ContactList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2ContactList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/sesv2_contact_list#import import section} in the documentation of this resource for the id to use
