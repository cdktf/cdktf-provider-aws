// https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/data-sources/db_cluster_snapshot
...
export class DataAwsDbClusterSnapshot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDbClusterSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/data-sources/db_cluster_snapshot#import import section} in the documentation of this resource for the id to use
