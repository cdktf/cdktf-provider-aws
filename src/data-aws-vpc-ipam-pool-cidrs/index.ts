// https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/data-sources/vpc_ipam_pool_cidrs
...
export class DataAwsVpcIpamPoolCidrs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcIpamPoolCidrs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/data-sources/vpc_ipam_pool_cidrs#import import section} in the documentation of this resource for the id to use
