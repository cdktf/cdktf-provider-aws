...
// https://registry.terraform.io/providers/hashicorp/aws/6.2.0/docs/data-sources/cloudfront_realtime_log_config
...
export class DataAwsCloudfrontRealtimeLogConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudfrontRealtimeLogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.2.0/docs/data-sources/cloudfront_realtime_log_config#import import section} in the documentation of this resource for the id to use
