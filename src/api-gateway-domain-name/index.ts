...
// https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/api_gateway_domain_name
...
export class ApiGatewayDomainName extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/api_gateway_domain_name#import import section} in the documentation of this resource for the id to use
