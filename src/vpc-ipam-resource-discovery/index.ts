// https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/vpc_ipam_resource_discovery
...
export class VpcIpamResourceDiscovery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpamResourceDiscovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/vpc_ipam_resource_discovery#import import section} in the documentation of this resource for the id to use
