// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/iot_policy_attachment
...
export class IotPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/iot_policy_attachment#import import section} in the documentation of this resource for the id to use
