// https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/data-sources/efs_access_points
...
export class DataAwsEfsAccessPoints extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEfsAccessPoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/data-sources/efs_access_points#import import section} in the documentation of this resource for the id to use
