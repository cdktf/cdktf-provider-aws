// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/ses_domain_mail_from
...
export class SesDomainMailFrom extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesDomainMailFrom that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/ses_domain_mail_from#import import section} in the documentation of this resource for the id to use
