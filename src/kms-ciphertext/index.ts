// https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/kms_ciphertext
...
export class KmsCiphertext extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsCiphertext that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/kms_ciphertext#import import section} in the documentation of this resource for the id to use
