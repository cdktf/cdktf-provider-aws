// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/data-sources/networkmanager_site
...
export class DataAwsNetworkmanagerSite extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/data-sources/networkmanager_site#import import section} in the documentation of this resource for the id to use
