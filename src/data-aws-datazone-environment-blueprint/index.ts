...
// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/data-sources/datazone_environment_blueprint
...
export class DataAwsDatazoneEnvironmentBlueprint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDatazoneEnvironmentBlueprint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/data-sources/datazone_environment_blueprint#import import section} in the documentation of this resource for the id to use
