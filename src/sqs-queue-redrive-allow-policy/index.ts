// https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/sqs_queue_redrive_allow_policy
...
export class SqsQueueRedriveAllowPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqsQueueRedriveAllowPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/sqs_queue_redrive_allow_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/sqs_queue_redrive_allow_policy aws_sqs_queue_redrive_allow_policy} Resource
  *
  * @param scope The scope in which to define this construct
