...
// https://registry.terraform.io/providers/hashicorp/aws/5.42.0/docs/resources/appmesh_virtual_router
...
export class AppmeshVirtualRouter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppmeshVirtualRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.42.0/docs/resources/appmesh_virtual_router#import import section} in the documentation of this resource for the id to use
