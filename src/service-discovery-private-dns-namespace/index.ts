...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/service_discovery_private_dns_namespace
...
export class ServiceDiscoveryPrivateDnsNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDiscoveryPrivateDnsNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/service_discovery_private_dns_namespace#import import section} in the documentation of this resource for the id to use
