...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/codecommit_approval_rule_template
...
export class CodecommitApprovalRuleTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodecommitApprovalRuleTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/codecommit_approval_rule_template#import import section} in the documentation of this resource for the id to use
