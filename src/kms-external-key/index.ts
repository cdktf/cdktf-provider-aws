// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/kms_external_key
...
export class KmsExternalKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsExternalKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/kms_external_key#import import section} in the documentation of this resource for the id to use
