...
// https://registry.terraform.io/providers/hashicorp/aws/5.62.0/docs/resources/amplify_domain_association
...
export class AmplifyDomainAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AmplifyDomainAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.62.0/docs/resources/amplify_domain_association#import import section} in the documentation of this resource for the id to use
