...
// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/ec2_managed_prefix_list_entry
...
export class Ec2ManagedPrefixListEntryA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ManagedPrefixListEntryA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/ec2_managed_prefix_list_entry#import import section} in the documentation of this resource for the id to use
