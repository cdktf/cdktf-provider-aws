// https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/resources/s3_access_point
...
export class S3AccessPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3AccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/resources/s3_access_point#import import section} in the documentation of this resource for the id to use
