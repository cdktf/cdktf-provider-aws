...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/scheduler_schedule
...
export class SchedulerSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchedulerSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/scheduler_schedule#import import section} in the documentation of this resource for the id to use
