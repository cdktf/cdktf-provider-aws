// https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/resources/iot_ca_certificate
...
export interface IotCaCertificateRegistrationConfig {
  ...
  */
  readonly roleArn?: boolean | cdktf.IResolvable;
  /**
...
export function iotCaCertificateRegistrationConfigToTerraform(struct?: IotCaCertificateRegistrationConfigOutputReference | IotCaCertificateRegistrationConfig): any {
  ...
  return {
    role_arn: cdktf.booleanToTerraform(struct!.roleArn),
...
export function iotCaCertificateRegistrationConfigToHclTerraform(struct?: IotCaCertificateRegistrationConfigOutputReference | IotCaCertificateRegistrationConfig): any {
  ...
  const attrs = {
    role_arn: {
      value: cdktf.booleanToHclTerraform(struct!.roleArn),
      isBlock: false,
      type: "simple",
...
export class IotCaCertificateRegistrationConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _roleArn?: boolean | cdktf.IResolvable; 
  public get roleArn() {
    return this.getBooleanAttribute('role_arn');
  }
  public set roleArn(value: boolean | cdktf.IResolvable) {
    this._roleArn = value;
  }
  public resetRoleArn() {
    this._roleArn = undefined;
...
export class IotCaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotCaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/resources/iot_ca_certificate#import import section} in the documentation of this resource for the id to use
