// https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/resources/storagegateway_upload_buffer
...
export class StoragegatewayUploadBuffer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StoragegatewayUploadBuffer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/resources/storagegateway_upload_buffer#import import section} in the documentation of this resource for the id to use
