...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/ec2_client_vpn_endpoint
...
export class Ec2ClientVpnEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ClientVpnEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/ec2_client_vpn_endpoint#import import section} in the documentation of this resource for the id to use
