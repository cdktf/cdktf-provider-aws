// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/vpc_dhcp_options
...
export class VpcDhcpOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcDhcpOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/vpc_dhcp_options#import import section} in the documentation of this resource for the id to use
