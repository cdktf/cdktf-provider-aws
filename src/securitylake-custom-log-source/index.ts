// https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/securitylake_custom_log_source
...
export class SecuritylakeCustomLogSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecuritylakeCustomLogSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/securitylake_custom_log_source#import import section} in the documentation of this resource for the id to use
