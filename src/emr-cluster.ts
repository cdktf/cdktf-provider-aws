...
export class EmrCluster extends TerraformResource {
  ...
  public set coreInstanceFleet(value: EmrClusterCoreInstanceFleet[] | undefined) {
  ...
  public set masterInstanceFleet(value: EmrClusterMasterInstanceFleet[] | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      core_instance_fleet: this._coreInstanceFleet,
      ...
      master_instance_fleet: this._masterInstanceFleet,
