// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/lb_listener_certificate
...
export class LbListenerCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbListenerCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/lb_listener_certificate#import import section} in the documentation of this resource for the id to use
