// https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/data-sources/batch_job_queue
...
export class DataAwsBatchJobQueue extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBatchJobQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/data-sources/batch_job_queue#import import section} in the documentation of this resource for the id to use
