// https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/athena_capacity_reservation
...
export function athenaCapacityReservationTimeoutsToTerraform(struct?: AthenaCapacityReservationTimeouts | cdktf.IResolvable): any {
...
export function athenaCapacityReservationTimeoutsToHclTerraform(struct?: AthenaCapacityReservationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AthenaCapacityReservationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AthenaCapacityReservationTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AthenaCapacityReservationTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AthenaCapacityReservation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AthenaCapacityReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/athena_capacity_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_athena_capacity_reservation", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/athena_capacity_reservation aws_athena_capacity_reservation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      target_dpus: cdktf.numberToTerraform(this._targetDpus),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      target_dpus: {
        value: cdktf.numberToHclTerraform(this._targetDpus),
        isBlock: false,
        type: "simple",
