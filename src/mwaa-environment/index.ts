...
// https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/mwaa_environment
...
export class MwaaEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MwaaEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/mwaa_environment#import import section} in the documentation of this resource for the id to use
