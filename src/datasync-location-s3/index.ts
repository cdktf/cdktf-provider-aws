// https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/datasync_location_s3
...
export class DatasyncLocationS3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncLocationS3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/datasync_location_s3#import import section} in the documentation of this resource for the id to use
