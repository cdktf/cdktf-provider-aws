...
// https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/s3control_access_grants_instance_resource_policy
...
export class S3ControlAccessGrantsInstanceResourcePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlAccessGrantsInstanceResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/s3control_access_grants_instance_resource_policy#import import section} in the documentation of this resource for the id to use
