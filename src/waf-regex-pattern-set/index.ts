// https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/waf_regex_pattern_set
...
export class WafRegexPatternSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafRegexPatternSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/waf_regex_pattern_set#import import section} in the documentation of this resource for the id to use
