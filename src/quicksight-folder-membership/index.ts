// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/quicksight_folder_membership
...
export class QuicksightFolderMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightFolderMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/quicksight_folder_membership#import import section} in the documentation of this resource for the id to use
