...
// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/opsworks_memcached_layer
...
export class OpsworksMemcachedLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksMemcachedLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/opsworks_memcached_layer#import import section} in the documentation of this resource for the id to use
