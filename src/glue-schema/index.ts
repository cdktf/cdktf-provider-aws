// https://registry.terraform.io/providers/hashicorp/aws/5.25.0/docs/resources/glue_schema
...
export class GlueSchema extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.25.0/docs/resources/glue_schema#import import section} in the documentation of this resource for the id to use
