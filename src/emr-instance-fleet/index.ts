// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/emr_instance_fleet
...
export class EmrInstanceFleet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrInstanceFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/emr_instance_fleet#import import section} in the documentation of this resource for the id to use
