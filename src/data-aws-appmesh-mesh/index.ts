...
// https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/data-sources/appmesh_mesh
...
export class DataAwsAppmeshMesh extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppmeshMesh that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/data-sources/appmesh_mesh#import import section} in the documentation of this resource for the id to use
