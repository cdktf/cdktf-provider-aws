// https://registry.terraform.io/providers/hashicorp/aws/5.42.0/docs/resources/lightsail_container_service
...
export class LightsailContainerService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailContainerService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.42.0/docs/resources/lightsail_container_service#import import section} in the documentation of this resource for the id to use
