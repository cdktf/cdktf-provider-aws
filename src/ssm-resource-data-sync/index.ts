// https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/ssm_resource_data_sync
...
export class SsmResourceDataSync extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmResourceDataSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/ssm_resource_data_sync#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/ssm_resource_data_sync aws_ssm_resource_data_sync} Resource
  *
  * @param scope The scope in which to define this construct
