...
// https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/ram_sharing_with_organization
...
export class RamSharingWithOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RamSharingWithOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/ram_sharing_with_organization#import import section} in the documentation of this resource for the id to use
