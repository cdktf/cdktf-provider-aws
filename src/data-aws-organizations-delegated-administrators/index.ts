...
// https://registry.terraform.io/providers/hashicorp/aws/5.47.0/docs/data-sources/organizations_delegated_administrators
...
export class DataAwsOrganizationsDelegatedAdministrators extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsDelegatedAdministrators that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.47.0/docs/data-sources/organizations_delegated_administrators#import import section} in the documentation of this resource for the id to use
