// https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/resources/dataexchange_revision
...
export class DataexchangeRevision extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataexchangeRevision that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/resources/dataexchange_revision#import import section} in the documentation of this resource for the id to use
