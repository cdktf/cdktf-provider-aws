...
// https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/securitylake_subscriber
...
export class SecuritylakeSubscriber extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecuritylakeSubscriber that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/securitylake_subscriber#import import section} in the documentation of this resource for the id to use
