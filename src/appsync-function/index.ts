...
// https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/appsync_function
...
export class AppsyncFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/appsync_function#import import section} in the documentation of this resource for the id to use
