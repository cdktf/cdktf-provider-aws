// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/ssmcontacts_plan
...
export class DataAwsSsmcontactsPlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsmcontactsPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/ssmcontacts_plan#import import section} in the documentation of this resource for the id to use
