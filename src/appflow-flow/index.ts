// https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/appflow_flow
...
export class AppflowFlow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppflowFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/appflow_flow#import import section} in the documentation of this resource for the id to use
