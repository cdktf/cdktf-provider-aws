...
// https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/data-sources/outposts_asset
...
export class DataAwsOutpostsAsset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOutpostsAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/data-sources/outposts_asset#import import section} in the documentation of this resource for the id to use
