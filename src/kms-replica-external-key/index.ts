// https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/kms_replica_external_key
...
export class KmsReplicaExternalKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsReplicaExternalKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/kms_replica_external_key#import import section} in the documentation of this resource for the id to use
