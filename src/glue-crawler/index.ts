// https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/glue_crawler
...
export class GlueCrawler extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueCrawler that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/glue_crawler#import import section} in the documentation of this resource for the id to use
