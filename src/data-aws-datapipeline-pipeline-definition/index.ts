// https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/data-sources/datapipeline_pipeline_definition
...
export class DataAwsDatapipelinePipelineDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDatapipelinePipelineDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/data-sources/datapipeline_pipeline_definition#import import section} in the documentation of this resource for the id to use
