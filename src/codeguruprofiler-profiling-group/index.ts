// https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/codeguruprofiler_profiling_group
...
export class CodeguruprofilerProfilingGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodeguruprofilerProfilingGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/codeguruprofiler_profiling_group#import import section} in the documentation of this resource for the id to use
