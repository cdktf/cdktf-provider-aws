// https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/vpc_endpoint_service
...
export class VpcEndpointService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/vpc_endpoint_service#import import section} in the documentation of this resource for the id to use
