...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/vpc_endpoint_service
...
export class VpcEndpointService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/vpc_endpoint_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/vpc_endpoint_service aws_vpc_endpoint_service} Resource
  *
  * @param scope The scope in which to define this construct
