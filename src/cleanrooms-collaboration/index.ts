// https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/cleanrooms_collaboration
...
export class CleanroomsCollaboration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CleanroomsCollaboration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/cleanrooms_collaboration#import import section} in the documentation of this resource for the id to use
