...
// https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/transfer_agreement
...
export class TransferAgreement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferAgreement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/transfer_agreement#import import section} in the documentation of this resource for the id to use
