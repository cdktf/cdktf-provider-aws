...
// https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/resources/cleanrooms_configured_table
...
export class CleanroomsConfiguredTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CleanroomsConfiguredTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/resources/cleanrooms_configured_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/resources/cleanrooms_configured_table aws_cleanrooms_configured_table} Resource
  *
  * @param scope The scope in which to define this construct
