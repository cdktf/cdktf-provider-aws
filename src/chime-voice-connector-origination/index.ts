...
// https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/chime_voice_connector_origination
...
export class ChimeVoiceConnectorOrigination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimeVoiceConnectorOrigination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/chime_voice_connector_origination#import import section} in the documentation of this resource for the id to use
