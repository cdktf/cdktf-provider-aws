...
// https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/dms_s3_endpoint
...
export class DmsS3Endpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsS3Endpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/dms_s3_endpoint#import import section} in the documentation of this resource for the id to use
