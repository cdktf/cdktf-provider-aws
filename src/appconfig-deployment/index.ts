// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/appconfig_deployment
...
export class AppconfigDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppconfigDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/appconfig_deployment#import import section} in the documentation of this resource for the id to use
