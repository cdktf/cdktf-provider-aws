...
// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/data-sources/dx_location
...
export class DataAwsDxLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDxLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/data-sources/dx_location#import import section} in the documentation of this resource for the id to use
