...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/s3control_multi_region_access_point_policy
...
export class S3ControlMultiRegionAccessPointPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlMultiRegionAccessPointPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/s3control_multi_region_access_point_policy#import import section} in the documentation of this resource for the id to use
