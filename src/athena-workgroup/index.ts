// https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/athena_workgroup
...
export class AthenaWorkgroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AthenaWorkgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/athena_workgroup#import import section} in the documentation of this resource for the id to use
