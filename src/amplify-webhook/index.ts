...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/amplify_webhook
...
export class AmplifyWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AmplifyWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/amplify_webhook#import import section} in the documentation of this resource for the id to use
