// https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/resources/quicksight_vpc_connection
...
export class QuicksightVpcConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightVpcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/resources/quicksight_vpc_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/resources/quicksight_vpc_connection aws_quicksight_vpc_connection} Resource
  *
  * @param scope The scope in which to define this construct
