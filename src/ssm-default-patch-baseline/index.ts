// https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/ssm_default_patch_baseline
...
export interface SsmDefaultPatchBaselineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/ssm_default_patch_baseline#baseline_id SsmDefaultPatchBaseline#baseline_id}
  */
  readonly baselineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/ssm_default_patch_baseline#id SsmDefaultPatchBaseline#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/ssm_default_patch_baseline#operating_system SsmDefaultPatchBaseline#operating_system}
  */
  readonly operatingSystem: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/ssm_default_patch_baseline aws_ssm_default_patch_baseline}
*/
export class SsmDefaultPatchBaseline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmDefaultPatchBaseline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/ssm_default_patch_baseline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/ssm_default_patch_baseline aws_ssm_default_patch_baseline} Resource
  *
  * @param scope The scope in which to define this construct
