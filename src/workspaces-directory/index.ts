// https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/workspaces_directory
...
export class WorkspacesDirectory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspacesDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/workspaces_directory#import import section} in the documentation of this resource for the id to use
