...
// https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/data-sources/api_gateway_authorizers
...
export class DataAwsApiGatewayAuthorizers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApiGatewayAuthorizers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/data-sources/api_gateway_authorizers#import import section} in the documentation of this resource for the id to use
