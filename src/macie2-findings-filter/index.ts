...
// https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/resources/macie2_findings_filter
...
export class Macie2FindingsFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Macie2FindingsFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/resources/macie2_findings_filter#import import section} in the documentation of this resource for the id to use
