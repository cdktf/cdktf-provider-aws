...
// https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/opensearch_vpc_endpoint
...
export class OpensearchVpcEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchVpcEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/opensearch_vpc_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.76.0/docs/resources/opensearch_vpc_endpoint aws_opensearch_vpc_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
