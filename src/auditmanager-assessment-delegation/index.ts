...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/auditmanager_assessment_delegation
...
export class AuditmanagerAssessmentDelegation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditmanagerAssessmentDelegation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/auditmanager_assessment_delegation#import import section} in the documentation of this resource for the id to use
