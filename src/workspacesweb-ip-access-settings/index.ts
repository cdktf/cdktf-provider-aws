...
// https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/workspacesweb_ip_access_settings
...
export class WorkspaceswebIpAccessSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceswebIpAccessSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/workspacesweb_ip_access_settings#import import section} in the documentation of this resource for the id to use
