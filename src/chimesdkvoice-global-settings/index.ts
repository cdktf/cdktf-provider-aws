...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/chimesdkvoice_global_settings
...
export class ChimesdkvoiceGlobalSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimesdkvoiceGlobalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/chimesdkvoice_global_settings#import import section} in the documentation of this resource for the id to use
