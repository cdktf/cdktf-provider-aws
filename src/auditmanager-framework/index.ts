...
// https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/auditmanager_framework
...
export class AuditmanagerFramework extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditmanagerFramework that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/auditmanager_framework#import import section} in the documentation of this resource for the id to use
