...
// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/config_configuration_recorder
...
export class ConfigConfigurationRecorder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigConfigurationRecorder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/config_configuration_recorder#import import section} in the documentation of this resource for the id to use
