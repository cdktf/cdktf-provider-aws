// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/macie2_custom_data_identifier
...
export class Macie2CustomDataIdentifier extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Macie2CustomDataIdentifier that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/macie2_custom_data_identifier#import import section} in the documentation of this resource for the id to use
