// https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/resources/api_gateway_rest_api_policy
...
export class ApiGatewayRestApiPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayRestApiPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/resources/api_gateway_rest_api_policy#import import section} in the documentation of this resource for the id to use
