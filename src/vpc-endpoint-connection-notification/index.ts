// https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/vpc_endpoint_connection_notification
...
export class VpcEndpointConnectionNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointConnectionNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/vpc_endpoint_connection_notification#import import section} in the documentation of this resource for the id to use
