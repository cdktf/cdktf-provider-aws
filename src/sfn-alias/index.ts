// https://registry.terraform.io/providers/hashicorp/aws/5.41.0/docs/resources/sfn_alias
...
export class SfnAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SfnAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.41.0/docs/resources/sfn_alias#import import section} in the documentation of this resource for the id to use
