// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/grafana_workspace_saml_configuration
...
export class GrafanaWorkspaceSamlConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrafanaWorkspaceSamlConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/grafana_workspace_saml_configuration#import import section} in the documentation of this resource for the id to use
