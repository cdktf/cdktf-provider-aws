// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/route53_cidr_collection
...
export class Route53CidrCollection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53CidrCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/route53_cidr_collection#import import section} in the documentation of this resource for the id to use
