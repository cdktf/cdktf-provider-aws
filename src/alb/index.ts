...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/alb
...
export class AlbIpamPoolsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AlbIpamPools | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: AlbIpamPools | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class AlbMinimumLoadBalancerCapacityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AlbMinimumLoadBalancerCapacity | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: AlbMinimumLoadBalancerCapacity | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class Alb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Alb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/alb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/alb aws_alb} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _ipamPools = new AlbIpamPoolsOutputReference(this, "ipam_pools");
  public get ipamPools() {
    return this._ipamPools;
  }
  public putIpamPools(value: AlbIpamPools) {
  ...
  private _minimumLoadBalancerCapacity = new AlbMinimumLoadBalancerCapacityOutputReference(this, "minimum_load_balancer_capacity");
  public get minimumLoadBalancerCapacity() {
    return this._minimumLoadBalancerCapacity;
  }
  public putMinimumLoadBalancerCapacity(value: AlbMinimumLoadBalancerCapacity) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ipam_pools: {
        value: albIpamPoolsToHclTerraform(this._ipamPools.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AlbIpamPoolsList",
      },
      minimum_load_balancer_capacity: {
        value: albMinimumLoadBalancerCapacityToHclTerraform(this._minimumLoadBalancerCapacity.internalValue),
        isBlock: true,
        type: "list",
