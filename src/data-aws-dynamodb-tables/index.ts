// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/dynamodb_tables
...
export class DataAwsDynamodbTables extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDynamodbTables that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/dynamodb_tables#import import section} in the documentation of this resource for the id to use
