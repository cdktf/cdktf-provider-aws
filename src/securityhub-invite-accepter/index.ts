...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.2/docs/resources/securityhub_invite_accepter
...
export class SecurityhubInviteAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityhubInviteAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.2/docs/resources/securityhub_invite_accepter#import import section} in the documentation of this resource for the id to use
