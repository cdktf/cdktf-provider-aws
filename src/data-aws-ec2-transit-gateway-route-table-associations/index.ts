// https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_route_table_associations
...
export function dataAwsEc2TransitGatewayRouteTableAssociationsTimeoutsToTerraform(struct?: DataAwsEc2TransitGatewayRouteTableAssociationsTimeoutsOutputReference | DataAwsEc2TransitGatewayRouteTableAssociationsTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
