...
// https://registry.terraform.io/providers/hashicorp/aws/5.61.0/docs/resources/dlm_lifecycle_policy
...
export class DlmLifecyclePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlmLifecyclePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.61.0/docs/resources/dlm_lifecycle_policy#import import section} in the documentation of this resource for the id to use
