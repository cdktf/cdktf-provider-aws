...
// https://registry.terraform.io/providers/hashicorp/aws/5.65.0/docs/resources/sagemaker_user_profile
...
export class SagemakerUserProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerUserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.65.0/docs/resources/sagemaker_user_profile#import import section} in the documentation of this resource for the id to use
