// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/data-sources/appmesh_virtual_router
...
export class DataAwsAppmeshVirtualRouter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppmeshVirtualRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/data-sources/appmesh_virtual_router#import import section} in the documentation of this resource for the id to use
