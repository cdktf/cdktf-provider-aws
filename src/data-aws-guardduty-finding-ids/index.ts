...
// https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/data-sources/guardduty_finding_ids
...
export class DataAwsGuarddutyFindingIds extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGuarddutyFindingIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/data-sources/guardduty_finding_ids#import import section} in the documentation of this resource for the id to use
