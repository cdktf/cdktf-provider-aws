// https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/appstream_fleet
...
export class AppstreamFleet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppstreamFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/resources/appstream_fleet#import import section} in the documentation of this resource for the id to use
