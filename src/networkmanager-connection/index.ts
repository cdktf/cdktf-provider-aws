...
// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/networkmanager_connection
...
export class NetworkmanagerConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/networkmanager_connection#import import section} in the documentation of this resource for the id to use
