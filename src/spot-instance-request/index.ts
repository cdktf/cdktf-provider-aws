// https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/spot_instance_request
...
export class SpotInstanceRequest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpotInstanceRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/spot_instance_request#import import section} in the documentation of this resource for the id to use
