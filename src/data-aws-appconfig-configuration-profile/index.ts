// https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/appconfig_configuration_profile
...
export class DataAwsAppconfigConfigurationProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppconfigConfigurationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/appconfig_configuration_profile#import import section} in the documentation of this resource for the id to use
