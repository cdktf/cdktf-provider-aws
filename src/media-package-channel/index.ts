// https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/resources/media_package_channel
...
export class MediaPackageChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaPackageChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/resources/media_package_channel#import import section} in the documentation of this resource for the id to use
