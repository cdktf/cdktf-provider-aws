// https://registry.terraform.io/providers/hashicorp/aws/5.72.1/docs/resources/default_security_group
...
export class DefaultSecurityGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.1/docs/resources/default_security_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.1/docs/resources/default_security_group aws_default_security_group} Resource
  *
  * @param scope The scope in which to define this construct
