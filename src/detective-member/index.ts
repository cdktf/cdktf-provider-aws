// https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/detective_member
...
export class DetectiveMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DetectiveMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/detective_member#import import section} in the documentation of this resource for the id to use
