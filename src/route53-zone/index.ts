...
// https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/route53_zone
...
export class Route53Zone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53Zone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/route53_zone#import import section} in the documentation of this resource for the id to use
