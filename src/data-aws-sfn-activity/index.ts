...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/sfn_activity
...
export class DataAwsSfnActivity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSfnActivity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/sfn_activity#import import section} in the documentation of this resource for the id to use
