// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/data-sources/sesv2_email_identity
...
export class DataAwsSesv2EmailIdentity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSesv2EmailIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/data-sources/sesv2_email_identity#import import section} in the documentation of this resource for the id to use
