...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/iot_topic_rule
...
export class IotTopicRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotTopicRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/iot_topic_rule#import import section} in the documentation of this resource for the id to use
