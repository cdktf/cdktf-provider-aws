...
// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/globalaccelerator_listener
...
export class GlobalacceleratorListener extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalacceleratorListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/globalaccelerator_listener#import import section} in the documentation of this resource for the id to use
