// https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/pinpoint_adm_channel
...
export class PinpointAdmChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointAdmChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/pinpoint_adm_channel#import import section} in the documentation of this resource for the id to use
