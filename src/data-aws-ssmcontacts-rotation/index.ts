// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ssmcontacts_rotation
...
export class DataAwsSsmcontactsRotation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsmcontactsRotation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ssmcontacts_rotation#import import section} in the documentation of this resource for the id to use
