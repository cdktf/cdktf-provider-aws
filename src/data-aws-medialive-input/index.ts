...
// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/data-sources/medialive_input
...
export class DataAwsMedialiveInput extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMedialiveInput that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/data-sources/medialive_input#import import section} in the documentation of this resource for the id to use
