// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/devicefarm_project
...
export class DevicefarmProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevicefarmProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/devicefarm_project#import import section} in the documentation of this resource for the id to use
