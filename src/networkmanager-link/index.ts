...
// https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/resources/networkmanager_link
...
export class NetworkmanagerLink extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/resources/networkmanager_link#import import section} in the documentation of this resource for the id to use
