...
// https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/opensearch_domain_saml_options
...
export class OpensearchDomainSamlOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchDomainSamlOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/opensearch_domain_saml_options#import import section} in the documentation of this resource for the id to use
