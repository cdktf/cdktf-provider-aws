// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/ram_resource_share
...
export class RamResourceShare extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RamResourceShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/ram_resource_share#import import section} in the documentation of this resource for the id to use
