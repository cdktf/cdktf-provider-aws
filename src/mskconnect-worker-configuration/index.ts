// https://registry.terraform.io/providers/hashicorp/aws/5.59.0/docs/resources/mskconnect_worker_configuration
...
export class MskconnectWorkerConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MskconnectWorkerConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.59.0/docs/resources/mskconnect_worker_configuration#import import section} in the documentation of this resource for the id to use
