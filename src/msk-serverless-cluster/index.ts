// https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/msk_serverless_cluster
...
export class MskServerlessCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MskServerlessCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/msk_serverless_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/msk_serverless_cluster aws_msk_serverless_cluster} Resource
  *
  * @param scope The scope in which to define this construct
