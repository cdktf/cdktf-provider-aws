...
// https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/dsql_cluster_peering
...
export class DsqlClusterPeering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DsqlClusterPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/dsql_cluster_peering#import import section} in the documentation of this resource for the id to use
