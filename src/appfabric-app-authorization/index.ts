// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/appfabric_app_authorization
...
export class AppfabricAppAuthorization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppfabricAppAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/appfabric_app_authorization#import import section} in the documentation of this resource for the id to use
