...
// https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/ec2_image_block_public_access
...
export interface Ec2ImageBlockPublicAccessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/ec2_image_block_public_access#id Ec2ImageBlockPublicAccess#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/ec2_image_block_public_access#state Ec2ImageBlockPublicAccess#state}
  */
  readonly state: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/ec2_image_block_public_access#timeouts Ec2ImageBlockPublicAccess#timeouts}
  */
...
export class Ec2ImageBlockPublicAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ImageBlockPublicAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/ec2_image_block_public_access#import import section} in the documentation of this resource for the id to use
