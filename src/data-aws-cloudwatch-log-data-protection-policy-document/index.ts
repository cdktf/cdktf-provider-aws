...
// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/data-sources/cloudwatch_log_data_protection_policy_document
...
export class DataAwsCloudwatchLogDataProtectionPolicyDocument extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudwatchLogDataProtectionPolicyDocument that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/data-sources/cloudwatch_log_data_protection_policy_document#import import section} in the documentation of this resource for the id to use
