...
// https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/servicequotas_template
...
export class ServicequotasTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicequotasTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/servicequotas_template#import import section} in the documentation of this resource for the id to use
