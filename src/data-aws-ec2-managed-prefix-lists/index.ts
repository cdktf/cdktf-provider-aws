// https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/data-sources/ec2_managed_prefix_lists
...
export class DataAwsEc2ManagedPrefixLists extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2ManagedPrefixLists that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.87.0/docs/data-sources/ec2_managed_prefix_lists#import import section} in the documentation of this resource for the id to use
