...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/lightsail_bucket_access_key
...
export class LightsailBucketAccessKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailBucketAccessKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/lightsail_bucket_access_key#import import section} in the documentation of this resource for the id to use
