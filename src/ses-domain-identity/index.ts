// https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/ses_domain_identity
...
export class SesDomainIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesDomainIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/ses_domain_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/ses_domain_identity aws_ses_domain_identity} Resource
  *
  * @param scope The scope in which to define this construct
