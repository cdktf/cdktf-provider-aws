...
// https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/launch_template
...
export class LaunchTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LaunchTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/launch_template#import import section} in the documentation of this resource for the id to use
