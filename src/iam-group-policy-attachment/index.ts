// https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/iam_group_policy_attachment
...
export class IamGroupPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroupPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/iam_group_policy_attachment#import import section} in the documentation of this resource for the id to use
