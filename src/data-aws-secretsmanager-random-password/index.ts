...
// https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/secretsmanager_random_password
...
export class DataAwsSecretsmanagerRandomPassword extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSecretsmanagerRandomPassword that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/secretsmanager_random_password#import import section} in the documentation of this resource for the id to use
