...
// https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/resources/lb_listener_rule
...
export class LbListenerRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbListenerRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/resources/lb_listener_rule#import import section} in the documentation of this resource for the id to use
