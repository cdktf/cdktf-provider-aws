...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/emr_managed_scaling_policy
...
export class EmrManagedScalingPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrManagedScalingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/emr_managed_scaling_policy#import import section} in the documentation of this resource for the id to use
