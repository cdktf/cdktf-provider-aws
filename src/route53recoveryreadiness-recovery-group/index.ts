// https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/route53recoveryreadiness_recovery_group
...
export class Route53RecoveryreadinessRecoveryGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53RecoveryreadinessRecoveryGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/route53recoveryreadiness_recovery_group#import import section} in the documentation of this resource for the id to use
