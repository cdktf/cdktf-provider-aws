// https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/elastic_beanstalk_environment
...
export class ElasticBeanstalkEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticBeanstalkEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/elastic_beanstalk_environment#import import section} in the documentation of this resource for the id to use
