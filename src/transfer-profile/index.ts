// https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/resources/transfer_profile
...
export class TransferProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/resources/transfer_profile#import import section} in the documentation of this resource for the id to use
