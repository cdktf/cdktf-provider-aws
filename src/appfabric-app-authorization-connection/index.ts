// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/appfabric_app_authorization_connection
...
export class AppfabricAppAuthorizationConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppfabricAppAuthorizationConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/appfabric_app_authorization_connection#import import section} in the documentation of this resource for the id to use
