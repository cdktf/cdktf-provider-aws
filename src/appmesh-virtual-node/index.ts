// https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/resources/appmesh_virtual_node
...
export class AppmeshVirtualNode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppmeshVirtualNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/resources/appmesh_virtual_node#import import section} in the documentation of this resource for the id to use
