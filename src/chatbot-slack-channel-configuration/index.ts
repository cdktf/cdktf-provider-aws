// https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/chatbot_slack_channel_configuration
...
export class ChatbotSlackChannelConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChatbotSlackChannelConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/chatbot_slack_channel_configuration#import import section} in the documentation of this resource for the id to use
