// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/cloudtrail_service_account
...
export class DataAwsCloudtrailServiceAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudtrailServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/cloudtrail_service_account#import import section} in the documentation of this resource for the id to use
