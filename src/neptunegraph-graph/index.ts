...
// https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/neptunegraph_graph
...
export class NeptunegraphGraph extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NeptunegraphGraph that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/neptunegraph_graph#import import section} in the documentation of this resource for the id to use
