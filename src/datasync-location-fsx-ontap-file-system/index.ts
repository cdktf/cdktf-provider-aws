...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/datasync_location_fsx_ontap_file_system
...
export class DatasyncLocationFsxOntapFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncLocationFsxOntapFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.0/docs/resources/datasync_location_fsx_ontap_file_system#import import section} in the documentation of this resource for the id to use
