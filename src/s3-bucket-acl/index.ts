...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/s3_bucket_acl
...
export class S3BucketAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/s3_bucket_acl#import import section} in the documentation of this resource for the id to use
