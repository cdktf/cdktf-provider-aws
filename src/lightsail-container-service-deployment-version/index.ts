// https://registry.terraform.io/providers/hashicorp/aws/5.51.0/docs/resources/lightsail_container_service_deployment_version
...
export class LightsailContainerServiceDeploymentVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailContainerServiceDeploymentVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.51.0/docs/resources/lightsail_container_service_deployment_version#import import section} in the documentation of this resource for the id to use
