// https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/resources/ec2_transit_gateway_policy_table_association
...
export class Ec2TransitGatewayPolicyTableAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2TransitGatewayPolicyTableAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/resources/ec2_transit_gateway_policy_table_association#import import section} in the documentation of this resource for the id to use
