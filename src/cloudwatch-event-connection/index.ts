...
// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/cloudwatch_event_connection
...
export class CloudwatchEventConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchEventConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/cloudwatch_event_connection#import import section} in the documentation of this resource for the id to use
