// https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/resources/wafregional_ipset
...
export class WafregionalIpset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalIpset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/resources/wafregional_ipset#import import section} in the documentation of this resource for the id to use
