...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/ecs_cluster_capacity_providers
...
export class EcsClusterCapacityProviders extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsClusterCapacityProviders that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/ecs_cluster_capacity_providers#import import section} in the documentation of this resource for the id to use
