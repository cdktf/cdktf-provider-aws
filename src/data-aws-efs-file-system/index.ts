// https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/data-sources/efs_file_system
...
export class DataAwsEfsFileSystem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEfsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/data-sources/efs_file_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/data-sources/efs_file_system aws_efs_file_system} Data Source
  *
  * @param scope The scope in which to define this construct
