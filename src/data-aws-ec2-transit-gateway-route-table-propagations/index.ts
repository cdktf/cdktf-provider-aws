// https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_route_table_propagations
...
export function dataAwsEc2TransitGatewayRouteTablePropagationsTimeoutsToTerraform(struct?: DataAwsEc2TransitGatewayRouteTablePropagationsTimeoutsOutputReference | DataAwsEc2TransitGatewayRouteTablePropagationsTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAwsEc2TransitGatewayRouteTablePropagations extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/aws/d/ec2_transit_gateway_route_table_propagations aws_ec2_transit_gateway_route_table_propagations} Data Source
  *
