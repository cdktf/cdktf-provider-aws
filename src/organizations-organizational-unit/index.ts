// https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/organizations_organizational_unit
...
export class OrganizationsOrganizationalUnit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationsOrganizationalUnit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/resources/organizations_organizational_unit#import import section} in the documentation of this resource for the id to use
