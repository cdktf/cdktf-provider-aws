...
// https://registry.terraform.io/providers/hashicorp/aws/5.32.1/docs/resources/opsworks_user_profile
...
export class OpsworksUserProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksUserProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.1/docs/resources/opsworks_user_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.1/docs/resources/opsworks_user_profile aws_opsworks_user_profile} Resource
  *
  * @param scope The scope in which to define this construct
