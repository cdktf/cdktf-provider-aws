// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/wafv2_ip_set
...
export class Wafv2IpSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2IpSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/wafv2_ip_set#import import section} in the documentation of this resource for the id to use
