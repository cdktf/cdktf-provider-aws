...
// https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/wafv2_ip_set
...
export class Wafv2IpSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2IpSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/wafv2_ip_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/wafv2_ip_set aws_wafv2_ip_set} Resource
  *
  * @param scope The scope in which to define this construct
