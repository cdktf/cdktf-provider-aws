...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/data-sources/eks_node_group
...
export class DataAwsEksNodeGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEksNodeGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/data-sources/eks_node_group#import import section} in the documentation of this resource for the id to use
