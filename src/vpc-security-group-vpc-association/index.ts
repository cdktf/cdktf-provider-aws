...
// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/vpc_security_group_vpc_association
...
export class VpcSecurityGroupVpcAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcSecurityGroupVpcAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/vpc_security_group_vpc_association#import import section} in the documentation of this resource for the id to use
