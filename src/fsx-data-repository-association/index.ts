// https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/fsx_data_repository_association
...
export class FsxDataRepositoryAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxDataRepositoryAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/fsx_data_repository_association#import import section} in the documentation of this resource for the id to use
