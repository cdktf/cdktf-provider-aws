...
// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/sfn_state_machine_versions
...
export interface DataAwsSfnStateMachineVersionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/sfn_state_machine_versions#id DataAwsSfnStateMachineVersions#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/sfn_state_machine_versions#statemachine_arn DataAwsSfnStateMachineVersions#statemachine_arn}
  */
  readonly statemachineArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/sfn_state_machine_versions aws_sfn_state_machine_versions}
*/
export class DataAwsSfnStateMachineVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSfnStateMachineVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/sfn_state_machine_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/sfn_state_machine_versions aws_sfn_state_machine_versions} Data Source
  *
  * @param scope The scope in which to define this construct
