// https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/lb_ssl_negotiation_policy
...
export class LbSslNegotiationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbSslNegotiationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/lb_ssl_negotiation_policy#import import section} in the documentation of this resource for the id to use
