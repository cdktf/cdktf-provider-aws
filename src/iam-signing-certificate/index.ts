...
// https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/iam_signing_certificate
...
export class IamSigningCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamSigningCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.31.0/docs/resources/iam_signing_certificate#import import section} in the documentation of this resource for the id to use
