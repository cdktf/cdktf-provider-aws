...
// https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/app_cookie_stickiness_policy
...
export class AppCookieStickinessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppCookieStickinessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/app_cookie_stickiness_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/app_cookie_stickiness_policy aws_app_cookie_stickiness_policy} Resource
  *
  * @param scope The scope in which to define this construct
