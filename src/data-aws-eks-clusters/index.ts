...
// https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/eks_clusters
...
export interface DataAwsEksClustersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/eks_clusters#id DataAwsEksClusters#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/eks_clusters aws_eks_clusters}
*/
export class DataAwsEksClusters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEksClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/eks_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/eks_clusters aws_eks_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
