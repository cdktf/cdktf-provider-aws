...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/data-sources/cloudcontrolapi_resource
...
export class DataAwsCloudcontrolapiResource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudcontrolapiResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/data-sources/cloudcontrolapi_resource#import import section} in the documentation of this resource for the id to use
