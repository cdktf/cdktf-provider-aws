// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/lightsail_lb
...
export class LightsailLb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailLb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/lightsail_lb#import import section} in the documentation of this resource for the id to use
