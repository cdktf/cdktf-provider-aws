...
// https://registry.terraform.io/providers/hashicorp/aws/6.2.0/docs/resources/ses_event_destination
...
export class SesEventDestination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesEventDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.2.0/docs/resources/ses_event_destination#import import section} in the documentation of this resource for the id to use
