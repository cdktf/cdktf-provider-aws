// https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/opsworks_ecs_cluster_layer
...
export class OpsworksEcsClusterLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksEcsClusterLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/opsworks_ecs_cluster_layer#import import section} in the documentation of this resource for the id to use
