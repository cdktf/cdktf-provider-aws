...
// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/route53profiles_association
...
export class Route53ProfilesAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53ProfilesAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/route53profiles_association#import import section} in the documentation of this resource for the id to use
