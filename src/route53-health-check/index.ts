...
// https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/route53_health_check
...
export class Route53HealthCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53HealthCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/route53_health_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/route53_health_check aws_route53_health_check} Resource
  *
  * @param scope The scope in which to define this construct
