...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/ivs_playback_key_pair
...
export class IvsPlaybackKeyPair extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IvsPlaybackKeyPair that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/ivs_playback_key_pair#import import section} in the documentation of this resource for the id to use
