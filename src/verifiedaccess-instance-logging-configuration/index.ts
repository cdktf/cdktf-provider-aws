// https://registry.terraform.io/providers/hashicorp/aws/5.27.0/docs/resources/verifiedaccess_instance_logging_configuration
...
export class VerifiedaccessInstanceLoggingConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedaccessInstanceLoggingConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.27.0/docs/resources/verifiedaccess_instance_logging_configuration#import import section} in the documentation of this resource for the id to use
