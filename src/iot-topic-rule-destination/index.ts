...
// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/iot_topic_rule_destination
...
export class IotTopicRuleDestination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotTopicRuleDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/iot_topic_rule_destination#import import section} in the documentation of this resource for the id to use
