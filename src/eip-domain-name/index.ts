...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/eip_domain_name
...
export class EipDomainName extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EipDomainName that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/eip_domain_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/eip_domain_name aws_eip_domain_name} Resource
  *
  * @param scope The scope in which to define this construct
