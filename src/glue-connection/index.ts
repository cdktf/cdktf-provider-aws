// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/glue_connection
...
export class GlueConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/glue_connection#import import section} in the documentation of this resource for the id to use
