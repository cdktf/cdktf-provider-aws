...
// https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/redshiftserverless_namespace
...
export class RedshiftserverlessNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftserverlessNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/redshiftserverless_namespace#import import section} in the documentation of this resource for the id to use
