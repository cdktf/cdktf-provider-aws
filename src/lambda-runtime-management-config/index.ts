// https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/lambda_runtime_management_config
...
export class LambdaRuntimeManagementConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaRuntimeManagementConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/lambda_runtime_management_config#import import section} in the documentation of this resource for the id to use
