...
// https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/default_vpc_dhcp_options
...
export class DefaultVpcDhcpOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultVpcDhcpOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/default_vpc_dhcp_options#import import section} in the documentation of this resource for the id to use
