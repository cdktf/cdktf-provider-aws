// https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/ec2_network_insights_analysis
...
export class Ec2NetworkInsightsAnalysis extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2NetworkInsightsAnalysis that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/ec2_network_insights_analysis#import import section} in the documentation of this resource for the id to use
