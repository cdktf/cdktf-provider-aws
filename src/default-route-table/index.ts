...
// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/default_route_table
...
export class DefaultRouteTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultRouteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/default_route_table#import import section} in the documentation of this resource for the id to use
