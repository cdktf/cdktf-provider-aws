// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/securityhub_organization_admin_account
...
export class SecurityhubOrganizationAdminAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityhubOrganizationAdminAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/securityhub_organization_admin_account#import import section} in the documentation of this resource for the id to use
