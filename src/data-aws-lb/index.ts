...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/data-sources/lb
...
export class DataAwsLb extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/data-sources/lb#import import section} in the documentation of this resource for the id to use
