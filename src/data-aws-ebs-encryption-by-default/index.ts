...
// https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/data-sources/ebs_encryption_by_default
...
export class DataAwsEbsEncryptionByDefault extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEbsEncryptionByDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/data-sources/ebs_encryption_by_default#import import section} in the documentation of this resource for the id to use
