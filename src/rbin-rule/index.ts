// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/rbin_rule
...
export class RbinRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RbinRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/rbin_rule#import import section} in the documentation of this resource for the id to use
