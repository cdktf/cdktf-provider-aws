...
// https://registry.terraform.io/providers/hashicorp/aws/5.79.0/docs/resources/ec2_fleet
...
export function ec2FleetOnDemandOptionsCapacityReservationOptionsToHclTerraform(struct?: Ec2FleetOnDemandOptionsCapacityReservationOptionsOutputReference | Ec2FleetOnDemandOptionsCapacityReservationOptions): any {
  ...
  const attrs = {
    usage_strategy: {
      value: cdktf.stringToHclTerraform(struct!.usageStrategy),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class Ec2FleetOnDemandOptionsCapacityReservationOptionsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class Ec2Fleet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2Fleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.79.0/docs/resources/ec2_fleet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.79.0/docs/resources/ec2_fleet aws_ec2_fleet} Resource
  *
  * @param scope The scope in which to define this construct
