// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type
...
export interface DatazoneAssetTypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#description DatazoneAssetType#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#domain_identifier DatazoneAssetType#domain_identifier}
  */
  readonly domainIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#name DatazoneAssetType#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#owning_project_identifier DatazoneAssetType#owning_project_identifier}
  */
  readonly owningProjectIdentifier: string;
  /**
  * forms_input block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#forms_input DatazoneAssetType#forms_input}
  */
  readonly formsInput?: DatazoneAssetTypeFormsInput[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#timeouts DatazoneAssetType#timeouts}
  */
  readonly timeouts?: DatazoneAssetTypeTimeouts;
}
export interface DatazoneAssetTypeFormsInput {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#map_block_key DatazoneAssetType#map_block_key}
  */
  readonly mapBlockKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#required DatazoneAssetType#required}
  */
  readonly required?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#type_identifier DatazoneAssetType#type_identifier}
  */
  readonly typeIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#type_revision DatazoneAssetType#type_revision}
  */
...
export interface DatazoneAssetTypeTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#create DatazoneAssetType#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type aws_datazone_asset_type}
*/
export class DatazoneAssetType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneAssetType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/datazone_asset_type aws_datazone_asset_type} Resource
  *
  * @param scope The scope in which to define this construct
