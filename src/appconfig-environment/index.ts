// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/appconfig_environment
...
export class AppconfigEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppconfigEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/appconfig_environment#import import section} in the documentation of this resource for the id to use
