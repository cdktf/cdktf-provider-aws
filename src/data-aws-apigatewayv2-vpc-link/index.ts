// https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/data-sources/apigatewayv2_vpc_link
...
export class DataAwsApigatewayv2VpcLink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApigatewayv2VpcLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/data-sources/apigatewayv2_vpc_link#import import section} in the documentation of this resource for the id to use
