...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/vpc_endpoint
...
export class VpcEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/vpc_endpoint#import import section} in the documentation of this resource for the id to use
