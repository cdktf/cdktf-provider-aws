// https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/resources/networkmanager_vpc_attachment
...
export class NetworkmanagerVpcAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerVpcAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/resources/networkmanager_vpc_attachment#import import section} in the documentation of this resource for the id to use
