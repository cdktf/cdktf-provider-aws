// https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/wafv2_web_acl_logging_configuration
...
export class Wafv2WebAclLoggingConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2WebAclLoggingConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/wafv2_web_acl_logging_configuration#import import section} in the documentation of this resource for the id to use
