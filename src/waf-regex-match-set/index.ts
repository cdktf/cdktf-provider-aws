...
// https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/waf_regex_match_set
...
export class WafRegexMatchSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafRegexMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/resources/waf_regex_match_set#import import section} in the documentation of this resource for the id to use
