...
export class ServicecatalogPortfolioShareTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServicecatalogPortfolioShareTimeouts | undefined {
  ...
  public set internalValue(value: ServicecatalogPortfolioShareTimeouts | undefined) {
    if (value === undefined) {
...
export class ServicecatalogPortfolioShare extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ServicecatalogPortfolioShareTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
