...
export class ServicecatalogProductTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServicecatalogProductTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ServicecatalogProductTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ServicecatalogProduct extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ServicecatalogProductTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
