...
export class ServicecatalogTagOptionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServicecatalogTagOptionTimeouts | undefined {
  ...
  public set internalValue(value: ServicecatalogTagOptionTimeouts | undefined) {
    if (value === undefined) {
...
export class ServicecatalogTagOption extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ServicecatalogTagOptionTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ServicecatalogTagOptionTimeouts) {
