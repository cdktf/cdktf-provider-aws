...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/dataexchange_event_action
...
export class DataexchangeEventAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataexchangeEventAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/dataexchange_event_action#import import section} in the documentation of this resource for the id to use
