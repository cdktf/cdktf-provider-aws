// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/verifiedpermissions_policy_store
...
export class VerifiedpermissionsPolicyStore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedpermissionsPolicyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/verifiedpermissions_policy_store#import import section} in the documentation of this resource for the id to use
