// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/data-sources/emr_supported_instance_types
...
export class DataAwsEmrSupportedInstanceTypes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEmrSupportedInstanceTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/data-sources/emr_supported_instance_types#import import section} in the documentation of this resource for the id to use
