// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/athena_data_catalog
...
export class AthenaDataCatalog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AthenaDataCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/athena_data_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/athena_data_catalog aws_athena_data_catalog} Resource
  *
  * @param scope The scope in which to define this construct
