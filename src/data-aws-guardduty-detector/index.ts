...
// https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/data-sources/guardduty_detector
...
export class DataAwsGuarddutyDetectorFeaturesAdditionalConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsGuarddutyDetectorFeaturesAdditionalConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsGuarddutyDetectorFeaturesAdditionalConfiguration | undefined) {
    if (value === undefined) {
...
export class DataAwsGuarddutyDetectorFeaturesAdditionalConfigurationList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsGuarddutyDetectorFeaturesAdditionalConfigurationOutputReference {
    return new DataAwsGuarddutyDetectorFeaturesAdditionalConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsGuarddutyDetectorFeaturesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsGuarddutyDetectorFeatures | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsGuarddutyDetectorFeatures | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _additionalConfiguration = new DataAwsGuarddutyDetectorFeaturesAdditionalConfigurationList(this, "additional_configuration", false);
...
export class DataAwsGuarddutyDetectorFeaturesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsGuarddutyDetectorFeaturesOutputReference {
    return new DataAwsGuarddutyDetectorFeaturesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsGuarddutyDetector extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGuarddutyDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/data-sources/guardduty_detector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/data-sources/guardduty_detector aws_guardduty_detector} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _features = new DataAwsGuarddutyDetectorFeaturesList(this, "features", false);
  public get features() {
