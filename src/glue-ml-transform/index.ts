// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/glue_ml_transform
...
export class GlueMlTransform extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueMlTransform that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/glue_ml_transform#import import section} in the documentation of this resource for the id to use
