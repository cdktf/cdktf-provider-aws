...
// https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/media_store_container
...
export class MediaStoreContainer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaStoreContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/media_store_container#import import section} in the documentation of this resource for the id to use
