// https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/budgets_budget
...
export class BudgetsBudget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BudgetsBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/budgets_budget#import import section} in the documentation of this resource for the id to use
