// https://registry.terraform.io/providers/hashicorp/aws/5.44.0/docs/data-sources/lb_target_group
...
export class DataAwsLbTargetGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLbTargetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.44.0/docs/data-sources/lb_target_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.44.0/docs/data-sources/lb_target_group aws_lb_target_group} Data Source
  *
  * @param scope The scope in which to define this construct
