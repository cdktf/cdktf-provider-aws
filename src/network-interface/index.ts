...
// https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/network_interface
...
export class NetworkInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.95.0/docs/resources/network_interface#import import section} in the documentation of this resource for the id to use
