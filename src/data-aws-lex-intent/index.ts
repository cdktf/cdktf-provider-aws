// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/lex_intent
...
export class DataAwsLexIntent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLexIntent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/lex_intent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/data-sources/lex_intent aws_lex_intent} Data Source
  *
  * @param scope The scope in which to define this construct
