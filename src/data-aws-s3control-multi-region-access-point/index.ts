// https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/data-sources/s3control_multi_region_access_point
...
export class DataAwsS3ControlMultiRegionAccessPoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsS3ControlMultiRegionAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/data-sources/s3control_multi_region_access_point#import import section} in the documentation of this resource for the id to use
