// https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/resources/simpledb_domain
...
export class SimpledbDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SimpledbDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/resources/simpledb_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/resources/simpledb_domain aws_simpledb_domain} Resource
  *
  * @param scope The scope in which to define this construct
