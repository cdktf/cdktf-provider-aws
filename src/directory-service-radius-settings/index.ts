...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/directory_service_radius_settings
...
export class DirectoryServiceRadiusSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceRadiusSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/directory_service_radius_settings#import import section} in the documentation of this resource for the id to use
