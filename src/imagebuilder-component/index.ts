// https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/imagebuilder_component
...
export class ImagebuilderComponent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImagebuilderComponent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/imagebuilder_component#import import section} in the documentation of this resource for the id to use
