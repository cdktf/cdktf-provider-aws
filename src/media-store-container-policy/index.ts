...
// https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/media_store_container_policy
...
export class MediaStoreContainerPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaStoreContainerPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/resources/media_store_container_policy#import import section} in the documentation of this resource for the id to use
