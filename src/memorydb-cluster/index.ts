...
// https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/memorydb_cluster
...
export class MemorydbCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MemorydbCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/memorydb_cluster#import import section} in the documentation of this resource for the id to use
