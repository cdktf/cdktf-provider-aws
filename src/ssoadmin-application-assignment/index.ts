// https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/resources/ssoadmin_application_assignment
...
export class SsoadminApplicationAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoadminApplicationAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.68.0/docs/resources/ssoadmin_application_assignment#import import section} in the documentation of this resource for the id to use
