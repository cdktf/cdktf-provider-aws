// https://registry.terraform.io/providers/hashicorp/aws/5.44.0/docs/resources/vpc_ipam
...
export class VpcIpam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpam that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.44.0/docs/resources/vpc_ipam#import import section} in the documentation of this resource for the id to use
