...
// https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/opensearch_authorize_vpc_endpoint_access
...
export class OpensearchAuthorizeVpcEndpointAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchAuthorizeVpcEndpointAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/opensearch_authorize_vpc_endpoint_access#import import section} in the documentation of this resource for the id to use
