...
// https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/data-sources/eks_access_entry
...
export class DataAwsEksAccessEntry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEksAccessEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/data-sources/eks_access_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/data-sources/eks_access_entry aws_eks_access_entry} Data Source
  *
  * @param scope The scope in which to define this construct
