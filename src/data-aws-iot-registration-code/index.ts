// https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/data-sources/iot_registration_code
...
export class DataAwsIotRegistrationCode extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIotRegistrationCode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/data-sources/iot_registration_code#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/data-sources/iot_registration_code aws_iot_registration_code} Data Source
  *
  * @param scope The scope in which to define this construct
