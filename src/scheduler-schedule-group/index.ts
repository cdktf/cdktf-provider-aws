...
// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/scheduler_schedule_group
...
export class SchedulerScheduleGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchedulerScheduleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/scheduler_schedule_group#import import section} in the documentation of this resource for the id to use
