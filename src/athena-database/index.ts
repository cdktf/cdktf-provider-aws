...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/athena_database
...
export class AthenaDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AthenaDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/athena_database#import import section} in the documentation of this resource for the id to use
