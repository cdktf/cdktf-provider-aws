// https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/data-sources/ecs_task_execution
...
export class DataAwsEcsTaskExecution extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEcsTaskExecution that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.85.0/docs/data-sources/ecs_task_execution#import import section} in the documentation of this resource for the id to use
