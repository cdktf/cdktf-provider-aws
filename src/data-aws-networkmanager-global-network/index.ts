// https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/data-sources/networkmanager_global_network
...
export class DataAwsNetworkmanagerGlobalNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerGlobalNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/data-sources/networkmanager_global_network#import import section} in the documentation of this resource for the id to use
