...
// https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/appautoscaling_scheduled_action
...
export class AppautoscalingScheduledAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppautoscalingScheduledAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.39.0/docs/resources/appautoscaling_scheduled_action#import import section} in the documentation of this resource for the id to use
