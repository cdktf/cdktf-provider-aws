// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/neptune_engine_version
...
export class DataAwsNeptuneEngineVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNeptuneEngineVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/neptune_engine_version#import import section} in the documentation of this resource for the id to use
