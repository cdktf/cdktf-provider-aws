...
export class CloudfrontDistributionTrustedSignersItems extends ComplexComputedList {

  // aws_account_number - computed: true, optional: false, required: true
  public get awsAccountNumber() {
    return this.getStringAttribute('aws_account_number');
  }

  // key_pair_ids - computed: true, optional: false, required: true
  public get keyPairIds() {
    return this.getListAttribute('key_pair_ids');
  }
}
export class CloudfrontDistributionTrustedSigners extends ComplexComputedList {
...
export class CloudfrontDistribution extends TerraformResource {
  ...
  // trusted_signers - computed: true, optional: false, required: true
