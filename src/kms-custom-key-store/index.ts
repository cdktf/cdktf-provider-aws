...
// https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/resources/kms_custom_key_store
...
export class KmsCustomKeyStore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsCustomKeyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/resources/kms_custom_key_store#import import section} in the documentation of this resource for the id to use
