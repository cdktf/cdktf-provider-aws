...
// https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/networkmanager_core_network_policy_document
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsViaWithEdgeOverrideToTerraform(struct?: DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsViaWithEdgeOverride | cdktf.IResolvable): any {
  ...
  return {
    edge_sets: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.edgeSets),
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsViaWithEdgeOverrideToHclTerraform(struct?: DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsViaWithEdgeOverride | cdktf.IResolvable): any {
  ...
  const attrs = {
    edge_sets: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.edgeSets),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsViaWithEdgeOverrideOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _edgeSets?: string[]; 
  public get edgeSets() {
    return cdktf.Fn.tolist(this.getListAttribute('edge_sets'));
  }
  public set edgeSets(value: string[]) {
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocument extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerCoreNetworkPolicyDocument that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/networkmanager_core_network_policy_document#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/networkmanager_core_network_policy_document aws_networkmanager_core_network_policy_document} Data Source
  *
  * @param scope The scope in which to define this construct
