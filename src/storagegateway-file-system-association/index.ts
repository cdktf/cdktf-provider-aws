// https://registry.terraform.io/providers/hashicorp/aws/5.62.0/docs/resources/storagegateway_file_system_association
...
export class StoragegatewayFileSystemAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StoragegatewayFileSystemAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.62.0/docs/resources/storagegateway_file_system_association#import import section} in the documentation of this resource for the id to use
