...
// https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/appflow_connector_profile
...
export class AppflowConnectorProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppflowConnectorProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/appflow_connector_profile#import import section} in the documentation of this resource for the id to use
