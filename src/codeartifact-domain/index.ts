...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/codeartifact_domain
...
export class CodeartifactDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodeartifactDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/codeartifact_domain#import import section} in the documentation of this resource for the id to use
