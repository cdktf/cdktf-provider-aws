// https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/dynamodb_resource_policy
...
export class DynamodbResourcePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/dynamodb_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/dynamodb_resource_policy aws_dynamodb_resource_policy} Resource
  *
  * @param scope The scope in which to define this construct
