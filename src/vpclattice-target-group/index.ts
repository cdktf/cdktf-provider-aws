...
// https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/resources/vpclattice_target_group
...
export class VpclatticeTargetGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeTargetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.22.0/docs/resources/vpclattice_target_group#import import section} in the documentation of this resource for the id to use
