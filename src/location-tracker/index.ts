...
// https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/location_tracker
...
export class LocationTracker extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationTracker that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/location_tracker#import import section} in the documentation of this resource for the id to use
