// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/networkfirewall_rule_group
...
export class NetworkfirewallRuleGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkfirewallRuleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/networkfirewall_rule_group#import import section} in the documentation of this resource for the id to use
