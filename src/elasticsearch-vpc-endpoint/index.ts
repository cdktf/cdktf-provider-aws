// https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/resources/elasticsearch_vpc_endpoint
...
export class ElasticsearchVpcEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchVpcEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/resources/elasticsearch_vpc_endpoint#import import section} in the documentation of this resource for the id to use
