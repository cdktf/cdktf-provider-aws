...
// https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/dx_hosted_private_virtual_interface_accepter
...
export class DxHostedPrivateVirtualInterfaceAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxHostedPrivateVirtualInterfaceAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/dx_hosted_private_virtual_interface_accepter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.91.0/docs/resources/dx_hosted_private_virtual_interface_accepter aws_dx_hosted_private_virtual_interface_accepter} Resource
  *
  * @param scope The scope in which to define this construct
