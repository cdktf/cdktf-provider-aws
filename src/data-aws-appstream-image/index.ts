...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/data-sources/appstream_image
...
export class DataAwsAppstreamImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppstreamImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/data-sources/appstream_image#import import section} in the documentation of this resource for the id to use
