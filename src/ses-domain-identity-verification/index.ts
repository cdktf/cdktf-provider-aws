// https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/ses_domain_identity_verification
...
export class SesDomainIdentityVerification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesDomainIdentityVerification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/ses_domain_identity_verification#import import section} in the documentation of this resource for the id to use
