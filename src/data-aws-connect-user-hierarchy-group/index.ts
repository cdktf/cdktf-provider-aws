...
// https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/data-sources/connect_user_hierarchy_group
...
export class DataAwsConnectUserHierarchyGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsConnectUserHierarchyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/data-sources/connect_user_hierarchy_group#import import section} in the documentation of this resource for the id to use
