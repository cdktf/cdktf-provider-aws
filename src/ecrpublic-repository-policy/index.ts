...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/ecrpublic_repository_policy
...
export class EcrpublicRepositoryPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrpublicRepositoryPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/ecrpublic_repository_policy#import import section} in the documentation of this resource for the id to use
