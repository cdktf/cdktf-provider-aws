// https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/sagemaker_image_version
...
export class SagemakerImageVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerImageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.81.0/docs/resources/sagemaker_image_version#import import section} in the documentation of this resource for the id to use
