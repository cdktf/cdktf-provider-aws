...
// https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/mskconnect_connector
...
export class MskconnectConnector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MskconnectConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/mskconnect_connector#import import section} in the documentation of this resource for the id to use
