...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/iot_logging_options
...
export class IotLoggingOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotLoggingOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/iot_logging_options#import import section} in the documentation of this resource for the id to use
