// https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/route53_resolver_firewall_config
...
export interface DataAwsRoute53ResolverFirewallConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/route53_resolver_firewall_config#id DataAwsRoute53ResolverFirewallConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/route53_resolver_firewall_config#resource_id DataAwsRoute53ResolverFirewallConfig#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/route53_resolver_firewall_config aws_route53_resolver_firewall_config}
*/
export class DataAwsRoute53ResolverFirewallConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRoute53ResolverFirewallConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/route53_resolver_firewall_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/route53_resolver_firewall_config aws_route53_resolver_firewall_config} Data Source
  *
  * @param scope The scope in which to define this construct
