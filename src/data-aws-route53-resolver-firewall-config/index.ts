...
// https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/data-sources/route53_resolver_firewall_config
...
export class DataAwsRoute53ResolverFirewallConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRoute53ResolverFirewallConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/data-sources/route53_resolver_firewall_config#import import section} in the documentation of this resource for the id to use
