...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/rds_cluster
...
export class RdsCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/rds_cluster#import import section} in the documentation of this resource for the id to use
