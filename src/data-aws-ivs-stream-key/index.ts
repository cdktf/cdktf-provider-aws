...
// https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/data-sources/ivs_stream_key
...
export class DataAwsIvsStreamKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIvsStreamKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/data-sources/ivs_stream_key#import import section} in the documentation of this resource for the id to use
