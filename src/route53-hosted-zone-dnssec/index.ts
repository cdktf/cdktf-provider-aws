...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/route53_hosted_zone_dnssec
...
export class Route53HostedZoneDnssec extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53HostedZoneDnssec that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/route53_hosted_zone_dnssec#import import section} in the documentation of this resource for the id to use
