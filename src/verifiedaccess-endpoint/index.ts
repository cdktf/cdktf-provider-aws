...
// https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/verifiedaccess_endpoint
...
export class VerifiedaccessEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedaccessEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/verifiedaccess_endpoint#import import section} in the documentation of this resource for the id to use
