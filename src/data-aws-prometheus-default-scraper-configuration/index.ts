// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/prometheus_default_scraper_configuration
...
export class DataAwsPrometheusDefaultScraperConfiguration extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/prometheus_default_scraper_configuration aws_prometheus_default_scraper_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
