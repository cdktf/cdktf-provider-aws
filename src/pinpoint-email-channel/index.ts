// https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/pinpoint_email_channel
...
export class PinpointEmailChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointEmailChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/pinpoint_email_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/pinpoint_email_channel aws_pinpoint_email_channel} Resource
  *
  * @param scope The scope in which to define this construct
