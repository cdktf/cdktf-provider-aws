// https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/resources/appsync_api_cache
...
export class AppsyncApiCache extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncApiCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.0/docs/resources/appsync_api_cache#import import section} in the documentation of this resource for the id to use
