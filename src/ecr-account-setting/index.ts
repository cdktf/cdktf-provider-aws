...
// https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/ecr_account_setting
...
export class EcrAccountSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrAccountSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/ecr_account_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/ecr_account_setting aws_ecr_account_setting} Resource
  *
  * @param scope The scope in which to define this construct
