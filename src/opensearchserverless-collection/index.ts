// https://registry.terraform.io/providers/hashicorp/aws/5.49.0/docs/resources/opensearchserverless_collection
...
export class OpensearchserverlessCollection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchserverlessCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.49.0/docs/resources/opensearchserverless_collection#import import section} in the documentation of this resource for the id to use
