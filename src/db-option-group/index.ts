// https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/resources/db_option_group
...
export class DbOptionGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbOptionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.39.1/docs/resources/db_option_group#import import section} in the documentation of this resource for the id to use
