...
// https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/vpc_network_performance_metric_subscription
...
export class VpcNetworkPerformanceMetricSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcNetworkPerformanceMetricSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/vpc_network_performance_metric_subscription#import import section} in the documentation of this resource for the id to use
