// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/msk_single_scram_secret_association
...
export class MskSingleScramSecretAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MskSingleScramSecretAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/msk_single_scram_secret_association#import import section} in the documentation of this resource for the id to use
