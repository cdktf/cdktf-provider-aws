...
// https://registry.terraform.io/providers/hashicorp/aws/5.38.0/docs/resources/quicksight_template_alias
...
export class QuicksightTemplateAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightTemplateAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.38.0/docs/resources/quicksight_template_alias#import import section} in the documentation of this resource for the id to use
