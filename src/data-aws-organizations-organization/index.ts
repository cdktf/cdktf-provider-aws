// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/data-sources/organizations_organization
...
export class DataAwsOrganizationsOrganization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/data-sources/organizations_organization#import import section} in the documentation of this resource for the id to use
