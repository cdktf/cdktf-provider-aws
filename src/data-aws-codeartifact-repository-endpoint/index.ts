// https://registry.terraform.io/providers/hashicorp/aws/5.73.0/docs/data-sources/codeartifact_repository_endpoint
...
export class DataAwsCodeartifactRepositoryEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCodeartifactRepositoryEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.73.0/docs/data-sources/codeartifact_repository_endpoint#import import section} in the documentation of this resource for the id to use
