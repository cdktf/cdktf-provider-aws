...
// https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/ec2_host
...
export class Ec2Host extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2Host that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.1/docs/resources/ec2_host#import import section} in the documentation of this resource for the id to use
