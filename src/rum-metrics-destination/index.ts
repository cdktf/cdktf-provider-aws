// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/rum_metrics_destination
...
export class RumMetricsDestination extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumMetricsDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/rum_metrics_destination#import import section} in the documentation of this resource for the id to use
