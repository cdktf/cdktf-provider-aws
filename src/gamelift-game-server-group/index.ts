...
// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/gamelift_game_server_group
...
export class GameliftGameServerGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftGameServerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/gamelift_game_server_group#import import section} in the documentation of this resource for the id to use
