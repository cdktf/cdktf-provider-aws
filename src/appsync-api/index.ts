...
// https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/appsync_api
...
export class AppsyncApi extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/appsync_api#import import section} in the documentation of this resource for the id to use
