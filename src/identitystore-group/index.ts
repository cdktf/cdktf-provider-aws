...
// https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/identitystore_group
...
export class IdentitystoreGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentitystoreGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/identitystore_group#import import section} in the documentation of this resource for the id to use
