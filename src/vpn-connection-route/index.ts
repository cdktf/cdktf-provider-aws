// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/vpn_connection_route
...
export class VpnConnectionRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnConnectionRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/vpn_connection_route#import import section} in the documentation of this resource for the id to use
