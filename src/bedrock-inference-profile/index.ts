// https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/bedrock_inference_profile
...
export class BedrockInferenceProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockInferenceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/bedrock_inference_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/bedrock_inference_profile aws_bedrock_inference_profile} Resource
  *
  * @param scope The scope in which to define this construct
