// https://registry.terraform.io/providers/hashicorp/aws/5.74.0/docs/resources/ssoadmin_trusted_token_issuer
...
export class SsoadminTrustedTokenIssuer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoadminTrustedTokenIssuer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.74.0/docs/resources/ssoadmin_trusted_token_issuer#import import section} in the documentation of this resource for the id to use
