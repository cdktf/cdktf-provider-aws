...
// https://registry.terraform.io/providers/hashicorp/aws/6.2.0/docs/data-sources/api_gateway_api_keys
...
export class DataAwsApiGatewayApiKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApiGatewayApiKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.2.0/docs/data-sources/api_gateway_api_keys#import import section} in the documentation of this resource for the id to use
