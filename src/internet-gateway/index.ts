...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/internet_gateway
...
export class InternetGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InternetGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/internet_gateway#import import section} in the documentation of this resource for the id to use
