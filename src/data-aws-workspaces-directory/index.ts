...
// https://registry.terraform.io/providers/hashicorp/aws/5.44.0/docs/data-sources/workspaces_directory
...
export class DataAwsWorkspacesDirectory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWorkspacesDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.44.0/docs/data-sources/workspaces_directory#import import section} in the documentation of this resource for the id to use
