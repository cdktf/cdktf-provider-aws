...
// https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/resources/ce_cost_allocation_tag
...
export class CeCostAllocationTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CeCostAllocationTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.40.0/docs/resources/ce_cost_allocation_tag#import import section} in the documentation of this resource for the id to use
