...
// https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/opsworks_rails_app_layer
...
export class OpsworksRailsAppLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpsworksRailsAppLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/opsworks_rails_app_layer#import import section} in the documentation of this resource for the id to use
