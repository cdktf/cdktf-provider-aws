...
// https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/organizations_delegated_administrator
...
export class OrganizationsDelegatedAdministrator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationsDelegatedAdministrator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/organizations_delegated_administrator#import import section} in the documentation of this resource for the id to use
