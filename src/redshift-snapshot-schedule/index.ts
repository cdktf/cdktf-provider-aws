...
// https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/redshift_snapshot_schedule
...
export class RedshiftSnapshotSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftSnapshotSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/redshift_snapshot_schedule#import import section} in the documentation of this resource for the id to use
