...
// https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/data-sources/appconfig_environment
...
export class DataAwsAppconfigEnvironment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppconfigEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/data-sources/appconfig_environment#import import section} in the documentation of this resource for the id to use
