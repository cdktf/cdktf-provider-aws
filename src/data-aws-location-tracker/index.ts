...
// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/location_tracker
...
export class DataAwsLocationTracker extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationTracker that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/location_tracker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/data-sources/location_tracker aws_location_tracker} Data Source
  *
  * @param scope The scope in which to define this construct
