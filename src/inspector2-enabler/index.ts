// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/inspector2_enabler
...
export class Inspector2Enabler extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Inspector2Enabler that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/inspector2_enabler#import import section} in the documentation of this resource for the id to use
