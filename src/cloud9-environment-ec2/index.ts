...
// https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/cloud9_environment_ec2
...
export class Cloud9EnvironmentEc2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cloud9EnvironmentEc2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/cloud9_environment_ec2#import import section} in the documentation of this resource for the id to use
