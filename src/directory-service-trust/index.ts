...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/directory_service_trust
...
export class DirectoryServiceTrust extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceTrust that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/directory_service_trust#import import section} in the documentation of this resource for the id to use
