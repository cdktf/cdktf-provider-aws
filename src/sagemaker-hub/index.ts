// https://registry.terraform.io/providers/hashicorp/aws/5.77.0/docs/resources/sagemaker_hub
...
export class SagemakerHub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.77.0/docs/resources/sagemaker_hub#import import section} in the documentation of this resource for the id to use
