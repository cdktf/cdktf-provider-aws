...
// https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/resources/ecs_service
...
export class EcsServiceDeploymentConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // bake_time_in_minutes - computed: false, optional: true, required: false
...
export class EcsService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/resources/ecs_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/resources/ecs_service aws_ecs_service} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // availability_zone_rebalancing - computed: false, optional: true, required: false
