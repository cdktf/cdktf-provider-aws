// https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/wafregional_web_acl_association
...
export class WafregionalWebAclAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalWebAclAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/resources/wafregional_web_acl_association#import import section} in the documentation of this resource for the id to use
