...
// https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/schemas_registry_policy
...
export class SchemasRegistryPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemasRegistryPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/schemas_registry_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.8.0/docs/resources/schemas_registry_policy aws_schemas_registry_policy} Resource
  *
  * @param scope The scope in which to define this construct
