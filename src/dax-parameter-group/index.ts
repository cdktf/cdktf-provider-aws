...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/dax_parameter_group
...
export class DaxParameterGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DaxParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/dax_parameter_group#import import section} in the documentation of this resource for the id to use
