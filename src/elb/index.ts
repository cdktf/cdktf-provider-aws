// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/elb
...
export class Elb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Elb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/elb#import import section} in the documentation of this resource for the id to use
