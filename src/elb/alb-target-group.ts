...
export class AlbTargetGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _healthCheck = new AlbTargetGroupHealthCheckOutputReference(this as any, "health_check", true);
  ...
  private _stickiness = new AlbTargetGroupStickinessOutputReference(this as any, "stickiness", true);
