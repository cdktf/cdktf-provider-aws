// https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/gamelift_fleet
...
export class GameliftFleet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/resources/gamelift_fleet#import import section} in the documentation of this resource for the id to use
