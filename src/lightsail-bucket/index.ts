// https://registry.terraform.io/providers/hashicorp/aws/5.63.1/docs/resources/lightsail_bucket
...
export class LightsailBucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.1/docs/resources/lightsail_bucket#import import section} in the documentation of this resource for the id to use
