// https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/workspaces_connection_alias
...
export class WorkspacesConnectionAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspacesConnectionAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.98.0/docs/resources/workspaces_connection_alias#import import section} in the documentation of this resource for the id to use
