...
// https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/resources/quicksight_ingestion
...
export class QuicksightIngestion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightIngestion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/resources/quicksight_ingestion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/resources/quicksight_ingestion aws_quicksight_ingestion} Resource
  *
  * @param scope The scope in which to define this construct
