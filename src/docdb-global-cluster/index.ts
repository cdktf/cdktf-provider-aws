// https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/docdb_global_cluster
...
export class DocdbGlobalCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbGlobalCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.63.0/docs/resources/docdb_global_cluster#import import section} in the documentation of this resource for the id to use
