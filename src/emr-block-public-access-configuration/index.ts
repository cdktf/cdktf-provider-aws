...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/emr_block_public_access_configuration
...
export class EmrBlockPublicAccessConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrBlockPublicAccessConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/emr_block_public_access_configuration#import import section} in the documentation of this resource for the id to use
