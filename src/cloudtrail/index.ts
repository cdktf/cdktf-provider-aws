// https://registry.terraform.io/providers/hashicorp/aws/5.89.0/docs/resources/cloudtrail
...
export class Cloudtrail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cloudtrail that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.89.0/docs/resources/cloudtrail#import import section} in the documentation of this resource for the id to use
