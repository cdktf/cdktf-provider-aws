// https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/controltower_control
...
export class ControltowerControl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ControltowerControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/controltower_control#import import section} in the documentation of this resource for the id to use
