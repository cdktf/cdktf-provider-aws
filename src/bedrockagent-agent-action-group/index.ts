// https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/resources/bedrockagent_agent_action_group
...
export class BedrockagentAgentActionGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockagentAgentActionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/resources/bedrockagent_agent_action_group#import import section} in the documentation of this resource for the id to use
