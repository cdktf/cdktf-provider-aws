// https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/resources/amplify_backend_environment
...
export class AmplifyBackendEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AmplifyBackendEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/resources/amplify_backend_environment#import import section} in the documentation of this resource for the id to use
