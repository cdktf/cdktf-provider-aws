...
// https://registry.terraform.io/providers/hashicorp/aws/5.25.0/docs/resources/chimesdkvoice_sip_media_application
...
export class ChimesdkvoiceSipMediaApplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimesdkvoiceSipMediaApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.25.0/docs/resources/chimesdkvoice_sip_media_application#import import section} in the documentation of this resource for the id to use
