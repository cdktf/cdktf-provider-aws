// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/apigatewayv2_deployment
...
export class Apigatewayv2Deployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Apigatewayv2Deployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/apigatewayv2_deployment#import import section} in the documentation of this resource for the id to use
