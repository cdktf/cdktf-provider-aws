// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/vpc_endpoint_subnet_association
...
export class VpcEndpointSubnetAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointSubnetAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/vpc_endpoint_subnet_association#import import section} in the documentation of this resource for the id to use
