...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/vpclattice_target_group_attachment
...
export class VpclatticeTargetGroupAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeTargetGroupAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/vpclattice_target_group_attachment#import import section} in the documentation of this resource for the id to use
