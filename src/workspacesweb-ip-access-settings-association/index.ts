...
// https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/workspacesweb_ip_access_settings_association
...
export class WorkspaceswebIpAccessSettingsAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceswebIpAccessSettingsAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/workspacesweb_ip_access_settings_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/workspacesweb_ip_access_settings_association aws_workspacesweb_ip_access_settings_association} Resource
  *
  * @param scope The scope in which to define this construct
