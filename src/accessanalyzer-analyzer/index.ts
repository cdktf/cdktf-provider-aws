// https://registry.terraform.io/providers/hashicorp/aws/5.73.0/docs/resources/accessanalyzer_analyzer
...
export class AccessanalyzerAnalyzer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessanalyzerAnalyzer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.73.0/docs/resources/accessanalyzer_analyzer#import import section} in the documentation of this resource for the id to use
