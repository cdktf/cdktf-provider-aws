...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/route53_resolver_rule
...
export class Route53ResolverRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53ResolverRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/resources/route53_resolver_rule#import import section} in the documentation of this resource for the id to use
