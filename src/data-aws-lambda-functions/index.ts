...
// https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/data-sources/lambda_functions
...
export class DataAwsLambdaFunctions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLambdaFunctions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.43.0/docs/data-sources/lambda_functions#import import section} in the documentation of this resource for the id to use
