...
// https://registry.terraform.io/providers/hashicorp/aws/5.49.0/docs/data-sources/elasticsearch_domain
...
export class DataAwsElasticsearchDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticsearchDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.49.0/docs/data-sources/elasticsearch_domain#import import section} in the documentation of this resource for the id to use
