// https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/customerprofiles_domain
...
export class CustomerprofilesDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomerprofilesDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/customerprofiles_domain#import import section} in the documentation of this resource for the id to use
