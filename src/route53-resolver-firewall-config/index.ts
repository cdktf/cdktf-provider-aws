// https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/route53_resolver_firewall_config
...
export class Route53ResolverFirewallConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53ResolverFirewallConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/route53_resolver_firewall_config#import import section} in the documentation of this resource for the id to use
