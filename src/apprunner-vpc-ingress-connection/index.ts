...
// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/apprunner_vpc_ingress_connection
...
export class ApprunnerVpcIngressConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApprunnerVpcIngressConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/apprunner_vpc_ingress_connection#import import section} in the documentation of this resource for the id to use
