...
// https://registry.terraform.io/providers/hashicorp/aws/5.59.0/docs/resources/elasticsearch_domain_policy
...
export class ElasticsearchDomainPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchDomainPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.59.0/docs/resources/elasticsearch_domain_policy#import import section} in the documentation of this resource for the id to use
