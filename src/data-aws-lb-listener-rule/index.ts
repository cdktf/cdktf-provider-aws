...
// https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/data-sources/lb_listener_rule
...
export class DataAwsLbListenerRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLbListenerRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/data-sources/lb_listener_rule#import import section} in the documentation of this resource for the id to use
