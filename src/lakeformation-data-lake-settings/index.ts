// https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/lakeformation_data_lake_settings
...
export class LakeformationDataLakeSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LakeformationDataLakeSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/resources/lakeformation_data_lake_settings#import import section} in the documentation of this resource for the id to use
