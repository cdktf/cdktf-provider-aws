// https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/sns_sms_preferences
...
export class SnsSmsPreferences extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnsSmsPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/resources/sns_sms_preferences#import import section} in the documentation of this resource for the id to use
