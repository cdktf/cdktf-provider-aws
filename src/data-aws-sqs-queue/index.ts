...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/sqs_queue
...
export class DataAwsSqsQueue extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSqsQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/sqs_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/sqs_queue aws_sqs_queue} Data Source
  *
  * @param scope The scope in which to define this construct
