...
// https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/outposts_sites
...
export class DataAwsOutpostsSites extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOutpostsSites that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/outposts_sites#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/outposts_sites aws_outposts_sites} Data Source
  *
  * @param scope The scope in which to define this construct
