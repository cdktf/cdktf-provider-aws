// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/glue_partition_index
...
export class GluePartitionIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GluePartitionIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/glue_partition_index#import import section} in the documentation of this resource for the id to use
