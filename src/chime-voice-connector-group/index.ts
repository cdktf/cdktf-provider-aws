// https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/chime_voice_connector_group
...
export class ChimeVoiceConnectorGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimeVoiceConnectorGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/chime_voice_connector_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.26.0/docs/resources/chime_voice_connector_group aws_chime_voice_connector_group} Resource
  *
  * @param scope The scope in which to define this construct
