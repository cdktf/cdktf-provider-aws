// https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/efs_file_system
...
export class EfsFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EfsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.69.0/docs/resources/efs_file_system#import import section} in the documentation of this resource for the id to use
