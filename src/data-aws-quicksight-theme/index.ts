...
// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/quicksight_theme
...
export class DataAwsQuicksightTheme extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsQuicksightTheme that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/data-sources/quicksight_theme#import import section} in the documentation of this resource for the id to use
