...
// https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/sagemaker_endpoint_configuration
...
export class SagemakerEndpointConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerEndpointConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/sagemaker_endpoint_configuration#import import section} in the documentation of this resource for the id to use
