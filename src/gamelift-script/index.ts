...
// https://registry.terraform.io/providers/hashicorp/aws/5.49.0/docs/resources/gamelift_script
...
export class GameliftScript extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.49.0/docs/resources/gamelift_script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.49.0/docs/resources/gamelift_script aws_gamelift_script} Resource
  *
  * @param scope The scope in which to define this construct
