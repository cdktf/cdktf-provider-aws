// https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/network_acl
...
export class NetworkAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/network_acl#import import section} in the documentation of this resource for the id to use
