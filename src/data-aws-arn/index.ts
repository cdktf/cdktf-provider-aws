// https://registry.terraform.io/providers/hashicorp/aws/5.27.0/docs/data-sources/arn
...
export class DataAwsArn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsArn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.27.0/docs/data-sources/arn#import import section} in the documentation of this resource for the id to use
