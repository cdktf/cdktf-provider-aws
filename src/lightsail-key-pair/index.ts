// https://registry.terraform.io/providers/hashicorp/aws/5.79.0/docs/resources/lightsail_key_pair
...
export class LightsailKeyPair extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailKeyPair that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.79.0/docs/resources/lightsail_key_pair#import import section} in the documentation of this resource for the id to use
