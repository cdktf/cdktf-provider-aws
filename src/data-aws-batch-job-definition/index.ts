...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/data-sources/batch_job_definition
...
export class DataAwsBatchJobDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBatchJobDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/data-sources/batch_job_definition#import import section} in the documentation of this resource for the id to use
