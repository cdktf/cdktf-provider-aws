// https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/osis_pipeline
...
export class OsisPipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OsisPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/resources/osis_pipeline#import import section} in the documentation of this resource for the id to use
