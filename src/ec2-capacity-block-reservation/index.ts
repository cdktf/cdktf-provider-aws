...
// https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/ec2_capacity_block_reservation
...
export class Ec2CapacityBlockReservation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2CapacityBlockReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/ec2_capacity_block_reservation#import import section} in the documentation of this resource for the id to use
