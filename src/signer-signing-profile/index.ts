// https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/resources/signer_signing_profile
...
export class SignerSigningProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SignerSigningProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/resources/signer_signing_profile#import import section} in the documentation of this resource for the id to use
