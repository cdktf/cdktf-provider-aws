// https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/resources/bedrockagent_data_source
...
export class BedrockagentDataSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockagentDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.60.0/docs/resources/bedrockagent_data_source#import import section} in the documentation of this resource for the id to use
