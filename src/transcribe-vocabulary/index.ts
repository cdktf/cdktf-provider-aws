// https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/transcribe_vocabulary
...
export class TranscribeVocabulary extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TranscribeVocabulary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.30.0/docs/resources/transcribe_vocabulary#import import section} in the documentation of this resource for the id to use
