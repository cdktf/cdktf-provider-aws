...
// https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/bedrock_custom_model
...
export class BedrockCustomModel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockCustomModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.50.0/docs/resources/bedrock_custom_model#import import section} in the documentation of this resource for the id to use
