// https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/resources/chatbot_teams_channel_configuration
...
export class ChatbotTeamsChannelConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChatbotTeamsChannelConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.93.0/docs/resources/chatbot_teams_channel_configuration#import import section} in the documentation of this resource for the id to use
