// https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/transfer_ssh_key
...
export class TransferSshKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.53.0/docs/resources/transfer_ssh_key#import import section} in the documentation of this resource for the id to use
