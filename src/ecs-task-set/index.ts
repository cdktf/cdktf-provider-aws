// https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/resources/ecs_task_set
...
export class EcsTaskSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsTaskSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/resources/ecs_task_set#import import section} in the documentation of this resource for the id to use
