// https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/data-sources/signer_signing_job
...
export class DataAwsSignerSigningJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSignerSigningJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.90.1/docs/data-sources/signer_signing_job#import import section} in the documentation of this resource for the id to use
