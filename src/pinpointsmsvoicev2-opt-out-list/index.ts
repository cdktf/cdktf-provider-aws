...
// https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/pinpointsmsvoicev2_opt_out_list
...
export class Pinpointsmsvoicev2OptOutList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Pinpointsmsvoicev2OptOutList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.78.0/docs/resources/pinpointsmsvoicev2_opt_out_list#import import section} in the documentation of this resource for the id to use
