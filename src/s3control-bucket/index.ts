...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/s3control_bucket
...
export class S3ControlBucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/s3control_bucket#import import section} in the documentation of this resource for the id to use
