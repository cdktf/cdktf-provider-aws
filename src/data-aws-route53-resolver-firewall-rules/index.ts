// https://registry.terraform.io/providers/hashicorp/aws/5.86.1/docs/data-sources/route53_resolver_firewall_rules
...
export class DataAwsRoute53ResolverFirewallRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRoute53ResolverFirewallRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.1/docs/data-sources/route53_resolver_firewall_rules#import import section} in the documentation of this resource for the id to use
