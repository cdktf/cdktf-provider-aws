...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/location_route_calculator
...
export class LocationRouteCalculator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationRouteCalculator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/location_route_calculator#import import section} in the documentation of this resource for the id to use
