...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/iam_role_policy_attachment
...
export class IamRolePolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamRolePolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/iam_role_policy_attachment#import import section} in the documentation of this resource for the id to use
