...
// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/oam_sink_policy
...
export class OamSinkPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OamSinkPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/oam_sink_policy#import import section} in the documentation of this resource for the id to use
