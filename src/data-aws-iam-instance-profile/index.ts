...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/iam_instance_profile
...
export class DataAwsIamInstanceProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamInstanceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/data-sources/iam_instance_profile#import import section} in the documentation of this resource for the id to use
