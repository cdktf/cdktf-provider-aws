...
// https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/data-sources/rds_orderable_db_instance
...
export class DataAwsRdsOrderableDbInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRdsOrderableDbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/data-sources/rds_orderable_db_instance#import import section} in the documentation of this resource for the id to use
