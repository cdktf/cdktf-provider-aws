...
// https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/iot_thing_principal_attachment
...
export class IotThingPrincipalAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotThingPrincipalAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/iot_thing_principal_attachment#import import section} in the documentation of this resource for the id to use
