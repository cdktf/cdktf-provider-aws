// https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/imagebuilder_image_recipe
...
export class ImagebuilderImageRecipe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImagebuilderImageRecipe that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/imagebuilder_image_recipe#import import section} in the documentation of this resource for the id to use
