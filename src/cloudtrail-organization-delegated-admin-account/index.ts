...
// https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/cloudtrail_organization_delegated_admin_account
...
export class CloudtrailOrganizationDelegatedAdminAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudtrailOrganizationDelegatedAdminAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.0.0/docs/resources/cloudtrail_organization_delegated_admin_account#import import section} in the documentation of this resource for the id to use
