...
// https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/route53_cidr_location
...
export class Route53CidrLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53CidrLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.9.0/docs/resources/route53_cidr_location#import import section} in the documentation of this resource for the id to use
