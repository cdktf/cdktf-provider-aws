// https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/waf_size_constraint_set
...
export class WafSizeConstraintSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafSizeConstraintSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.86.0/docs/resources/waf_size_constraint_set#import import section} in the documentation of this resource for the id to use
