...
// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/data-sources/cloudformation_export
...
export class DataAwsCloudformationExport extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudformationExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/data-sources/cloudformation_export#import import section} in the documentation of this resource for the id to use
