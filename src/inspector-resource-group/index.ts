// https://registry.terraform.io/providers/hashicorp/aws/5.72.1/docs/resources/inspector_resource_group
...
export class InspectorResourceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InspectorResourceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.1/docs/resources/inspector_resource_group#import import section} in the documentation of this resource for the id to use
