...
// https://registry.terraform.io/providers/hashicorp/aws/5.65.0/docs/data-sources/appmesh_virtual_node
...
export class DataAwsAppmeshVirtualNode extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppmeshVirtualNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.65.0/docs/data-sources/appmesh_virtual_node#import import section} in the documentation of this resource for the id to use
