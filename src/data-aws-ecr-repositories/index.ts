// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ecr_repositories
...
export class DataAwsEcrRepositories extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEcrRepositories that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ecr_repositories#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/data-sources/ecr_repositories aws_ecr_repositories} Data Source
  *
  * @param scope The scope in which to define this construct
