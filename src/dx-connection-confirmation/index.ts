...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/dx_connection_confirmation
...
export class DxConnectionConfirmation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxConnectionConfirmation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/dx_connection_confirmation#import import section} in the documentation of this resource for the id to use
