...
// https://registry.terraform.io/providers/hashicorp/aws/5.46.0/docs/resources/globalaccelerator_custom_routing_accelerator
...
export class GlobalacceleratorCustomRoutingAccelerator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalacceleratorCustomRoutingAccelerator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.46.0/docs/resources/globalaccelerator_custom_routing_accelerator#import import section} in the documentation of this resource for the id to use
