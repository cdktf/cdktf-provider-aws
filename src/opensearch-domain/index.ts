...
// https://registry.terraform.io/providers/hashicorp/aws/5.79.0/docs/resources/opensearch_domain
...
export class OpensearchDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.79.0/docs/resources/opensearch_domain#import import section} in the documentation of this resource for the id to use
