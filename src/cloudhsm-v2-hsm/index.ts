// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/cloudhsm_v2_hsm
...
export class CloudhsmV2Hsm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudhsmV2Hsm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/cloudhsm_v2_hsm#import import section} in the documentation of this resource for the id to use
