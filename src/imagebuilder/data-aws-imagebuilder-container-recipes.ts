...
export class DataAwsImagebuilderContainerRecipesFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsImagebuilderContainerRecipesFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAwsImagebuilderContainerRecipesFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAwsImagebuilderContainerRecipesFilterList extends cdktf.ComplexList {
  public internalValue? : DataAwsImagebuilderContainerRecipesFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataAwsImagebuilderContainerRecipesFilterOutputReference {
    return new DataAwsImagebuilderContainerRecipesFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsImagebuilderContainerRecipes extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _filter = new DataAwsImagebuilderContainerRecipesFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataAwsImagebuilderContainerRecipesFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataAwsImagebuilderContainerRecipesFilterToTerraform, true)(this._filter.internalValue),
    };
  }
}
