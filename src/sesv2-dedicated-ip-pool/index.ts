...
// https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/sesv2_dedicated_ip_pool
...
export class Sesv2DedicatedIpPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2DedicatedIpPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/sesv2_dedicated_ip_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/sesv2_dedicated_ip_pool aws_sesv2_dedicated_ip_pool} Resource
  *
  * @param scope The scope in which to define this construct
