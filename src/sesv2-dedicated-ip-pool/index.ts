...
// https://registry.terraform.io/providers/hashicorp/aws/5.74.0/docs/resources/sesv2_dedicated_ip_pool
...
export class Sesv2DedicatedIpPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2DedicatedIpPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.74.0/docs/resources/sesv2_dedicated_ip_pool#import import section} in the documentation of this resource for the id to use
