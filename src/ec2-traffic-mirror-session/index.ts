...
// https://registry.terraform.io/providers/hashicorp/aws/5.36.0/docs/resources/ec2_traffic_mirror_session
...
export class Ec2TrafficMirrorSession extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2TrafficMirrorSession that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.36.0/docs/resources/ec2_traffic_mirror_session#import import section} in the documentation of this resource for the id to use
