...
export class GrafanaRoleAssociationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GrafanaRoleAssociationTimeouts | undefined {
  ...
  public set internalValue(value: GrafanaRoleAssociationTimeouts | undefined) {
    if (value === undefined) {
...
export class GrafanaRoleAssociation extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "aws_grafana_role_association";
  ...
  */
  ...
  private _timeouts = new GrafanaRoleAssociationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
