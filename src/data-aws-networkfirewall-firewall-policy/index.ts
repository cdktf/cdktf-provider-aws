// https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/data-sources/networkfirewall_firewall_policy
...
export class DataAwsNetworkfirewallFirewallPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkfirewallFirewallPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/data-sources/networkfirewall_firewall_policy#import import section} in the documentation of this resource for the id to use
