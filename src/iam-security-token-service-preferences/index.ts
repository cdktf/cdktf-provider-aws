...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/iam_security_token_service_preferences
...
export class IamSecurityTokenServicePreferences extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamSecurityTokenServicePreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/iam_security_token_service_preferences#import import section} in the documentation of this resource for the id to use
