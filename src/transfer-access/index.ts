...
// https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/transfer_access
...
export class TransferAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/transfer_access#import import section} in the documentation of this resource for the id to use
