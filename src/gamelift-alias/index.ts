// https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/gamelift_alias
...
export class GameliftAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/resources/gamelift_alias#import import section} in the documentation of this resource for the id to use
