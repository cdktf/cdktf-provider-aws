// https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/resources/datasync_location_object_storage
...
export class DatasyncLocationObjectStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncLocationObjectStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/resources/datasync_location_object_storage#import import section} in the documentation of this resource for the id to use
