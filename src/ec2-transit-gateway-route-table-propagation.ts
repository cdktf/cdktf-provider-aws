...
export interface Ec2TransitGatewayRouteTablePropagationConfig extends TerraformMetaArguments {
...
export class Ec2TransitGatewayRouteTablePropagation extends TerraformResource {
