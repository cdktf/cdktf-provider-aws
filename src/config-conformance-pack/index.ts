...
// https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/config_conformance_pack
...
export class ConfigConformancePack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigConformancePack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.51.1/docs/resources/config_conformance_pack#import import section} in the documentation of this resource for the id to use
