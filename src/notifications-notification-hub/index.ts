...
// https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/notifications_notification_hub
...
export class NotificationsNotificationHub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationsNotificationHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.4.0/docs/resources/notifications_notification_hub#import import section} in the documentation of this resource for the id to use
