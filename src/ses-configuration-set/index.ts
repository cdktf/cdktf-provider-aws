// https://registry.terraform.io/providers/hashicorp/aws/5.41.0/docs/resources/ses_configuration_set
...
export class SesConfigurationSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesConfigurationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.41.0/docs/resources/ses_configuration_set#import import section} in the documentation of this resource for the id to use
