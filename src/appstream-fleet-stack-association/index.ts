// https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/appstream_fleet_stack_association
...
export class AppstreamFleetStackAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppstreamFleetStackAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/appstream_fleet_stack_association#import import section} in the documentation of this resource for the id to use
