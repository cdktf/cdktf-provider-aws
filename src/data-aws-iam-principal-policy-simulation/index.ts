...
// https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/data-sources/iam_principal_policy_simulation
...
export class DataAwsIamPrincipalPolicySimulation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamPrincipalPolicySimulation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/data-sources/iam_principal_policy_simulation#import import section} in the documentation of this resource for the id to use
