...
// https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/ssoadmin_application_assignments
...
export class DataAwsSsoadminApplicationAssignments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsoadminApplicationAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.48.0/docs/data-sources/ssoadmin_application_assignments#import import section} in the documentation of this resource for the id to use
