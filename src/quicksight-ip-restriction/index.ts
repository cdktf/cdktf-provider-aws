...
// https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/quicksight_ip_restriction
...
export class QuicksightIpRestriction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightIpRestriction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/quicksight_ip_restriction#import import section} in the documentation of this resource for the id to use
