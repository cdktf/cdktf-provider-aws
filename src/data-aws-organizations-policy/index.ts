...
// https://registry.terraform.io/providers/hashicorp/aws/5.59.0/docs/data-sources/organizations_policy
...
export class DataAwsOrganizationsPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.59.0/docs/data-sources/organizations_policy#import import section} in the documentation of this resource for the id to use
