// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/ebs_encryption_by_default
...
export class EbsEncryptionByDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsEncryptionByDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/ebs_encryption_by_default#import import section} in the documentation of this resource for the id to use
