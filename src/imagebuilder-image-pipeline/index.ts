// https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/imagebuilder_image_pipeline
...
export class ImagebuilderImagePipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImagebuilderImagePipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/imagebuilder_image_pipeline#import import section} in the documentation of this resource for the id to use
