// https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/devopsguru_resource_collection
...
export class DevopsguruResourceCollection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevopsguruResourceCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.64.0/docs/resources/devopsguru_resource_collection#import import section} in the documentation of this resource for the id to use
