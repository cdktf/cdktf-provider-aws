...
// https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/kinesis_analytics_application
...
export class KinesisAnalyticsApplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisAnalyticsApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/kinesis_analytics_application#import import section} in the documentation of this resource for the id to use
