...
// https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/opensearchserverless_security_policy
...
export class OpensearchserverlessSecurityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchserverlessSecurityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/opensearchserverless_security_policy#import import section} in the documentation of this resource for the id to use
