...
export class KinesisFirehoseDeliveryStream extends TerraformResource {
  ...
  public set httpEndpointConfiguration(value: KinesisFirehoseDeliveryStreamHttpEndpointConfiguration[] | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      http_endpoint_configuration: this._httpEndpointConfiguration,
