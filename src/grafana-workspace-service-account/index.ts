...
// https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/grafana_workspace_service_account
...
export class GrafanaWorkspaceServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrafanaWorkspaceServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/resources/grafana_workspace_service_account#import import section} in the documentation of this resource for the id to use
