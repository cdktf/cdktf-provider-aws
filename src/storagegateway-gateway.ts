...
export class StoragegatewayGatewayGatewayNetworkInterface extends ComplexComputedList {

  // ipv4_address - computed: true, optional: false, required: true
...
export class StoragegatewayGateway extends TerraformResource {
  ...
  // gateway_network_interface - computed: true, optional: false, required: true
  ...
  // host_environment - computed: true, optional: false, required: true
  ...
  public get smbSecurityStrategy() {
    return this._smbSecurityStrategy ?? this.getStringAttribute('smb_security_strategy');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      average_download_rate_limit_in_bits_per_sec: this._averageDownloadRateLimitInBitsPerSec,
      average_upload_rate_limit_in_bits_per_sec: this._averageUploadRateLimitInBitsPerSec,
      ...
      smb_security_strategy: this._smbSecurityStrategy,
      tags: this._tags,
