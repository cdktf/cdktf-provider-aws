...
// https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/vpc_route_server_peer
...
export class VpcRouteServerPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcRouteServerPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.5.0/docs/resources/vpc_route_server_peer#import import section} in the documentation of this resource for the id to use
