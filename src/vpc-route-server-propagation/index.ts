...
// https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/vpc_route_server_propagation
...
export class VpcRouteServerPropagation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcRouteServerPropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.6.0/docs/resources/vpc_route_server_propagation#import import section} in the documentation of this resource for the id to use
