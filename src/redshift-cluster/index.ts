// https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/resources/redshift_cluster
...
export class RedshiftCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.75.0/docs/resources/redshift_cluster#import import section} in the documentation of this resource for the id to use
