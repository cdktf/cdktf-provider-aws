...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/ses_identity_policy
...
export class SesIdentityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesIdentityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/ses_identity_policy#import import section} in the documentation of this resource for the id to use
