// https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/glue_workflow
...
export class GlueWorkflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.34.0/docs/resources/glue_workflow#import import section} in the documentation of this resource for the id to use
