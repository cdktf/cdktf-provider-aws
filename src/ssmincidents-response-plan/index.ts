...
// https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/ssmincidents_response_plan
...
export class SsmincidentsResponsePlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmincidentsResponsePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/resources/ssmincidents_response_plan#import import section} in the documentation of this resource for the id to use
