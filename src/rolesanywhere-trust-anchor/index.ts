...
// https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/rolesanywhere_trust_anchor
...
export class RolesanywhereTrustAnchor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RolesanywhereTrustAnchor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/rolesanywhere_trust_anchor#import import section} in the documentation of this resource for the id to use
