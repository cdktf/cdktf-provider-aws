// https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/dx_bgp_peer
...
export class DxBgpPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxBgpPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/dx_bgp_peer#import import section} in the documentation of this resource for the id to use
