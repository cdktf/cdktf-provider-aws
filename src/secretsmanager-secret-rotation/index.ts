...
// https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/secretsmanager_secret_rotation
...
export class SecretsmanagerSecretRotation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsmanagerSecretRotation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/secretsmanager_secret_rotation#import import section} in the documentation of this resource for the id to use
