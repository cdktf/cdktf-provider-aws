...
// https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/efs_backup_policy
...
export class EfsBackupPolicy extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/efs_backup_policy aws_efs_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
