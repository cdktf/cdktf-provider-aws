// https://registry.terraform.io/providers/hashicorp/aws/5.46.0/docs/resources/shield_drt_access_log_bucket_association
...
export class ShieldDrtAccessLogBucketAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ShieldDrtAccessLogBucketAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.46.0/docs/resources/shield_drt_access_log_bucket_association#import import section} in the documentation of this resource for the id to use
