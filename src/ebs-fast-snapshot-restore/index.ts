// https://registry.terraform.io/providers/hashicorp/aws/5.51.0/docs/resources/ebs_fast_snapshot_restore
...
export class EbsFastSnapshotRestore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsFastSnapshotRestore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.51.0/docs/resources/ebs_fast_snapshot_restore#import import section} in the documentation of this resource for the id to use
