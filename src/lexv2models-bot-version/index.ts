// https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/lexv2models_bot_version
...
export class Lexv2ModelsBotVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lexv2ModelsBotVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/lexv2models_bot_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.1/docs/resources/lexv2models_bot_version aws_lexv2models_bot_version} Resource
  *
  * @param scope The scope in which to define this construct
