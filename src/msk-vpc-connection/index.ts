...
// https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/msk_vpc_connection
...
export class MskVpcConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MskVpcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.56.0/docs/resources/msk_vpc_connection#import import section} in the documentation of this resource for the id to use
