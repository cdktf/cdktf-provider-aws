...
// https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/resources/ebs_default_kms_key
...
export class EbsDefaultKmsKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbsDefaultKmsKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/resources/ebs_default_kms_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/resources/ebs_default_kms_key aws_ebs_default_kms_key} Resource
  *
  * @param scope The scope in which to define this construct
