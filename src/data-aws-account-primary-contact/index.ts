...
// https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/data-sources/account_primary_contact
...
export class DataAwsAccountPrimaryContact extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAccountPrimaryContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.7.0/docs/data-sources/account_primary_contact#import import section} in the documentation of this resource for the id to use
