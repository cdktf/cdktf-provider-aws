// https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/evidently_feature
...
export class EvidentlyFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EvidentlyFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.45.0/docs/resources/evidently_feature#import import section} in the documentation of this resource for the id to use
