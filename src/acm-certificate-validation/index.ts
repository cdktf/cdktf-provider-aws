...
// https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/acm_certificate_validation
...
export class AcmCertificateValidation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AcmCertificateValidation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/acm_certificate_validation#import import section} in the documentation of this resource for the id to use
