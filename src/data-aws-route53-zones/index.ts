...
// https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/route53_zones
...
export class DataAwsRoute53Zones extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRoute53Zones that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/route53_zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/5.67.0/docs/data-sources/route53_zones aws_route53_zones} Data Source
  *
  * @param scope The scope in which to define this construct
