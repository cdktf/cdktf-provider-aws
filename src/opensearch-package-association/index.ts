// https://registry.terraform.io/providers/hashicorp/aws/5.41.0/docs/resources/opensearch_package_association
...
export class OpensearchPackageAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchPackageAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.41.0/docs/resources/opensearch_package_association#import import section} in the documentation of this resource for the id to use
