// https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/inspector_assessment_template
...
export class InspectorAssessmentTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InspectorAssessmentTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.37.0/docs/resources/inspector_assessment_template#import import section} in the documentation of this resource for the id to use
