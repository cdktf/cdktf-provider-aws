// https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/data-sources/location_map
...
export class DataAwsLocationMap extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/5.92.0/docs/data-sources/location_map#import import section} in the documentation of this resource for the id to use
