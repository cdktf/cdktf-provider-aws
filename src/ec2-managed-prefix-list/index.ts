...
// https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/ec2_managed_prefix_list
...
export class Ec2ManagedPrefixList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ManagedPrefixList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.3.0/docs/resources/ec2_managed_prefix_list#import import section} in the documentation of this resource for the id to use
