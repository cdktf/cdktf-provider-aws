...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/networkmanagerconnection"
...
&networkmanagerconnection.NetworkmanagerConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.networkmanagerConnection.NetworkmanagerConnectionTimeouts,
}
```
