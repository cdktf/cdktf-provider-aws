...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/networkmanagerconnection"
...
&networkmanagerconnection.NetworkmanagerConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.networkmanagerConnection.NetworkmanagerConnectionTimeouts,
}
```
