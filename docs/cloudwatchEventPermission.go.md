...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/cloudwatcheventpermission"
...
&cloudwatcheventpermission.CloudwatchEventPermissionConfig {
	...
	StatementId: *string,
	Action: *string,
	Condition: github.com/cdktf/cdktf-provider-aws-go/aws/v12.cloudwatchEventPermission.CloudwatchEventPermissionCondition,
	EventBusName: *string,
	Id: *string,
}
```
