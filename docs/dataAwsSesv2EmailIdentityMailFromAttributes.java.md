...
Refer to the Terraform Registory for docs: [`data_aws_sesv2_email_identity_mail_from_attributes`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/sesv2_email_identity_mail_from_attributes).
