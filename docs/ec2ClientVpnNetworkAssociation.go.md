...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/ec2clientvpnnetworkassociation"
...
ec2clientvpnnetworkassociation.Ec2ClientVpnNetworkAssociation_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| <code><a href="#@cdktf/provider-aws.ec2ClientVpnNetworkAssociation.Ec2ClientVpnNetworkAssociation.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&ec2clientvpnnetworkassociation.Ec2ClientVpnNetworkAssociationConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.ec2ClientVpnNetworkAssociation.Ec2ClientVpnNetworkAssociationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.ec2ClientVpnNetworkAssociation.Ec2ClientVpnNetworkAssociationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
