...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/kendraquerysuggestionsblocklist"
...
&kendraquerysuggestionsblocklist.KendraQuerySuggestionsBlockListConfig {
	...
	Name: *string,
	RoleArn: *string,
	SourceS3Path: github.com/cdktf/cdktf-provider-aws-go/aws/v17.kendraQuerySuggestionsBlockList.KendraQuerySuggestionsBlockListSourceS3Path,
	Description: *string,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.kendraQuerySuggestionsBlockList.KendraQuerySuggestionsBlockListTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.kendraQuerySuggestionsBlockList.KendraQuerySuggestionsBlockListConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.15.0/docs/resources/kendra_query_suggestions_block_list#tags KendraQuerySuggestionsBlockList#tags}. |
| <code><a href="#@cdktf/provider-aws.kendraQuerySuggestionsBlockList.KendraQuerySuggestionsBlockListConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.15.0/docs/resources/kendra_query_suggestions_block_list#tags_all KendraQuerySuggestionsBlockList#tags_all}. |
