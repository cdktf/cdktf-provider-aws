...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/servicecatalogportfolio"
...
&servicecatalogportfolio.ServicecatalogPortfolioConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.servicecatalogPortfolio.ServicecatalogPortfolioTimeouts,
}
```
