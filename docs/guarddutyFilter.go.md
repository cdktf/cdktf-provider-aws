...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/guarddutyfilter"
...
&guarddutyfilter.GuarddutyFilterConfig {
	...
	Action: *string,
	DetectorId: *string,
	FindingCriteria: github.com/cdktf/cdktf-provider-aws-go/aws/v17.guarddutyFilter.GuarddutyFilterFindingCriteria,
	Name: *string,
	Rank: *f64,
	Description: *string,
	Id: *string,
...
| <code><a href="#@cdktf/provider-aws.guarddutyFilter.GuarddutyFilterConfig.property.rank">Rank</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.16.2/docs/resources/guardduty_filter#rank GuarddutyFilter#rank}. |
...
| <code><a href="#@cdktf/provider-aws.guarddutyFilter.GuarddutyFilterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.16.2/docs/resources/guardduty_filter#tags GuarddutyFilter#tags}. |
| <code><a href="#@cdktf/provider-aws.guarddutyFilter.GuarddutyFilterConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.16.2/docs/resources/guardduty_filter#tags_all GuarddutyFilter#tags_all}. |
