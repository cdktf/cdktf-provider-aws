...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/accountregion"
...
&accountregion.AccountRegionConfig {
	...
	AccountId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.accountRegion.AccountRegionTimeouts,
}
```
