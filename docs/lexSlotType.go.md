...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/lexslottype"
...
&lexslottype.LexSlotTypeConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.lexSlotType.LexSlotTypeTimeouts,
