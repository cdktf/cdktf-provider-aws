...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dxhostedprivatevirtualinterfaceaccepter"
...
&dxhostedprivatevirtualinterfaceaccepter.DxHostedPrivateVirtualInterfaceAccepterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dxHostedPrivateVirtualInterfaceAccepter.DxHostedPrivateVirtualInterfaceAccepterTimeouts,
	VpnGatewayId: *string,
}
```
