...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dxhostedprivatevirtualinterfaceaccepter"
...
&dxhostedprivatevirtualinterfaceaccepter.DxHostedPrivateVirtualInterfaceAccepterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dxHostedPrivateVirtualInterfaceAccepter.DxHostedPrivateVirtualInterfaceAccepterTimeouts,
	VpnGatewayId: *string,
}
```
