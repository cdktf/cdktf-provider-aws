...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dxhostedprivatevirtualinterfaceaccepter"
...
&dxhostedprivatevirtualinterfaceaccepter.DxHostedPrivateVirtualInterfaceAccepterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dxHostedPrivateVirtualInterfaceAccepter.DxHostedPrivateVirtualInterfaceAccepterTimeouts,
	VpnGatewayId: *string,
}
```
