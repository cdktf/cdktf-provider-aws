...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/configorganizationmanagedrule"
...
&configorganizationmanagedrule.ConfigOrganizationManagedRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.configOrganizationManagedRule.ConfigOrganizationManagedRuleTimeouts,
}
```
