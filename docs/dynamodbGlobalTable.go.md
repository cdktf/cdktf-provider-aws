...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dynamodbglobaltable"
...
&dynamodbglobaltable.DynamodbGlobalTableConfig {
	...
	Replica: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dynamodbGlobalTable.DynamodbGlobalTableTimeouts,
}
```
