...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsvpngateway"
...
&dataawsvpngateway.DataAwsVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsVpnGateway.DataAwsVpnGatewayTimeouts,
}
```
