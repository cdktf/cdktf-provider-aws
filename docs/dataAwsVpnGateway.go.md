...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/dataawsvpngateway"
...
&dataawsvpngateway.DataAwsVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v18.dataAwsVpnGateway.DataAwsVpnGatewayTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsVpnGateway.DataAwsVpnGatewayConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/data-sources/vpn_gateway#tags DataAwsVpnGateway#tags}. |
