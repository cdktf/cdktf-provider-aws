...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsvpngateway"
...
&dataawsvpngateway.DataAwsVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsVpnGateway.DataAwsVpnGatewayTimeouts,
}
```
