...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsvpngateway"
...
&dataawsvpngateway.DataAwsVpnGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsVpnGateway.DataAwsVpnGatewayTimeouts,
}
```
