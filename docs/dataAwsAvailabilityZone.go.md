...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsavailabilityzone"
...
| <code><a href="#@cdktf/provider-aws.dataAwsAvailabilityZone.DataAwsAvailabilityZone.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dataawsavailabilityzone.DataAwsAvailabilityZoneConfig {
	...
	Region: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.dataAwsAvailabilityZone.DataAwsAvailabilityZoneTimeouts,
	ZoneId: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsAvailabilityZone.DataAwsAvailabilityZoneConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAvailabilityZone.DataAwsAvailabilityZoneConfig.property.allAvailabilityZones">AllAvailabilityZones</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/availability_zone#all_availability_zones DataAwsAvailabilityZone#all_availability_zones}. |
