...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsavailabilityzone"
...
&dataawsavailabilityzone.DataAwsAvailabilityZoneConfig {
	...
	Name: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsAvailabilityZone.DataAwsAvailabilityZoneTimeouts,
	ZoneId: *string,
}
```
