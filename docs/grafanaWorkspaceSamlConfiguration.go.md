...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/grafanaworkspacesamlconfiguration"
...
&grafanaworkspacesamlconfiguration.GrafanaWorkspaceSamlConfigurationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.grafanaWorkspaceSamlConfiguration.GrafanaWorkspaceSamlConfigurationTimeouts,
}
```
