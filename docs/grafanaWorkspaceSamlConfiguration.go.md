...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/grafanaworkspacesamlconfiguration"
...
&grafanaworkspacesamlconfiguration.GrafanaWorkspaceSamlConfigurationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.grafanaWorkspaceSamlConfiguration.GrafanaWorkspaceSamlConfigurationTimeouts,
}
```
