...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/grafanaworkspacesamlconfiguration"
...
&grafanaworkspacesamlconfiguration.GrafanaWorkspaceSamlConfigurationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.grafanaWorkspaceSamlConfiguration.GrafanaWorkspaceSamlConfigurationTimeouts,
}
```
