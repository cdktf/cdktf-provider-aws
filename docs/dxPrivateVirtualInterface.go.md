...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dxprivatevirtualinterface"
...
&dxprivatevirtualinterface.DxPrivateVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceTimeouts,
	VpnGatewayId: *string,
}
```
