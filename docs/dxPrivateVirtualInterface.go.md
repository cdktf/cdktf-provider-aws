...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dxprivatevirtualinterface"
...
&dxprivatevirtualinterface.DxPrivateVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceTimeouts,
	VpnGatewayId: *string,
}
```
