...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dxprivatevirtualinterface"
...
&dxprivatevirtualinterface.DxPrivateVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceTimeouts,
	VpnGatewayId: *string,
}
```
