...
Refer to the Terraform Registory for docs: [`data_aws_billing_service_account`](https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/data-sources/billing_service_account).
...
| <code><a href="#@cdktf/provider-aws.dataAwsBillingServiceAccount.DataAwsBillingServiceAccountConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/data-sources/billing_service_account#id DataAwsBillingServiceAccount#id}. |
