...
Refer to the Terraform Registory for docs: [`data_aws_billing_service_account`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/billing_service_account).
...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsbillingserviceaccount"
...
| <code><a href="#@cdktf/provider-aws.dataAwsBillingServiceAccount.DataAwsBillingServiceAccountConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/billing_service_account#id DataAwsBillingServiceAccount#id}. |
