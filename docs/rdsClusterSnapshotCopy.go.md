...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/rdsclustersnapshotcopy"
...
&rdsclustersnapshotcopy.RdsClusterSnapshotCopyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.rdsClusterSnapshotCopy.RdsClusterSnapshotCopyTimeouts,
}
```
