...
| <code><a href="#@cdktf/provider-aws.sqsQueuePolicy.SqsQueuePolicy.Initializer.parameter.policy">policy</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/sqs_queue_policy#policy SqsQueuePolicy#policy}. |
| <code><a href="#@cdktf/provider-aws.sqsQueuePolicy.SqsQueuePolicy.Initializer.parameter.queueUrl">queue_url</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/sqs_queue_policy#queue_url SqsQueuePolicy#queue_url}. |
| <code><a href="#@cdktf/provider-aws.sqsQueuePolicy.SqsQueuePolicy.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/sqs_queue_policy#id SqsQueuePolicy#id}. |
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/sqs_queue_policy#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.sqsQueuePolicy.SqsQueuePolicyConfig.property.policy">policy</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/sqs_queue_policy#policy SqsQueuePolicy#policy}. |
| <code><a href="#@cdktf/provider-aws.sqsQueuePolicy.SqsQueuePolicyConfig.property.queueUrl">queue_url</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/sqs_queue_policy#queue_url SqsQueuePolicy#queue_url}. |
| <code><a href="#@cdktf/provider-aws.sqsQueuePolicy.SqsQueuePolicyConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/sqs_queue_policy#id SqsQueuePolicy#id}. |
