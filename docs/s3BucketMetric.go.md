...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/s3bucketmetric"
...
&s3bucketmetric.S3BucketMetricConfig {
	...
	Bucket: *string,
	Name: *string,
	Filter: github.com/cdktf/cdktf-provider-aws-go/aws/v19.s3BucketMetric.S3BucketMetricFilter,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.s3BucketMetric.S3BucketMetricFilter.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.0/docs/resources/s3_bucket_metric#tags S3BucketMetric#tags}. |
