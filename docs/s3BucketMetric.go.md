...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/s3bucketmetric"
...
&s3bucketmetric.S3BucketMetricConfig {
	...
	Bucket: *string,
	Name: *string,
	Filter: github.com/cdktf/cdktf-provider-aws-go/aws/v13.s3BucketMetric.S3BucketMetricFilter,
	Id: *string,
}
```
