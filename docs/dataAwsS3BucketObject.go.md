...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawss3bucketobject"
...
| <code><a href="#@cdktf/provider-aws.dataAwsS3BucketObject.DataAwsS3BucketObjectConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/data-sources/s3_bucket_object#tags DataAwsS3BucketObject#tags}. |
