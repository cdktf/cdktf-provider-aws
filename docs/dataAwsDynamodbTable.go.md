...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsdynamodbtable"
...
&dataawsdynamodbtable.DataAwsDynamodbTableConfig {
	...
	Name: *string,
	Id: *string,
	ServerSideEncryption: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsDynamodbTable.DataAwsDynamodbTableServerSideEncryption,
...
| <code><a href="#@cdktf/provider-aws.dataAwsDynamodbTable.DataAwsDynamodbTableConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/dynamodb_table#tags DataAwsDynamodbTable#tags}. |
