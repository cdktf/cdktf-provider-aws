...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dbinstanceautomatedbackupsreplication"
...
&dbinstanceautomatedbackupsreplication.DbInstanceAutomatedBackupsReplicationConfig {
	...
	PreSignedUrl: *string,
	RetentionPeriod: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dbInstanceAutomatedBackupsReplication.DbInstanceAutomatedBackupsReplicationTimeouts,
}
```
