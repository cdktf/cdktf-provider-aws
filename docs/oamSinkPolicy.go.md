...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/oamsinkpolicy"
...
&oamsinkpolicy.OamSinkPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.oamSinkPolicy.OamSinkPolicyTimeouts,
}
```
