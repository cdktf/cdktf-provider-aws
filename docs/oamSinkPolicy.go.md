...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/oamsinkpolicy"
...
&oamsinkpolicy.OamSinkPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.oamSinkPolicy.OamSinkPolicyTimeouts,
}
```
