...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/oamsinkpolicy"
...
&oamsinkpolicy.OamSinkPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.oamSinkPolicy.OamSinkPolicyTimeouts,
}
```
