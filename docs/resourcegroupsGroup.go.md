...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/resourcegroupsgroup"
...
&resourcegroupsgroup.ResourcegroupsGroupConfig {
	...
	Description: *string,
	Id: *string,
	ResourceQuery: github.com/cdktf/cdktf-provider-aws-go/aws/v12.resourcegroupsGroup.ResourcegroupsGroupResourceQuery,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.resourcegroupsGroup.ResourcegroupsGroupTimeouts,
}
```
