...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/resourcegroupsgroup"
...
&resourcegroupsgroup.ResourcegroupsGroupConfig {
	...
	Description: *string,
	Id: *string,
	ResourceQuery: github.com/cdktf/cdktf-provider-aws-go/aws/v15.resourcegroupsGroup.ResourcegroupsGroupResourceQuery,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.resourcegroupsGroup.ResourcegroupsGroupTimeouts,
}
```
