...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/cloudtraileventdatastore"
...
&cloudtraileventdatastore.CloudtrailEventDataStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.cloudtrailEventDataStore.CloudtrailEventDataStoreTimeouts,
}
```
