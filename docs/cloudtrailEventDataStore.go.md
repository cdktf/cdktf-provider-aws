...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/cloudtraileventdatastore"
...
&cloudtraileventdatastore.CloudtrailEventDataStoreConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.cloudtrailEventDataStore.CloudtrailEventDataStoreTimeouts,
}
```
