...
| <code><a href="#@cdktf/provider-aws.dataAwsLexIntent.DataAwsLexIntentConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/data-sources/lex_intent#name DataAwsLexIntent#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsLexIntent.DataAwsLexIntentConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/data-sources/lex_intent#id DataAwsLexIntent#id}. |
| <code><a href="#@cdktf/provider-aws.dataAwsLexIntent.DataAwsLexIntentConfig.property.version">Version</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.28.0/docs/data-sources/lex_intent#version DataAwsLexIntent#version}. |
