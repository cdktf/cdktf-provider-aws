...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsebssnapshot"
...
&dataawsebssnapshot.DataAwsEbsSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEbsSnapshot.DataAwsEbsSnapshotTimeouts,
}
```
