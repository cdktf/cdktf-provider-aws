...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsebssnapshot"
...
&dataawsebssnapshot.DataAwsEbsSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsEbsSnapshot.DataAwsEbsSnapshotTimeouts,
}
```
