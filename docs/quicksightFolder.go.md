...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/quicksightfolder"
...
&quicksightfolder.QuicksightFolderConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.quicksightFolder.QuicksightFolderTimeouts,
}
```
