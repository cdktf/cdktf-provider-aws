...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/quicksightfolder"
...
&quicksightfolder.QuicksightFolderConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.quicksightFolder.QuicksightFolderTimeouts,
}
```
