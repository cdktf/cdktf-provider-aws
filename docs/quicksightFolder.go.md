...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/quicksightfolder"
...
&quicksightfolder.QuicksightFolderConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.quicksightFolder.QuicksightFolderTimeouts,
}
```
