...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/s3bucketversioning"
...
&s3bucketversioning.S3BucketVersioningAConfig {
	...
	Bucket: *string,
	VersioningConfiguration: github.com/cdktf/cdktf-provider-aws-go/aws/v13.s3BucketVersioning.S3BucketVersioningVersioningConfiguration,
