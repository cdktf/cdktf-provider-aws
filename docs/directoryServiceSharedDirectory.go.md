...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/directoryserviceshareddirectory"
...
&directoryserviceshareddirectory.DirectoryServiceSharedDirectoryConfig {
	...
	DirectoryId: *string,
	Target: github.com/cdktf/cdktf-provider-aws-go/aws/v13.directoryServiceSharedDirectory.DirectoryServiceSharedDirectoryTarget,
	Id: *string,
	Method: *string,
	Notes: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.directoryServiceSharedDirectory.DirectoryServiceSharedDirectoryTimeouts,
}
```
