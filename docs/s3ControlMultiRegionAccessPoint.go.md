...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/s3controlmultiregionaccesspoint"
...
&s3controlmultiregionaccesspoint.S3ControlMultiRegionAccessPointConfig {
	...
	Details: github.com/cdktf/cdktf-provider-aws-go/aws/v12.s3ControlMultiRegionAccessPoint.S3ControlMultiRegionAccessPointDetails,
	AccountId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.s3ControlMultiRegionAccessPoint.S3ControlMultiRegionAccessPointTimeouts,
}
```
...
&s3controlmultiregionaccesspoint.S3ControlMultiRegionAccessPointDetails {
	Name: *string,
	Region: interface{},
	PublicAccessBlock: github.com/cdktf/cdktf-provider-aws-go/aws/v12.s3ControlMultiRegionAccessPoint.S3ControlMultiRegionAccessPointDetailsPublicAccessBlock,
}
```
