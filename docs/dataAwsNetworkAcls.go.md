...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsnetworkacls"
...
&dataawsnetworkacls.DataAwsNetworkAclsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsNetworkAcls.DataAwsNetworkAclsTimeouts,
	VpcId: *string,
}
```
