...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsnetworkacls"
...
&dataawsnetworkacls.DataAwsNetworkAclsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsNetworkAcls.DataAwsNetworkAclsTimeouts,
	VpcId: *string,
}
```
