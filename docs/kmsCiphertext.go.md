...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/kmsciphertext"
...
| <code><a href="#@cdktf/provider-aws.kmsCiphertext.KmsCiphertextConfig.property.context">Context</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/resources/kms_ciphertext#context KmsCiphertext#context}. |
