...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/efsbackuppolicy"
...
&efsbackuppolicy.EfsBackupPolicyConfig {
	...
	BackupPolicy: github.com/cdktf/cdktf-provider-aws-go/aws/v13.efsBackupPolicy.EfsBackupPolicyBackupPolicy,
	FileSystemId: *string,
	Id: *string,
}
```
