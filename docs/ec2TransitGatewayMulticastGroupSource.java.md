...
Refer to the Terraform Registory for docs: [`aws_ec2_transit_gateway_multicast_group_source`](https://registry.terraform.io/providers/hashicorp/aws/5.18.1/docs/resources/ec2_transit_gateway_multicast_group_source).
