...
| <code><a href="#@cdktf/provider-aws.dataAwsDxGateway.DataAwsDxGateway.Initializer.parameter.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/dx_gateway#name DataAwsDxGateway#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsDxGateway.DataAwsDxGateway.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/dx_gateway#id DataAwsDxGateway#id}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsDxGateway.DataAwsDxGatewayConfig.property.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/dx_gateway#name DataAwsDxGateway#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsDxGateway.DataAwsDxGatewayConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/dx_gateway#id DataAwsDxGateway#id}. |
