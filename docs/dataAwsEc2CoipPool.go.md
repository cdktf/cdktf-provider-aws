...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsec2coippool"
...
&dataawsec2coippool.DataAwsEc2CoipPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsEc2CoipPool.DataAwsEc2CoipPoolTimeouts,
}
```
