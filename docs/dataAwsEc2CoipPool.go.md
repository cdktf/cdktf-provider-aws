...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2coippool"
...
&dataawsec2coippool.DataAwsEc2CoipPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2CoipPool.DataAwsEc2CoipPoolTimeouts,
}
```
