...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsec2coippool"
...
&dataawsec2coippool.DataAwsEc2CoipPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsEc2CoipPool.DataAwsEc2CoipPoolTimeouts,
}
```
