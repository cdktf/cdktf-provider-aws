...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/cloudformationtype"
...
&cloudformationtype.CloudformationTypeConfig {
	...
	Id: *string,
	LoggingConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v15.cloudformationType.CloudformationTypeLoggingConfig,
	Type: *string,
}
```
