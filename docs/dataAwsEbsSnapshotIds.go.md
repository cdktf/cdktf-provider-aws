...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dataawsebssnapshotids"
...
&dataawsebssnapshotids.DataAwsEbsSnapshotIdsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.dataAwsEbsSnapshotIds.DataAwsEbsSnapshotIdsTimeouts,
}
```
