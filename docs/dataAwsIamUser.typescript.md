...
| <code><a href="#@cdktf/provider-aws.dataAwsIamUser.DataAwsIamUserConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/data-sources/iam_user#tags DataAwsIamUser#tags}. |
