...
dataAwsAmi.DataAwsAmi(
  ...
  allow_unsafe_filter: typing.Union[bool, IResolvable] = None,
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.allowUnsafeFilter">allow_unsafe_filter</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#allow_unsafe_filter DataAwsAmi#allow_unsafe_filter}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.executableUsers">executable_users</a></code> | <code>typing.List[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#executable_users DataAwsAmi#executable_users}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#id DataAwsAmi#id}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.includeDeprecated">include_deprecated</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#include_deprecated DataAwsAmi#include_deprecated}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.mostRecent">most_recent</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#most_recent DataAwsAmi#most_recent}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.nameRegex">name_regex</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#name_regex DataAwsAmi#name_regex}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.owners">owners</a></code> | <code>typing.List[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#owners DataAwsAmi#owners}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.region">region</a></code> | <code>str</code> | Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference). |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.tags">tags</a></code> | <code>typing.Mapping[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#tags DataAwsAmi#tags}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.uefiData">uefi_data</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#uefi_data DataAwsAmi#uefi_data}. |
...
##### `allow_unsafe_filter`<sup>Optional</sup> <a name="allow_unsafe_filter" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.allowUnsafeFilter"></a>
...
##### `region`<sup>Optional</sup> <a name="region" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.region"></a>
...
##### `uefi_data`<sup>Optional</sup> <a name="uefi_data" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.Initializer.parameter.uefiData"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.toHclTerraform">to_hcl_terraform</a></code> | Adds this resource to the terraform JSON output. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.resetAllowUnsafeFilter">reset_allow_unsafe_filter</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.resetRegion">reset_region</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.resetUefiData">reset_uefi_data</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.toHclTerraform"></a>
...
##### `reset_allow_unsafe_filter` <a name="reset_allow_unsafe_filter" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.resetAllowUnsafeFilter"></a>

```python
def reset_allow_unsafe_filter() -> None
```
...
##### `reset_region` <a name="reset_region" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.resetRegion"></a>
...
##### `reset_uefi_data` <a name="reset_uefi_data" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.resetUefiData"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTF code for importing a DataAwsAmi resource upon running "cdktf plan <stack-name>". |
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.generateConfigForImport"></a>

```python
from cdktf_cdktf_provider_aws import data_aws_ami

dataAwsAmi.DataAwsAmi.generate_config_for_import(
  scope: Construct,
  import_to_id: str,
  import_from_id: str,
  provider: TerraformProvider = None
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.generateConfigForImport.parameter.importFromId"></a>

- *Type:* str

The id of the existing DataAwsAmi that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.lastLaunchedTime">last_launched_time</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.allowUnsafeFilterInput">allow_unsafe_filter_input</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.regionInput">region_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.timeoutsInput">timeouts_input</a></code> | <code>typing.Union[cdktf.IResolvable, <a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiTimeouts">DataAwsAmiTimeouts</a>]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.uefiDataInput">uefi_data_input</a></code> | <code>str</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.allowUnsafeFilter">allow_unsafe_filter</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.region">region</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.uefiData">uefi_data</a></code> | <code>str</code> | *No description.* |
...
##### `last_launched_time`<sup>Required</sup> <a name="last_launched_time" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.lastLaunchedTime"></a>
...
##### `allow_unsafe_filter_input`<sup>Optional</sup> <a name="allow_unsafe_filter_input" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.allowUnsafeFilterInput"></a>

```python
allow_unsafe_filter_input: typing.Union[bool, IResolvable]
```
...
##### `region_input`<sup>Optional</sup> <a name="region_input" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.regionInput"></a>
...
```python
timeouts_input: typing.Union[IResolvable, DataAwsAmiTimeouts]
```

- *Type:* typing.Union[cdktf.IResolvable, <a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiTimeouts">DataAwsAmiTimeouts</a>]

---

##### `uefi_data_input`<sup>Optional</sup> <a name="uefi_data_input" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.uefiDataInput"></a>
...
##### `allow_unsafe_filter`<sup>Required</sup> <a name="allow_unsafe_filter" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.allowUnsafeFilter"></a>

```python
allow_unsafe_filter: typing.Union[bool, IResolvable]
```
...
##### `uefi_data`<sup>Required</sup> <a name="uefi_data" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmi.property.uefiData"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.allowUnsafeFilter">allow_unsafe_filter</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#allow_unsafe_filter DataAwsAmi#allow_unsafe_filter}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.executableUsers">executable_users</a></code> | <code>typing.List[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#executable_users DataAwsAmi#executable_users}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#id DataAwsAmi#id}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.includeDeprecated">include_deprecated</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#include_deprecated DataAwsAmi#include_deprecated}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.mostRecent">most_recent</a></code> | <code>typing.Union[bool, cdktf.IResolvable]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#most_recent DataAwsAmi#most_recent}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.nameRegex">name_regex</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#name_regex DataAwsAmi#name_regex}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.owners">owners</a></code> | <code>typing.List[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#owners DataAwsAmi#owners}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.region">region</a></code> | <code>str</code> | Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference). |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.tags">tags</a></code> | <code>typing.Mapping[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#tags DataAwsAmi#tags}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.uefiData">uefi_data</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#uefi_data DataAwsAmi#uefi_data}. |
...
##### `allow_unsafe_filter`<sup>Optional</sup> <a name="allow_unsafe_filter" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.allowUnsafeFilter"></a>
...
##### `uefi_data`<sup>Optional</sup> <a name="uefi_data" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiConfig.property.uefiData"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilter.property.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#name DataAwsAmi#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilter.property.values">values</a></code> | <code>typing.List[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#values DataAwsAmi#values}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiTimeouts.property.read">read</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/ami#read DataAwsAmi#read}. |
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiBlockDeviceMappingsList.allWithMapKey">all_with_map_key</a></code> | Creating an iterator for this complex list. |
...
##### `all_with_map_key` <a name="all_with_map_key" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiBlockDeviceMappingsList.allWithMapKey"></a>
...
###### `map_key_attribute_name`<sup>Required</sup> <a name="map_key_attribute_name" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiBlockDeviceMappingsList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilterList.allWithMapKey">all_with_map_key</a></code> | Creating an iterator for this complex list. |
...
##### `all_with_map_key` <a name="all_with_map_key" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilterList.allWithMapKey"></a>
...
###### `map_key_attribute_name`<sup>Required</sup> <a name="map_key_attribute_name" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilterList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilterOutputReference.property.internalValue">internal_value</a></code> | <code>typing.Union[cdktf.IResolvable, <a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilter">DataAwsAmiFilter</a>]</code> | *No description.* |
...
```python
internal_value: typing.Union[IResolvable, DataAwsAmiFilter]
```

- *Type:* typing.Union[cdktf.IResolvable, <a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiFilter">DataAwsAmiFilter</a>]
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiProductCodesList.allWithMapKey">all_with_map_key</a></code> | Creating an iterator for this complex list. |
...
##### `all_with_map_key` <a name="all_with_map_key" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiProductCodesList.allWithMapKey"></a>
...
###### `map_key_attribute_name`<sup>Required</sup> <a name="map_key_attribute_name" id="@cdktf/provider-aws.dataAwsAmi.DataAwsAmiProductCodesList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiTimeoutsOutputReference.property.internalValue">internal_value</a></code> | <code>typing.Union[cdktf.IResolvable, <a href="#@cdktf/provider-aws.dataAwsAmi.DataAwsAmiTimeouts">DataAwsAmiTimeouts</a>]</code> | *No description.* |
...
```python
internal_value: typing.Union[IResolvable, DataAwsAmiTimeouts]
```
