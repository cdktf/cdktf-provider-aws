...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/networkmanagercorenetwork"
...
&networkmanagercorenetwork.NetworkmanagerCoreNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.networkmanagerCoreNetwork.NetworkmanagerCoreNetworkTimeouts,
}
```
