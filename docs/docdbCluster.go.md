...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/docdbcluster"
...
&docdbcluster.DocdbClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.docdbCluster.DocdbClusterTimeouts,
