...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/docdbcluster"
...
&docdbcluster.DocdbClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.docdbCluster.DocdbClusterTimeouts,
