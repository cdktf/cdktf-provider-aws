...
Refer to the Terraform Registory for docs: [`aws_s3_bucket_intelligent_tiering_configuration`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/resources/s3_bucket_intelligent_tiering_configuration).
