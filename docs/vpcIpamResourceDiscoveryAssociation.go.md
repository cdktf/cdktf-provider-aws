...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/vpcipamresourcediscoveryassociation"
...
&vpcipamresourcediscoveryassociation.VpcIpamResourceDiscoveryAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.vpcIpamResourceDiscoveryAssociation.VpcIpamResourceDiscoveryAssociationTimeouts,
}
```
