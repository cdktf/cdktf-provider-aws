...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/vpcipamresourcediscoveryassociation"
...
&vpcipamresourcediscoveryassociation.VpcIpamResourceDiscoveryAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.vpcIpamResourceDiscoveryAssociation.VpcIpamResourceDiscoveryAssociationTimeouts,
}
```
