...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawscodebuildfleet"
...
| <code><a href="#@cdktf/provider-aws.dataAwsCodebuildFleet.DataAwsCodebuildFleetConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.83.0/docs/data-sources/codebuild_fleet#tags DataAwsCodebuildFleet#tags}. |
