...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/apigatewayv2integration"
...
&apigatewayv2integration.Apigatewayv2IntegrationConfig {
	...
	TlsConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v17.apigatewayv2Integration.Apigatewayv2IntegrationTlsConfig,
}
```
