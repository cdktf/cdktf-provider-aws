...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsservicecatalogportfolioconstraints"
...
&dataawsservicecatalogportfolioconstraints.DataAwsServicecatalogPortfolioConstraintsConfig {
	...
	Id: *string,
	ProductId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsServicecatalogPortfolioConstraints.DataAwsServicecatalogPortfolioConstraintsTimeouts,
}
```
