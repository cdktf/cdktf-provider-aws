...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/route53recoveryreadinesscell"
...
&route53recoveryreadinesscell.Route53RecoveryreadinessCellConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.route53RecoveryreadinessCell.Route53RecoveryreadinessCellTimeouts,
}
```
