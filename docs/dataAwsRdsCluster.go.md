...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsrdscluster"
...
| <code><a href="#@cdktf/provider-aws.dataAwsRdsCluster.DataAwsRdsClusterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/rds_cluster#tags DataAwsRdsCluster#tags}. |
