...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsnetworkinterface"
...
&dataawsnetworkinterface.DataAwsNetworkInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsNetworkInterface.DataAwsNetworkInterfaceTimeouts,
}
```
