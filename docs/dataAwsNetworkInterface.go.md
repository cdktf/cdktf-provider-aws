...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsnetworkinterface"
...
&dataawsnetworkinterface.DataAwsNetworkInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsNetworkInterface.DataAwsNetworkInterfaceTimeouts,
}
```
