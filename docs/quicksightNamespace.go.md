...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/quicksightnamespace"
...
&quicksightnamespace.QuicksightNamespaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.quicksightNamespace.QuicksightNamespaceTimeouts,
}
```
