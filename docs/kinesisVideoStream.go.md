...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/kinesisvideostream"
...
&kinesisvideostream.KinesisVideoStreamConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.kinesisVideoStream.KinesisVideoStreamTimeouts,
}
```
