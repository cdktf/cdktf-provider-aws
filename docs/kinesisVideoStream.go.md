...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/kinesisvideostream"
...
&kinesisvideostream.KinesisVideoStreamConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.kinesisVideoStream.KinesisVideoStreamTimeouts,
}
```
