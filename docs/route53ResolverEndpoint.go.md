...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/route53resolverendpoint"
...
&route53resolverendpoint.Route53ResolverEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.route53ResolverEndpoint.Route53ResolverEndpointTimeouts,
}
```
