...
```java
public DataAwsOpensearchserverlessSecurityConfigSamlOptionsOutputReference getSamlOptions();
```
...
new DataAwsOpensearchserverlessSecurityConfigSamlOptionsOutputReference(IInterpolatingParent terraformResource, java.lang.String terraformAttribute);
```
