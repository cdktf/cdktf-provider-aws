...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dataawsdmsreplicationtask"
...
| <code><a href="#@cdktf/provider-aws.dataAwsDmsReplicationTask.DataAwsDmsReplicationTaskConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.13.1/docs/data-sources/dms_replication_task#tags DataAwsDmsReplicationTask#tags}. |
