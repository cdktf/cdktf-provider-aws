...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/ssmincidentsreplicationset"
...
&ssmincidentsreplicationset.SsmincidentsReplicationSetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.ssmincidentsReplicationSet.SsmincidentsReplicationSetTimeouts,
}
```
