...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawsacmcertificate"
...
| <code><a href="#@cdktf/provider-aws.dataAwsAcmCertificate.DataAwsAcmCertificateConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.16.2/docs/data-sources/acm_certificate#tags DataAwsAcmCertificate#tags}. |
