...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/dataawsacmcertificate"
...
| <code><a href="#@cdktf/provider-aws.dataAwsAcmCertificate.DataAwsAcmCertificateConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.29.0/docs/data-sources/acm_certificate#tags DataAwsAcmCertificate#tags}. |
