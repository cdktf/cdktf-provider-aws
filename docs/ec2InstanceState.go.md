...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/ec2instancestate"
...
&ec2instancestate.Ec2InstanceStateConfig {
	...
	Force: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.ec2InstanceState.Ec2InstanceStateTimeouts,
}
```
