...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/ec2instancestate"
...
&ec2instancestate.Ec2InstanceStateConfig {
	...
	Force: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.ec2InstanceState.Ec2InstanceStateTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.ec2InstanceState.Ec2InstanceStateConfig.property.force">Force</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.65.0/docs/resources/ec2_instance_state#force Ec2InstanceState#force}. |
