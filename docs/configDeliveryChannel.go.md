...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/configdeliverychannel"
...
&configdeliverychannel.ConfigDeliveryChannelConfig {
	...
	S3KeyPrefix: *string,
	S3KmsKeyArn: *string,
	SnapshotDeliveryProperties: github.com/cdktf/cdktf-provider-aws-go/aws/v20.configDeliveryChannel.ConfigDeliveryChannelSnapshotDeliveryProperties,
	SnsTopicArn: *string,
}
```
