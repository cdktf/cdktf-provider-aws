...
Refer to the Terraform Registory for docs: [`data_aws_sqs_queues`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/sqs_queues).
...
| <code><a href="#@cdktf/provider-aws.dataAwsSqsQueues.DataAwsSqsQueuesConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/sqs_queues#id DataAwsSqsQueues#id}. |
