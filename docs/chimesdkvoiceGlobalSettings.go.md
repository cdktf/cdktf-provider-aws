...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/chimesdkvoiceglobalsettings"
...
&chimesdkvoiceglobalsettings.ChimesdkvoiceGlobalSettingsConfig {
	...
	VoiceConnector: github.com/cdktf/cdktf-provider-aws-go/aws/v20.chimesdkvoiceGlobalSettings.ChimesdkvoiceGlobalSettingsVoiceConnector,
	Id: *string,
}
```
