...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/macie2invitationaccepter"
...
| <code><a href="#@cdktf/provider-aws.macie2InvitationAccepter.Macie2InvitationAccepter.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&macie2invitationaccepter.Macie2InvitationAccepterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.macie2InvitationAccepter.Macie2InvitationAccepterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.macie2InvitationAccepter.Macie2InvitationAccepterConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
