...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2transitgatewayattachments"
...
&dataawsec2transitgatewayattachments.DataAwsEc2TransitGatewayAttachmentsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2TransitGatewayAttachments.DataAwsEc2TransitGatewayAttachmentsTimeouts,
}
```
