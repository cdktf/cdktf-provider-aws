...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/medialiveinputsecuritygroup"
...
&medialiveinputsecuritygroup.MedialiveInputSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.medialiveInputSecurityGroup.MedialiveInputSecurityGroupTimeouts,
}
```
