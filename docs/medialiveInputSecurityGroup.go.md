...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/medialiveinputsecuritygroup"
...
&medialiveinputsecuritygroup.MedialiveInputSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v18.medialiveInputSecurityGroup.MedialiveInputSecurityGroupTimeouts,
}
```
