...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/vpclatticeservice"
...
&vpclatticeservice.VpclatticeServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.vpclatticeService.VpclatticeServiceTimeouts,
}
```
