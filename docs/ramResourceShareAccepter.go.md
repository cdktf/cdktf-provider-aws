...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/ramresourceshareaccepter"
...
&ramresourceshareaccepter.RamResourceShareAccepterConfig {
	...
	ShareArn: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.ramResourceShareAccepter.RamResourceShareAccepterTimeouts,
}
```
