...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/ivsplaybackkeypair"
...
&ivsplaybackkeypair.IvsPlaybackKeyPairConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.ivsPlaybackKeyPair.IvsPlaybackKeyPairTimeouts,
}
```
