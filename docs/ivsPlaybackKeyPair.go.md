...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/ivsplaybackkeypair"
...
&ivsplaybackkeypair.IvsPlaybackKeyPairConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.ivsPlaybackKeyPair.IvsPlaybackKeyPairTimeouts,
}
```
