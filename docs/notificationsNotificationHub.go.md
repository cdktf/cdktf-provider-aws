...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/notificationsnotificationhub"
...
&notificationsnotificationhub.NotificationsNotificationHubConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.notificationsNotificationHub.NotificationsNotificationHubTimeouts,
}
```
