...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/neptuneglobalcluster"
...
&neptuneglobalcluster.NeptuneGlobalClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.neptuneGlobalCluster.NeptuneGlobalClusterTimeouts,
}
```
