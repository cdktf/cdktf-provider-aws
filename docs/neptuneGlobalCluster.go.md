...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/neptuneglobalcluster"
...
&neptuneglobalcluster.NeptuneGlobalClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.neptuneGlobalCluster.NeptuneGlobalClusterTimeouts,
}
```
