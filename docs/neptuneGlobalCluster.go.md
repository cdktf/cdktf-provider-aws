...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/neptuneglobalcluster"
...
&neptuneglobalcluster.NeptuneGlobalClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.neptuneGlobalCluster.NeptuneGlobalClusterTimeouts,
}
```
