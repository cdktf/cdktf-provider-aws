...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsinternetgateway"
...
&dataawsinternetgateway.DataAwsInternetGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsInternetGateway.DataAwsInternetGatewayTimeouts,
}
```
