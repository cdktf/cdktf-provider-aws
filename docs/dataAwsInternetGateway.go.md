...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsinternetgateway"
...
&dataawsinternetgateway.DataAwsInternetGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsInternetGateway.DataAwsInternetGatewayTimeouts,
}
```
