...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/directoryserviceshareddirectoryaccepter"
...
&directoryserviceshareddirectoryaccepter.DirectoryServiceSharedDirectoryAccepterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.directoryServiceSharedDirectoryAccepter.DirectoryServiceSharedDirectoryAccepterTimeouts,
}
```
