...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/directoryserviceshareddirectoryaccepter"
...
&directoryserviceshareddirectoryaccepter.DirectoryServiceSharedDirectoryAccepterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.directoryServiceSharedDirectoryAccepter.DirectoryServiceSharedDirectoryAccepterTimeouts,
}
```
