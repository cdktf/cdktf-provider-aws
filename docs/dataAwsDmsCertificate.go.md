...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawsdmscertificate"
...
| <code><a href="#@cdktf/provider-aws.dataAwsDmsCertificate.DataAwsDmsCertificateConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.64.0/docs/data-sources/dms_certificate#tags DataAwsDmsCertificate#tags}. |
