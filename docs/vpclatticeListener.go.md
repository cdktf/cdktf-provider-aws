...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/vpclatticelistener"
...
&vpclatticelistener.VpclatticeListenerConfig {
	...
	DefaultAction: github.com/cdktf/cdktf-provider-aws-go/aws/v15.vpclatticeListener.VpclatticeListenerDefaultAction,
	Name: *string,
	Protocol: *string,
	Id: *string,
	Port: *f64,
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.vpclatticeListener.VpclatticeListenerTimeouts,
}
```
...
&vpclatticelistener.VpclatticeListenerDefaultAction {
	FixedResponse: github.com/cdktf/cdktf-provider-aws-go/aws/v15.vpclatticeListener.VpclatticeListenerDefaultActionFixedResponse,
	Forward: interface{},
}
```
