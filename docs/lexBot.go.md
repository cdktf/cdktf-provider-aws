...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/lexbot"
...
&lexbot.LexBotConfig {
	...
	AbortStatement: github.com/cdktf/cdktf-provider-aws-go/aws/v15.lexBot.LexBotAbortStatement,
	ChildDirected: interface{},
	Intent: interface{},
	Name: *string,
	ClarificationPrompt: github.com/cdktf/cdktf-provider-aws-go/aws/v15.lexBot.LexBotClarificationPrompt,
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.lexBot.LexBotTimeouts,
	VoiceId: *string,
}
```
