...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/securitygrouprule"
...
&securitygrouprule.SecurityGroupRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.securityGroupRule.SecurityGroupRuleTimeouts,
}
```
