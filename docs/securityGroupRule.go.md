...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/securitygrouprule"
...
&securitygrouprule.SecurityGroupRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.securityGroupRule.SecurityGroupRuleTimeouts,
}
```
