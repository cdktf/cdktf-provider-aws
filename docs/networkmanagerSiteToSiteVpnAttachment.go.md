...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/networkmanagersitetositevpnattachment"
...
&networkmanagersitetositevpnattachment.NetworkmanagerSiteToSiteVpnAttachmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.networkmanagerSiteToSiteVpnAttachment.NetworkmanagerSiteToSiteVpnAttachmentTimeouts,
}
```
