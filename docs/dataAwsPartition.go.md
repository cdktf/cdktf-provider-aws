...
Refer to the Terraform Registory for docs: [`data_aws_partition`](https://registry.terraform.io/providers/hashicorp/aws/5.18.1/docs/data-sources/partition).
...
| <code><a href="#@cdktf/provider-aws.dataAwsPartition.DataAwsPartitionConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.18.1/docs/data-sources/partition#id DataAwsPartition#id}. |
