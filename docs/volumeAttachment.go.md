...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/volumeattachment"
...
&volumeattachment.VolumeAttachmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.volumeAttachment.VolumeAttachmentTimeouts,
}
```
