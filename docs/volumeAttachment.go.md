...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/volumeattachment"
...
&volumeattachment.VolumeAttachmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.volumeAttachment.VolumeAttachmentTimeouts,
}
```
