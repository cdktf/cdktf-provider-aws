...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/kmscustomkeystore"
...
&kmscustomkeystore.KmsCustomKeyStoreConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.kmsCustomKeyStore.KmsCustomKeyStoreTimeouts,
}
```
