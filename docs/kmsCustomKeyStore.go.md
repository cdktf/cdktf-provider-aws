...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/kmscustomkeystore"
...
&kmscustomkeystore.KmsCustomKeyStoreConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.kmsCustomKeyStore.KmsCustomKeyStoreTimeouts,
}
```
