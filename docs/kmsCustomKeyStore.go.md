...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/kmscustomkeystore"
...
&kmscustomkeystore.KmsCustomKeyStoreConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.kmsCustomKeyStore.KmsCustomKeyStoreTimeouts,
}
```
