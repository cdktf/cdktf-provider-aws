...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/route53hostedzonednssec"
...
&route53hostedzonednssec.Route53HostedZoneDnssecConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.route53HostedZoneDnssec.Route53HostedZoneDnssecTimeouts,
}
```
