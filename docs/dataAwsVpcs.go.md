...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsvpcs"
...
&dataawsvpcs.DataAwsVpcsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsVpcs.DataAwsVpcsTimeouts,
}
```
