...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/connectinstance"
...
&connectinstance.ConnectInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.connectInstance.ConnectInstanceTimeouts,
}
```
