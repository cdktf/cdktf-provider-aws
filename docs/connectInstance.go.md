...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/connectinstance"
...
&connectinstance.ConnectInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.connectInstance.ConnectInstanceTimeouts,
}
```
