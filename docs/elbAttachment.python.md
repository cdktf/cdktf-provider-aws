...
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachment.Initializer.parameter.elb">elb</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/elb_attachment#elb ElbAttachment#elb}. |
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachment.Initializer.parameter.instance">instance</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/elb_attachment#instance ElbAttachment#instance}. |
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachment.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/elb_attachment#id ElbAttachment#id}. |
...
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachment.resetRegion">reset_region</a></code> | *No description.* |
...
##### `reset_region` <a name="reset_region" id="@cdktf/provider-aws.elbAttachment.ElbAttachment.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachment.property.regionInput">region_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachment.property.region">region</a></code> | <code>str</code> | *No description.* |
...
##### `region_input`<sup>Optional</sup> <a name="region_input" id="@cdktf/provider-aws.elbAttachment.ElbAttachment.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachmentConfig.property.elb">elb</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/elb_attachment#elb ElbAttachment#elb}. |
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachmentConfig.property.instance">instance</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/elb_attachment#instance ElbAttachment#instance}. |
| <code><a href="#@cdktf/provider-aws.elbAttachment.ElbAttachmentConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/elb_attachment#id ElbAttachment#id}. |
