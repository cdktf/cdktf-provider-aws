...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/vpcipamresourcediscovery"
...
&vpcipamresourcediscovery.VpcIpamResourceDiscoveryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.vpcIpamResourceDiscovery.VpcIpamResourceDiscoveryTimeouts,
}
```
