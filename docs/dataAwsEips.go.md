...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawseips"
...
&dataawseips.DataAwsEipsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEips.DataAwsEipsTimeouts,
}
```
