...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawseips"
...
&dataawseips.DataAwsEipsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEips.DataAwsEipsTimeouts,
}
```
