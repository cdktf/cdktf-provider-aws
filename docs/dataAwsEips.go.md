...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawseips"
...
&dataawseips.DataAwsEipsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsEips.DataAwsEipsTimeouts,
}
```
