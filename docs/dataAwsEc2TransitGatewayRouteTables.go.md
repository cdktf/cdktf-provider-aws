...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2transitgatewayroutetables"
...
&dataawsec2transitgatewayroutetables.DataAwsEc2TransitGatewayRouteTablesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2TransitGatewayRouteTables.DataAwsEc2TransitGatewayRouteTablesTimeouts,
}
```
