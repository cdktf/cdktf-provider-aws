...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsec2transitgatewayroutetables"
...
&dataawsec2transitgatewayroutetables.DataAwsEc2TransitGatewayRouteTablesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEc2TransitGatewayRouteTables.DataAwsEc2TransitGatewayRouteTablesTimeouts,
}
```
