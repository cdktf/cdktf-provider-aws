...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/cloudformationstackset"
...
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSet.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func ManagedExecutionInput() CloudformationStackSetManagedExecution
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetAutoDeployment.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/cloudformation_stack_set#enabled CloudformationStackSet#enabled}. |
...
&cloudformationstackset.CloudformationStackSetConfig {
	...
	AutoDeployment: github.com/cdktf/cdktf-provider-aws-go/aws/v19.cloudformationStackSet.CloudformationStackSetAutoDeployment,
	CallAs: *string,
	Capabilities: *[]*string,
	Description: *string,
	ExecutionRoleName: *string,
	Id: *string,
	ManagedExecution: github.com/cdktf/cdktf-provider-aws-go/aws/v19.cloudformationStackSet.CloudformationStackSetManagedExecution,
	OperationPreferences: github.com/cdktf/cdktf-provider-aws-go/aws/v19.cloudformationStackSet.CloudformationStackSetOperationPreferences,
	...
	TemplateBody: *string,
	TemplateUrl: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.cloudformationStackSet.CloudformationStackSetTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetConfig.property.parameters">Parameters</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/cloudformation_stack_set#parameters CloudformationStackSet#parameters}. |
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetConfig.property.permissionModel">PermissionModel</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/cloudformation_stack_set#permission_model CloudformationStackSet#permission_model}. |
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.54.1/docs/resources/cloudformation_stack_set#tags CloudformationStackSet#tags}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetManagedExecutionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetManagedExecutionOutputReference.property.activeInput">ActiveInput</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.cloudformationStackSet.CloudformationStackSetManagedExecutionOutputReference.property.active">Active</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func InternalValue() CloudformationStackSetManagedExecution
```
