...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/directoryserviceregion"
...
&directoryserviceregion.DirectoryServiceRegionConfig {
	...
	DirectoryId: *string,
	RegionName: *string,
	VpcSettings: github.com/cdktf/cdktf-provider-aws-go/aws/v12.directoryServiceRegion.DirectoryServiceRegionVpcSettings,
	DesiredNumberOfDomainControllers: *f64,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.directoryServiceRegion.DirectoryServiceRegionTimeouts,
}
```
