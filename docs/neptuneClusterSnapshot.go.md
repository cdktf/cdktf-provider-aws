...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/neptuneclustersnapshot"
...
&neptuneclustersnapshot.NeptuneClusterSnapshotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.neptuneClusterSnapshot.NeptuneClusterSnapshotTimeouts,
}
```
