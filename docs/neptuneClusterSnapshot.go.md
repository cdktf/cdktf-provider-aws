...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/neptuneclustersnapshot"
...
| <code><a href="#@cdktf/provider-aws.neptuneClusterSnapshot.NeptuneClusterSnapshot.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&neptuneclustersnapshot.NeptuneClusterSnapshotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.neptuneClusterSnapshot.NeptuneClusterSnapshotTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.neptuneClusterSnapshot.NeptuneClusterSnapshotConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
