...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/rbinrule"
...
&rbinrule.RbinRuleConfig {
	...
	ResourceType: *string,
	RetentionPeriod: github.com/cdktf/cdktf-provider-aws-go/aws/v12.rbinRule.RbinRuleRetentionPeriod,
	Description: *string,
	LockConfiguration: github.com/cdktf/cdktf-provider-aws-go/aws/v12.rbinRule.RbinRuleLockConfiguration,
	ResourceTags: interface{},
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.rbinRule.RbinRuleTimeouts,
}
```
...
&rbinrule.RbinRuleLockConfiguration {
	UnlockDelay: github.com/cdktf/cdktf-provider-aws-go/aws/v12.rbinRule.RbinRuleLockConfigurationUnlockDelay,
}
```
