...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/eksidentityproviderconfig"
...
&eksidentityproviderconfig.EksIdentityProviderConfigConfig {
	...
	ClusterName: *string,
	Oidc: github.com/cdktf/cdktf-provider-aws-go/aws/v12.eksIdentityProviderConfig.EksIdentityProviderConfigOidc,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.eksIdentityProviderConfig.EksIdentityProviderConfigTimeouts,
}
```
