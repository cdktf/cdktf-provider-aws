...
Refer to the Terraform Registory for docs: [`data_aws_sfn_state_machine_versions`](https://registry.terraform.io/providers/hashicorp/aws/5.11.0/docs/data-sources/sfn_state_machine_versions).
