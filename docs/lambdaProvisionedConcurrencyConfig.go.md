...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/lambdaprovisionedconcurrencyconfig"
...
&lambdaprovisionedconcurrencyconfig.LambdaProvisionedConcurrencyConfigConfig {
	...
	Qualifier: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfigTimeouts,
}
```
