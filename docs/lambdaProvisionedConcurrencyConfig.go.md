...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/lambdaprovisionedconcurrencyconfig"
...
&lambdaprovisionedconcurrencyconfig.LambdaProvisionedConcurrencyConfigConfig {
	...
	Qualifier: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.lambdaProvisionedConcurrencyConfig.LambdaProvisionedConcurrencyConfigTimeouts,
}
```
