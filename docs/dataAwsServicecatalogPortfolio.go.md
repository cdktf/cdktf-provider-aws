...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsservicecatalogportfolio"
...
&dataawsservicecatalogportfolio.DataAwsServicecatalogPortfolioConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsServicecatalogPortfolio.DataAwsServicecatalogPortfolioTimeouts,
}
```
