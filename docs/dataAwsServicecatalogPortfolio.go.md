...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsservicecatalogportfolio"
...
&dataawsservicecatalogportfolio.DataAwsServicecatalogPortfolioConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsServicecatalogPortfolio.DataAwsServicecatalogPortfolioTimeouts,
}
```
