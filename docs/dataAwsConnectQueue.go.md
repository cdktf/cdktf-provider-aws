...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsconnectqueue"
...
| <code><a href="#@cdktf/provider-aws.dataAwsConnectQueue.DataAwsConnectQueueConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.57.0/docs/data-sources/connect_queue#tags DataAwsConnectQueue#tags}. |
