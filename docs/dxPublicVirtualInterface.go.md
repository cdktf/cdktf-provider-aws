...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dxpublicvirtualinterface"
...
&dxpublicvirtualinterface.DxPublicVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dxPublicVirtualInterface.DxPublicVirtualInterfaceTimeouts,
}
```
