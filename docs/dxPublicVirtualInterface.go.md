...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dxpublicvirtualinterface"
...
&dxpublicvirtualinterface.DxPublicVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dxPublicVirtualInterface.DxPublicVirtualInterfaceTimeouts,
}
```
