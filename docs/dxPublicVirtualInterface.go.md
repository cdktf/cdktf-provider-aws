...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dxpublicvirtualinterface"
...
&dxpublicvirtualinterface.DxPublicVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dxPublicVirtualInterface.DxPublicVirtualInterfaceTimeouts,
}
```
