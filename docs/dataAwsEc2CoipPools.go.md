...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsec2coippools"
...
&dataawsec2coippools.DataAwsEc2CoipPoolsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsEc2CoipPools.DataAwsEc2CoipPoolsTimeouts,
}
```
