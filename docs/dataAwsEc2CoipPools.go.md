...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsec2coippools"
...
&dataawsec2coippools.DataAwsEc2CoipPoolsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.dataAwsEc2CoipPools.DataAwsEc2CoipPoolsTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsEc2CoipPools.DataAwsEc2CoipPoolsConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/data-sources/ec2_coip_pools#tags DataAwsEc2CoipPools#tags}. |
