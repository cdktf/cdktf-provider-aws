...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/guarddutyinviteaccepter"
...
| <code><a href="#@cdktf/provider-aws.guarddutyInviteAccepter.GuarddutyInviteAccepter.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&guarddutyinviteaccepter.GuarddutyInviteAccepterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.guarddutyInviteAccepter.GuarddutyInviteAccepterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.guarddutyInviteAccepter.GuarddutyInviteAccepterConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
