...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsvpcipampoolcidrs"
...
dataawsvpcipampoolcidrs.DataAwsVpcIpamPoolCidrs_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsVpcIpamPoolCidrs.DataAwsVpcIpamPoolCidrs.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dataawsvpcipampoolcidrs.DataAwsVpcIpamPoolCidrsConfig {
	...
	Filter: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.dataAwsVpcIpamPoolCidrs.DataAwsVpcIpamPoolCidrsTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsVpcIpamPoolCidrs.DataAwsVpcIpamPoolCidrsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
