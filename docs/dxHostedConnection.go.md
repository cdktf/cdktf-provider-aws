...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dxhostedconnection"
...
| <code><a href="#@cdktf/provider-aws.dxHostedConnection.DxHostedConnectionConfig.property.vlan">Vlan</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.65.0/docs/resources/dx_hosted_connection#vlan DxHostedConnection#vlan}. |
