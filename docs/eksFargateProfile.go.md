...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/eksfargateprofile"
...
&eksfargateprofile.EksFargateProfileConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.eksFargateProfile.EksFargateProfileTimeouts,
}
```
