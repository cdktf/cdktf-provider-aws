...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/eksfargateprofile"
...
&eksfargateprofile.EksFargateProfileConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.eksFargateProfile.EksFargateProfileTimeouts,
}
```
