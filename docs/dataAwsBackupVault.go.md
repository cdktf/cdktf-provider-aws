...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawsbackupvault"
...
| <code><a href="#@cdktf/provider-aws.dataAwsBackupVault.DataAwsBackupVaultConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/backup_vault#tags DataAwsBackupVault#tags}. |
