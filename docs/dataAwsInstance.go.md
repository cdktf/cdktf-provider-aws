...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsinstance"
...
&dataawsinstance.DataAwsInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsInstance.DataAwsInstanceTimeouts,
}
```
