...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsinstance"
...
&dataawsinstance.DataAwsInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsInstance.DataAwsInstanceTimeouts,
}
```
