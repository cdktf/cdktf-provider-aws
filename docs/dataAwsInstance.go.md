...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/dataawsinstance"
...
&dataawsinstance.DataAwsInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.dataAwsInstance.DataAwsInstanceTimeouts,
}
```
