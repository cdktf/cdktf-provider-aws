...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/cloudhsmv2cluster"
...
&cloudhsmv2cluster.CloudhsmV2ClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.cloudhsmV2Cluster.CloudhsmV2ClusterTimeouts,
}
```
