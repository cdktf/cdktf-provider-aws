...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawskmssecret"
...
| <code><a href="#@cdktf/provider-aws.dataAwsKmsSecret.DataAwsKmsSecretSecret.property.context">Context</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.17.0/docs/data-sources/kms_secret#context DataAwsKmsSecret#context}. |
