...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsvpcpeeringconnection"
...
&dataawsvpcpeeringconnection.DataAwsVpcPeeringConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsVpcPeeringConnection.DataAwsVpcPeeringConnectionTimeouts,
	VpcId: *string,
}
```
