...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawslaunchtemplate"
...
&dataawslaunchtemplate.DataAwsLaunchTemplateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsLaunchTemplate.DataAwsLaunchTemplateTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsLaunchTemplate.DataAwsLaunchTemplateConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/launch_template#tags DataAwsLaunchTemplate#tags}. |
