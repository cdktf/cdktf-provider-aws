...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/sagemakermonitoringschedule"
...
| <code><a href="#@cdktf/provider-aws.sagemakerMonitoringSchedule.SagemakerMonitoringSchedule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&sagemakermonitoringschedule.SagemakerMonitoringScheduleConfig {
	...
	MonitoringScheduleConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.sagemakerMonitoringSchedule.SagemakerMonitoringScheduleMonitoringScheduleConfig,
	Id: *string,
	Name: *string,
...
| <code><a href="#@cdktf/provider-aws.sagemakerMonitoringSchedule.SagemakerMonitoringScheduleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.sagemakerMonitoringSchedule.SagemakerMonitoringScheduleConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/sagemaker_monitoring_schedule#tags SagemakerMonitoringSchedule#tags}. |
| <code><a href="#@cdktf/provider-aws.sagemakerMonitoringSchedule.SagemakerMonitoringScheduleConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/sagemaker_monitoring_schedule#tags_all SagemakerMonitoringSchedule#tags_all}. |
...
&sagemakermonitoringschedule.SagemakerMonitoringScheduleMonitoringScheduleConfig {
	...
	ScheduleConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.sagemakerMonitoringSchedule.SagemakerMonitoringScheduleMonitoringScheduleConfigScheduleConfig,
}
```
