...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/appmeshmesh"
...
&appmeshmesh.AppmeshMeshConfig {
	...
	Name: *string,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-aws-go/aws/v16.appmeshMesh.AppmeshMeshSpec,
...
| <code><a href="#@cdktf/provider-aws.appmeshMesh.AppmeshMeshConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/resources/appmesh_mesh#tags AppmeshMesh#tags}. |
| <code><a href="#@cdktf/provider-aws.appmeshMesh.AppmeshMeshConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/resources/appmesh_mesh#tags_all AppmeshMesh#tags_all}. |
...
&appmeshmesh.AppmeshMeshSpec {
	EgressFilter: github.com/cdktf/cdktf-provider-aws-go/aws/v16.appmeshMesh.AppmeshMeshSpecEgressFilter,
}
```
