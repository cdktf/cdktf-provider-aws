...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawsdbinstance"
...
| <code><a href="#@cdktf/provider-aws.dataAwsDbInstance.DataAwsDbInstanceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.64.0/docs/data-sources/db_instance#tags DataAwsDbInstance#tags}. |
