...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsamiids"
...
&dataawsamiids.DataAwsAmiIdsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsAmiIds.DataAwsAmiIdsTimeouts,
}
```
