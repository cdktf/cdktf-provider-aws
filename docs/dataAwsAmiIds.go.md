...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsamiids"
...
&dataawsamiids.DataAwsAmiIdsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsAmiIds.DataAwsAmiIdsTimeouts,
}
```
