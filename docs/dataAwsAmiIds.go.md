...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsamiids"
...
&dataawsamiids.DataAwsAmiIdsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsAmiIds.DataAwsAmiIdsTimeouts,
}
```
