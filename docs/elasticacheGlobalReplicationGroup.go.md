...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/elasticacheglobalreplicationgroup"
...
&elasticacheglobalreplicationgroup.ElasticacheGlobalReplicationGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.elasticacheGlobalReplicationGroup.ElasticacheGlobalReplicationGroupTimeouts,
}
```
