...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/route53recoveryreadinessrecoverygroup"
...
&route53recoveryreadinessrecoverygroup.Route53RecoveryreadinessRecoveryGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.route53RecoveryreadinessRecoveryGroup.Route53RecoveryreadinessRecoveryGroupTimeouts,
}
```
