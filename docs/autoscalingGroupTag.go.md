...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/autoscalinggrouptag"
...
&autoscalinggrouptag.AutoscalingGroupTagAConfig {
	...
	Tag: github.com/cdktf/cdktf-provider-aws-go/aws/v12.autoscalingGroupTag.AutoscalingGroupTagTag,
	Id: *string,
}
```
