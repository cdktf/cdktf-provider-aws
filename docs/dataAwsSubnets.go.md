...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawssubnets"
...
&dataawssubnets.DataAwsSubnetsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsSubnets.DataAwsSubnetsTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsSubnets.DataAwsSubnetsConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/subnets#tags DataAwsSubnets#tags}. |
