...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawssubnets"
...
&dataawssubnets.DataAwsSubnetsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsSubnets.DataAwsSubnetsTimeouts,
}
```
