...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawssubnets"
...
&dataawssubnets.DataAwsSubnetsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsSubnets.DataAwsSubnetsTimeouts,
}
```
