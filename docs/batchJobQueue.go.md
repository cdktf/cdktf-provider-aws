...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/batchjobqueue"
...
&batchjobqueue.BatchJobQueueConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.batchJobQueue.BatchJobQueueTimeouts,
}
```
