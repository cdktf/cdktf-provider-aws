...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/auditmanagerframework"
...
| <code><a href="#@cdktf/provider-aws.auditmanagerFramework.AuditmanagerFrameworkConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/auditmanager_framework#tags AuditmanagerFramework#tags}. |
