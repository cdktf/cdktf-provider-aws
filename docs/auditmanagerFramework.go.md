...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/auditmanagerframework"
...
| <code><a href="#@cdktf/provider-aws.auditmanagerFramework.AuditmanagerFrameworkConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.20.1/docs/resources/auditmanager_framework#tags AuditmanagerFramework#tags}. |
