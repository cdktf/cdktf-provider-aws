...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/docdbeventsubscription"
...
&docdbeventsubscription.DocdbEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.docdbEventSubscription.DocdbEventSubscriptionTimeouts,
}
```
