...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/docdbeventsubscription"
...
&docdbeventsubscription.DocdbEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.docdbEventSubscription.DocdbEventSubscriptionTimeouts,
}
```
