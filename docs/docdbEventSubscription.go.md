...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/docdbeventsubscription"
...
&docdbeventsubscription.DocdbEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.docdbEventSubscription.DocdbEventSubscriptionTimeouts,
}
```
