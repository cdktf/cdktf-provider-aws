...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/daxcluster"
...
&daxcluster.DaxClusterConfig {
	...
	ServerSideEncryption: github.com/cdktf/cdktf-provider-aws-go/aws/v13.daxCluster.DaxClusterServerSideEncryption,
	SubnetGroupName: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.daxCluster.DaxClusterTimeouts,
}
```
