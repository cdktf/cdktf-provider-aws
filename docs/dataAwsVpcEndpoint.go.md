...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsvpcendpoint"
...
&dataawsvpcendpoint.DataAwsVpcEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsVpcEndpoint.DataAwsVpcEndpointTimeouts,
	VpcId: *string,
}
```
