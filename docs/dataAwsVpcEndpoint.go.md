...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsvpcendpoint"
...
&dataawsvpcendpoint.DataAwsVpcEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsVpcEndpoint.DataAwsVpcEndpointTimeouts,
	VpcId: *string,
}
```
