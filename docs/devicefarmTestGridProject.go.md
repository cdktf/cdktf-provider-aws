...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/devicefarmtestgridproject"
...
&devicefarmtestgridproject.DevicefarmTestGridProjectConfig {
	...
	VpcConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.devicefarmTestGridProject.DevicefarmTestGridProjectVpcConfig,
}
```
