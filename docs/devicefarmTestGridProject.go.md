...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/devicefarmtestgridproject"
...
&devicefarmtestgridproject.DevicefarmTestGridProjectConfig {
	...
	VpcConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v15.devicefarmTestGridProject.DevicefarmTestGridProjectVpcConfig,
}
```
