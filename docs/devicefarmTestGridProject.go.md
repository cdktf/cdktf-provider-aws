...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/devicefarmtestgridproject"
...
&devicefarmtestgridproject.DevicefarmTestGridProjectConfig {
	...
	VpcConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v17.devicefarmTestGridProject.DevicefarmTestGridProjectVpcConfig,
}
```
