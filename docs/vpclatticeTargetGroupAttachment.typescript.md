...
```typescript
public readonly timeoutsInput: VpclatticeTargetGroupAttachmentTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-aws.vpclatticeTargetGroupAttachment.VpclatticeTargetGroupAttachmentTimeouts">VpclatticeTargetGroupAttachmentTimeouts</a> | cdktf.IResolvable
...
| <code><a href="#@cdktf/provider-aws.vpclatticeTargetGroupAttachment.VpclatticeTargetGroupAttachmentTarget.property.port">port</a></code> | <code>number</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.66.1/docs/resources/vpclattice_target_group_attachment#port VpclatticeTargetGroupAttachment#port}. |
...
```typescript
public readonly internalValue: VpclatticeTargetGroupAttachmentTimeouts | IResolvable;
```
