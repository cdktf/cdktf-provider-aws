...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/configorganizationconformancepack"
...
&configorganizationconformancepack.ConfigOrganizationConformancePackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.configOrganizationConformancePack.ConfigOrganizationConformancePackTimeouts,
}
```
