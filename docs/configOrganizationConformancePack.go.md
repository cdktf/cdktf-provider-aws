...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/configorganizationconformancepack"
...
&configorganizationconformancepack.ConfigOrganizationConformancePackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.configOrganizationConformancePack.ConfigOrganizationConformancePackTimeouts,
}
```
