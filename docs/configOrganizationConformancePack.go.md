...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/configorganizationconformancepack"
...
&configorganizationconformancepack.ConfigOrganizationConformancePackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.configOrganizationConformancePack.ConfigOrganizationConformancePackTimeouts,
}
```
