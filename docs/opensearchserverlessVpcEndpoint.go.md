...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/opensearchserverlessvpcendpoint"
...
&opensearchserverlessvpcendpoint.OpensearchserverlessVpcEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.opensearchserverlessVpcEndpoint.OpensearchserverlessVpcEndpointTimeouts,
}
```
