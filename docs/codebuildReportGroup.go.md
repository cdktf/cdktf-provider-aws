...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/codebuildreportgroup"
...
&codebuildreportgroup.CodebuildReportGroupConfig {
	...
	ExportConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v12.codebuildReportGroup.CodebuildReportGroupExportConfig,
	Name: *string,
	Type: *string,
...
&codebuildreportgroup.CodebuildReportGroupExportConfig {
	Type: *string,
	S3Destination: github.com/cdktf/cdktf-provider-aws-go/aws/v12.codebuildReportGroup.CodebuildReportGroupExportConfigS3Destination,
}
```
