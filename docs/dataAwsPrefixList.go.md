...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawsprefixlist"
...
&dataawsprefixlist.DataAwsPrefixListConfig {
	...
	Name: *string,
	PrefixListId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.dataAwsPrefixList.DataAwsPrefixListTimeouts,
}
```
