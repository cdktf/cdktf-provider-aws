...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsprefixlist"
...
&dataawsprefixlist.DataAwsPrefixListConfig {
	...
	Name: *string,
	PrefixListId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.dataAwsPrefixList.DataAwsPrefixListTimeouts,
}
```
