...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsebsdefaultkmskey"
...
&dataawsebsdefaultkmskey.DataAwsEbsDefaultKmsKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEbsDefaultKmsKey.DataAwsEbsDefaultKmsKeyTimeouts,
}
```
