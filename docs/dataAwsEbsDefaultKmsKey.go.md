...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dataawsebsdefaultkmskey"
...
&dataawsebsdefaultkmskey.DataAwsEbsDefaultKmsKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.dataAwsEbsDefaultKmsKey.DataAwsEbsDefaultKmsKeyTimeouts,
}
```
