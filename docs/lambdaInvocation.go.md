...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/lambdainvocation"
...
| <code><a href="#@cdktf/provider-aws.lambdaInvocation.LambdaInvocationConfig.property.triggers">Triggers</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.11.0/docs/resources/lambda_invocation#triggers LambdaInvocation#triggers}. |
