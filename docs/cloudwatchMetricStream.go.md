...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/cloudwatchmetricstream"
...
&cloudwatchmetricstream.CloudwatchMetricStreamConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.cloudwatchMetricStream.CloudwatchMetricStreamTimeouts,
}
```
