...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/cloudwatchmetricstream"
...
&cloudwatchmetricstream.CloudwatchMetricStreamConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.cloudwatchMetricStream.CloudwatchMetricStreamTimeouts,
}
```
