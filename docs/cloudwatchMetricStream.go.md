...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/cloudwatchmetricstream"
...
&cloudwatchmetricstream.CloudwatchMetricStreamConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.cloudwatchMetricStream.CloudwatchMetricStreamTimeouts,
}
```
