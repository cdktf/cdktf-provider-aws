...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawsiamsamlprovider"
...
| <code><a href="#@cdktf/provider-aws.dataAwsIamSamlProvider.DataAwsIamSamlProviderConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.18.1/docs/data-sources/iam_saml_provider#tags DataAwsIamSamlProvider#tags}. |
