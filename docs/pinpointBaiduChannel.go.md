...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/pinpointbaiduchannel"
...
| <code><a href="#@cdktf/provider-aws.pinpointBaiduChannel.PinpointBaiduChannelConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.66.0/docs/resources/pinpoint_baidu_channel#enabled PinpointBaiduChannel#enabled}. |
