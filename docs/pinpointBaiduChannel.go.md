...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/pinpointbaiduchannel"
...
| <code><a href="#@cdktf/provider-aws.pinpointBaiduChannel.PinpointBaiduChannelConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.14.0/docs/resources/pinpoint_baidu_channel#enabled PinpointBaiduChannel#enabled}. |
