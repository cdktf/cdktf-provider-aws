...
drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplate(
  ...
  staging_area_tags: typing.Mapping[str] = None,
...
##### `staging_area_tags`<sup>Optional</sup> <a name="staging_area_tags" id="@cdktf/provider-aws.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplate.Initializer.parameter.stagingAreaTags"></a>
...
| <code><a href="#@cdktf/provider-aws.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplate.resetStagingAreaTags">reset_staging_area_tags</a></code> | *No description.* |
...
##### `reset_staging_area_tags` <a name="reset_staging_area_tags" id="@cdktf/provider-aws.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplate.resetStagingAreaTags"></a>

```python
def reset_staging_area_tags() -> None
```
...
##### `staging_area_tags`<sup>Optional</sup> <a name="staging_area_tags" id="@cdktf/provider-aws.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplateConfig.property.stagingAreaTags"></a>
