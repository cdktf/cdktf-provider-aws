...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dbsnapshotcopy"
...
&dbsnapshotcopy.DbSnapshotCopyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dbSnapshotCopy.DbSnapshotCopyTimeouts,
}
```
