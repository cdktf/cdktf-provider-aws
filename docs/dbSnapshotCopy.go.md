...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dbsnapshotcopy"
...
&dbsnapshotcopy.DbSnapshotCopyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dbSnapshotCopy.DbSnapshotCopyTimeouts,
}
```
