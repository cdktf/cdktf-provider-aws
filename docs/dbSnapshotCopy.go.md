...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dbsnapshotcopy"
...
&dbsnapshotcopy.DbSnapshotCopyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.dbSnapshotCopy.DbSnapshotCopyTimeouts,
}
```
