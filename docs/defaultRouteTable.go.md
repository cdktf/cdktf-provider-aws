...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/defaultroutetable"
...
&defaultroutetable.DefaultRouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.defaultRouteTable.DefaultRouteTableTimeouts,
}
```
