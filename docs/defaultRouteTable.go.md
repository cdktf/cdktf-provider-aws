...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/defaultroutetable"
...
&defaultroutetable.DefaultRouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.defaultRouteTable.DefaultRouteTableTimeouts,
}
```
