...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawssubnetids"
...
&dataawssubnetids.DataAwsSubnetIdsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsSubnetIds.DataAwsSubnetIdsTimeouts,
}
```
