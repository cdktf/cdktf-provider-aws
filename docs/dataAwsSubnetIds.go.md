...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawssubnetids"
...
&dataawssubnetids.DataAwsSubnetIdsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsSubnetIds.DataAwsSubnetIdsTimeouts,
}
```
