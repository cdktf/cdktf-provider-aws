...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsalbtargetgroup"
...
&dataawsalbtargetgroup.DataAwsAlbTargetGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsAlbTargetGroup.DataAwsAlbTargetGroupTimeouts,
}
```
