...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/s3bucketacl"
...
&s3bucketacl.S3BucketAclAccessControlPolicy {
	Owner: github.com/cdktf/cdktf-provider-aws-go/aws/v15.s3BucketAcl.S3BucketAclAccessControlPolicyOwner,
	Grant: interface{},
}
```
...
&s3bucketacl.S3BucketAclAccessControlPolicyGrant {
	Permission: *string,
	Grantee: github.com/cdktf/cdktf-provider-aws-go/aws/v15.s3BucketAcl.S3BucketAclAccessControlPolicyGrantGrantee,
}
```
...
&s3bucketacl.S3BucketAclConfig {
	...
	Bucket: *string,
	AccessControlPolicy: github.com/cdktf/cdktf-provider-aws-go/aws/v15.s3BucketAcl.S3BucketAclAccessControlPolicy,
	Acl: *string,
