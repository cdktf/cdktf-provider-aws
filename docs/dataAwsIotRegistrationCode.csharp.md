...
new DataAwsIotRegistrationCode(Construct Scope, string Id, DataAwsIotRegistrationCodeConfig Config = null);
```
...
DataAwsIotRegistrationCode.IsConstruct(object X);
```
...
DataAwsIotRegistrationCode.IsTerraformElement(object X);
```
...
DataAwsIotRegistrationCode.IsTerraformDataSource(object X);
```
...
DataAwsIotRegistrationCode.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCode.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCode.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCode.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCode.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCode.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCode.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCode.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
...
new DataAwsIotRegistrationCodeConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCodeConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCodeConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCodeConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCodeConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsIotRegistrationCode.DataAwsIotRegistrationCodeConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.71.0/docs/data-sources/iot_registration_code#id DataAwsIotRegistrationCode#id}. |
