...
Refer to the Terraform Registory for docs: [`data_aws_cognito_identity_pool`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/cognito_identity_pool).
...
| <code><a href="#@cdktf/provider-aws.dataAwsCognitoIdentityPool.DataAwsCognitoIdentityPoolConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/cognito_identity_pool#id DataAwsCognitoIdentityPool#id}. |
