...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.Initializer.parameter.targetIdentifier">target_identifier</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.5.0/docs/data-sources/controltower_controls#target_identifier DataAwsControltowerControls#target_identifier}. |
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.5.0/docs/data-sources/controltower_controls#id DataAwsControltowerControls#id}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControlsConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.5.0/docs/data-sources/controltower_controls#id DataAwsControltowerControls#id}. |
