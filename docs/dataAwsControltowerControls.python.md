...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.Initializer.parameter.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.Initializer.parameter.targetIdentifier">target_identifier</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/controltower_controls#target_identifier DataAwsControltowerControls#target_identifier}. |
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/controltower_controls#id DataAwsControltowerControls#id}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.toHclTerraform">to_hcl_terraform</a></code> | Adds this resource to the terraform JSON output. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.resetRegion">reset_region</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.toHclTerraform"></a>
...
##### `reset_region` <a name="reset_region" id="@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTF code for importing a DataAwsControltowerControls resource upon running "cdktf plan <stack-name>". |
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.generateConfigForImport"></a>

```python
from cdktf_cdktf_provider_aws import data_aws_controltower_controls

dataAwsControltowerControls.DataAwsControltowerControls.generate_config_for_import(
  scope: Construct,
  import_to_id: str,
  import_from_id: str,
  provider: TerraformProvider = None
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.property.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.property.regionInput">region_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.property.region">region</a></code> | <code>str</code> | *No description.* |
...
##### `region_input`<sup>Optional</sup> <a name="region_input" id="@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControls.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControlsConfig.property.count">count</a></code> | <code>typing.Union[typing.Union[int, float], cdktf.TerraformCount]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsControltowerControls.DataAwsControltowerControlsConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/data-sources/controltower_controls#id DataAwsControltowerControls#id}. |
