...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/shielddrtaccesslogbucketassociation"
...
&shielddrtaccesslogbucketassociation.ShieldDrtAccessLogBucketAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.shieldDrtAccessLogBucketAssociation.ShieldDrtAccessLogBucketAssociationTimeouts,
}
```
