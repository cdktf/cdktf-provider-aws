...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/shielddrtaccesslogbucketassociation"
...
&shielddrtaccesslogbucketassociation.ShieldDrtAccessLogBucketAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.shieldDrtAccessLogBucketAssociation.ShieldDrtAccessLogBucketAssociationTimeouts,
}
```
