...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsec2localgateway"
...
&dataawsec2localgateway.DataAwsEc2LocalGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsEc2LocalGateway.DataAwsEc2LocalGatewayTimeouts,
}
```
