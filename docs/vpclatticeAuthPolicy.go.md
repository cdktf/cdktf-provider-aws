...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/vpclatticeauthpolicy"
...
&vpclatticeauthpolicy.VpclatticeAuthPolicyConfig {
	...
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.vpclatticeAuthPolicy.VpclatticeAuthPolicyTimeouts,
}
```
