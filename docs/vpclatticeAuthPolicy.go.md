...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/vpclatticeauthpolicy"
...
&vpclatticeauthpolicy.VpclatticeAuthPolicyConfig {
	...
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.vpclatticeAuthPolicy.VpclatticeAuthPolicyTimeouts,
}
```
