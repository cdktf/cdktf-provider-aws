...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ebs_default_kms_key aws_ebs_default_kms_key}.

#### Initializers <a name="Initializers" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.Initializer"></a>

```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/ebsdefaultkmskey"
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.importFrom">ImportFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.resetId">ResetId</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.resetRegion">ResetRegion</a></code> | *No description.* |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.hasResourceMove"></a>

```go
func HasResourceMove() interface{}
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.importFrom"></a>

```go
func ImportFrom(id *string, provider TerraformProvider)
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.importFrom.parameter.id"></a>

- *Type:* *string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.importFrom.parameter.provider"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveFromId.parameter.id"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveTo.parameter.index"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.moveToId.parameter.id"></a>
...
##### `ResetRegion` <a name="ResetRegion" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a EbsDefaultKmsKey resource upon running "cdktf plan <stack-name>". |
...
##### `GenerateConfigForImport` <a name="GenerateConfigForImport" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.generateConfigForImport"></a>

```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/ebsdefaultkmskey"

ebsdefaultkmskey.EbsDefaultKmsKey_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```

Generates CDKTF code for importing a EbsDefaultKmsKey resource upon running "cdktf plan <stack-name>".

###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.generateConfigForImport.parameter.importFromId"></a>

- *Type:* *string

The id of the existing EbsDefaultKmsKey that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ebs_default_kms_key#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.property.regionInput">RegionInput</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.property.region">Region</a></code> | <code>*string</code> | *No description.* |
...
##### `RegionInput`<sup>Optional</sup> <a name="RegionInput" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.property.regionInput"></a>
...
##### `Region`<sup>Required</sup> <a name="Region" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKey.property.region"></a>
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKeyConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKeyConfig.property.keyArn">KeyArn</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ebs_default_kms_key#key_arn EbsDefaultKmsKey#key_arn}. |
| <code><a href="#@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKeyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ebs_default_kms_key#id EbsDefaultKmsKey#id}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ebs_default_kms_key#key_arn EbsDefaultKmsKey#key_arn}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ebs_default_kms_key#id EbsDefaultKmsKey#id}.
...
##### `Region`<sup>Optional</sup> <a name="Region" id="@cdktf/provider-aws.ebsDefaultKmsKey.EbsDefaultKmsKeyConfig.property.region"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.13.0/docs/resources/ebs_default_kms_key#region EbsDefaultKmsKey#region}
