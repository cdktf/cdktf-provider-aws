...
Refer to the Terraform Registory for docs: [`aws_securityhub_standards_subscription`](https://registry.terraform.io/providers/hashicorp/aws/5.6.1/docs/resources/securityhub_standards_subscription).
