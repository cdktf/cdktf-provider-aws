...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/fsxopenzfssnapshot"
...
&fsxopenzfssnapshot.FsxOpenzfsSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.fsxOpenzfsSnapshot.FsxOpenzfsSnapshotTimeouts,
}
```
