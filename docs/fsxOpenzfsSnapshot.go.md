...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/fsxopenzfssnapshot"
...
&fsxopenzfssnapshot.FsxOpenzfsSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.fsxOpenzfsSnapshot.FsxOpenzfsSnapshotTimeouts,
}
```
