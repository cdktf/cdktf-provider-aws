...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/ramresourceshare"
...
&ramresourceshare.RamResourceShareConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.ramResourceShare.RamResourceShareTimeouts,
}
```
