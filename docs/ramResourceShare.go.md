...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/ramresourceshare"
...
&ramresourceshare.RamResourceShareConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.ramResourceShare.RamResourceShareTimeouts,
}
```
