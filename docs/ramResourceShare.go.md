...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/ramresourceshare"
...
&ramresourceshare.RamResourceShareConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.ramResourceShare.RamResourceShareTimeouts,
}
```
