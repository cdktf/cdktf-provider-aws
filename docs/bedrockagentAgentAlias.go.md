...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/bedrockagentagentalias"
...
&bedrockagentagentalias.BedrockagentAgentAliasConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.bedrockagentAgentAlias.BedrockagentAgentAliasTimeouts,
}
```
