...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/gluepartition"
...
&gluepartition.GluePartitionConfig {
	...
	StorageDescriptor: github.com/cdktf/cdktf-provider-aws-go/aws/v12.gluePartition.GluePartitionStorageDescriptor,
}
```
...
&gluepartition.GluePartitionStorageDescriptor {
	...
	OutputFormat: *string,
	Parameters: *map[string]*string,
	SerDeInfo: github.com/cdktf/cdktf-provider-aws-go/aws/v12.gluePartition.GluePartitionStorageDescriptorSerDeInfo,
	SkewedInfo: github.com/cdktf/cdktf-provider-aws-go/aws/v12.gluePartition.GluePartitionStorageDescriptorSkewedInfo,
