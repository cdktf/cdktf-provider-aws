...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/guarddutymember"
...
&guarddutymember.GuarddutyMemberConfig {
	...
	Invite: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.guarddutyMember.GuarddutyMemberTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.guarddutyMember.GuarddutyMemberConfig.property.invite">Invite</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.1/docs/resources/guardduty_member#invite GuarddutyMember#invite}. |
