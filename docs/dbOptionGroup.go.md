...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dboptiongroup"
...
&dboptiongroup.DbOptionGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dbOptionGroup.DbOptionGroupTimeouts,
}
```
