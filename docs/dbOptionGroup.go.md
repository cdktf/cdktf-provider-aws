...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dboptiongroup"
...
&dboptiongroup.DbOptionGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dbOptionGroup.DbOptionGroupTimeouts,
}
```
