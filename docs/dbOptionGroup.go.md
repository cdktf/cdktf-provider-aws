...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dboptiongroup"
...
&dboptiongroup.DbOptionGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dbOptionGroup.DbOptionGroupTimeouts,
}
```
