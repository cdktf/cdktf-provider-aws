...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/ecrrepository"
...
&ecrrepository.EcrRepositoryConfig {
	...
	Id: *string,
	ImageScanningConfiguration: github.com/cdktf/cdktf-provider-aws-go/aws/v15.ecrRepository.EcrRepositoryImageScanningConfiguration,
	ImageTagMutability: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.ecrRepository.EcrRepositoryTimeouts,
}
```
