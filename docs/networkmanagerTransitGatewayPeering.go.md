...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/networkmanagertransitgatewaypeering"
...
&networkmanagertransitgatewaypeering.NetworkmanagerTransitGatewayPeeringConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.networkmanagerTransitGatewayPeering.NetworkmanagerTransitGatewayPeeringTimeouts,
}
```
