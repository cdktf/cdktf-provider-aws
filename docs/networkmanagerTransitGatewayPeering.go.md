...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/networkmanagertransitgatewaypeering"
...
&networkmanagertransitgatewaypeering.NetworkmanagerTransitGatewayPeeringConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.networkmanagerTransitGatewayPeering.NetworkmanagerTransitGatewayPeeringTimeouts,
}
```
