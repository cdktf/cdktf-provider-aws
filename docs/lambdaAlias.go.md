...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/lambdaalias"
...
&lambdaalias.LambdaAliasConfig {
	...
	Id: *string,
	Region: *string,
	RoutingConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v21.lambdaAlias.LambdaAliasRoutingConfig,
}
```
