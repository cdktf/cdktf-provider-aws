...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/lambdaalias"
...
&lambdaalias.LambdaAliasConfig {
	...
	Description: *string,
	Id: *string,
	RoutingConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v12.lambdaAlias.LambdaAliasRoutingConfig,
}
```
