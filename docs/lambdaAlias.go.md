...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/lambdaalias"
...
&lambdaalias.LambdaAliasConfig {
	...
	Description: *string,
	Id: *string,
	RoutingConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v17.lambdaAlias.LambdaAliasRoutingConfig,
}
```
