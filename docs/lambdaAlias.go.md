...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/lambdaalias"
...
&lambdaalias.LambdaAliasConfig {
	...
	Description: *string,
	Id: *string,
	RoutingConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v15.lambdaAlias.LambdaAliasRoutingConfig,
}
```
