...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/lambdaalias"
...
&lambdaalias.LambdaAliasConfig {
	...
	Description: *string,
	Id: *string,
	RoutingConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.lambdaAlias.LambdaAliasRoutingConfig,
}
```
