...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dmseventsubscription"
...
&dmseventsubscription.DmsEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dmsEventSubscription.DmsEventSubscriptionTimeouts,
}
```
