...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dmseventsubscription"
...
&dmseventsubscription.DmsEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dmsEventSubscription.DmsEventSubscriptionTimeouts,
}
```
