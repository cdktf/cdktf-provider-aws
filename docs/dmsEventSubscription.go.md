...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dmseventsubscription"
...
&dmseventsubscription.DmsEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dmsEventSubscription.DmsEventSubscriptionTimeouts,
}
```
