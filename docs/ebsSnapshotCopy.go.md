...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/ebssnapshotcopy"
...
&ebssnapshotcopy.EbsSnapshotCopyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.ebsSnapshotCopy.EbsSnapshotCopyTimeouts,
}
```
