...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/neptuneeventsubscription"
...
&neptuneeventsubscription.NeptuneEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.neptuneEventSubscription.NeptuneEventSubscriptionTimeouts,
}
```
