...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/neptuneeventsubscription"
...
&neptuneeventsubscription.NeptuneEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.neptuneEventSubscription.NeptuneEventSubscriptionTimeouts,
}
```
