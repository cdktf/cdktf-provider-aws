...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/glaciervault"
...
&glaciervault.GlacierVaultConfig {
	...
	AccessPolicy: *string,
	Id: *string,
	Notification: github.com/cdktf/cdktf-provider-aws-go/aws/v12.glacierVault.GlacierVaultNotification,
