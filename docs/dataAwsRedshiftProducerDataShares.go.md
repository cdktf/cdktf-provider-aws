...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsredshiftproducerdatashares"
...
| <code><a href="#@cdktf/provider-aws.dataAwsRedshiftProducerDataShares.DataAwsRedshiftProducerDataSharesConfig.property.producerArn">ProducerArn</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/data-sources/redshift_producer_data_shares#producer_arn DataAwsRedshiftProducerDataShares#producer_arn}. |
...
```go
func InternalValue() DataAwsRedshiftProducerDataSharesDataShares
```
