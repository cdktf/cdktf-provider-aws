...
Refer to the Terraform Registory for docs: [`data_aws_ecrpublic_authorization_token`](https://registry.terraform.io/providers/hashicorp/aws/4.66.1/docs/data-sources/ecrpublic_authorization_token).
