...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping aws_emr_studio_session_mapping}.
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.importFrom">ImportFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.resetRegion">ResetRegion</a></code> | *No description.* |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.addMoveTarget"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.hasResourceMove"></a>

```csharp
private object HasResourceMove()
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.importFrom"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.moveFromId"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.moveTo"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.moveTo.parameter.moveTarget"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.moveToId"></a>
...
##### `ResetRegion` <a name="ResetRegion" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a EmrStudioSessionMapping resource upon running "cdktf plan <stack-name>". |
...
###### `ImportToId`<sup>Required</sup> <a name="ImportToId" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.generateConfigForImport.parameter.importToId"></a>
...
###### `ImportFromId`<sup>Required</sup> <a name="ImportFromId" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing EmrStudioSessionMapping that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.property.regionInput">RegionInput</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.property.region">Region</a></code> | <code>string</code> | *No description.* |
...
##### `RegionInput`<sup>Optional</sup> <a name="RegionInput" id="@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMapping.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMappingConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.emrStudioSessionMapping.EmrStudioSessionMappingConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#id EmrStudioSessionMapping#id}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#identity_type EmrStudioSessionMapping#identity_type}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#session_policy_arn EmrStudioSessionMapping#session_policy_arn}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#studio_id EmrStudioSessionMapping#studio_id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#id EmrStudioSessionMapping#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#identity_id EmrStudioSessionMapping#identity_id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#identity_name EmrStudioSessionMapping#identity_name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/emr_studio_session_mapping#region EmrStudioSessionMapping#region}
