...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/dbsnapshot"
...
&dbsnapshot.DbSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v18.dbSnapshot.DbSnapshotTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dbSnapshot.DbSnapshotConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/db_snapshot#tags DbSnapshot#tags}. |
| <code><a href="#@cdktf/provider-aws.dbSnapshot.DbSnapshotConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/db_snapshot#tags_all DbSnapshot#tags_all}. |
