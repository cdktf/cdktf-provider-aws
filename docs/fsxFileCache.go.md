...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/fsxfilecache"
...
&fsxfilecache.FsxFileCacheConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.fsxFileCache.FsxFileCacheTimeouts,
}
```
