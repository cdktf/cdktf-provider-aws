...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/fsxfilecache"
...
&fsxfilecache.FsxFileCacheConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.fsxFileCache.FsxFileCacheTimeouts,
}
```
