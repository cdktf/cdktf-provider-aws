...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsec2host"
...
&dataawsec2host.DataAwsEc2HostConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.dataAwsEc2Host.DataAwsEc2HostTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsEc2Host.DataAwsEc2HostConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.66.0/docs/data-sources/ec2_host#tags DataAwsEc2Host#tags}. |
