...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/appstreamdirectoryconfig"
...
&appstreamdirectoryconfig.AppstreamDirectoryConfigConfig {
	...
	ServiceAccountCredentials: github.com/cdktf/cdktf-provider-aws-go/aws/v15.appstreamDirectoryConfig.AppstreamDirectoryConfigServiceAccountCredentials,
	Id: *string,
}
```
