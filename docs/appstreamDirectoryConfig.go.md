...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/appstreamdirectoryconfig"
...
&appstreamdirectoryconfig.AppstreamDirectoryConfigConfig {
	...
	ServiceAccountCredentials: github.com/cdktf/cdktf-provider-aws-go/aws/v13.appstreamDirectoryConfig.AppstreamDirectoryConfigServiceAccountCredentials,
	Id: *string,
}
```
