...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/appstreamdirectoryconfig"
...
&appstreamdirectoryconfig.AppstreamDirectoryConfigConfig {
	...
	ServiceAccountCredentials: github.com/cdktf/cdktf-provider-aws-go/aws/v16.appstreamDirectoryConfig.AppstreamDirectoryConfigServiceAccountCredentials,
	Id: *string,
}
```
