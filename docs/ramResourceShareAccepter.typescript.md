...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter aws_ram_resource_share_accepter}.

#### Initializers <a name="Initializers" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.Initializer"></a>

```typescript
import { ramResourceShareAccepter } from '@cdktf/provider-aws'
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.resetRegion">resetRegion</a></code> | *No description.* |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.addMoveTarget.parameter.moveTarget"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.importFrom.parameter.provider"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.moveToId.parameter.id"></a>
...
##### `resetRegion` <a name="resetRegion" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a RamResourceShareAccepter resource upon running "cdktf plan <stack-name>". |
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing RamResourceShareAccepter that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.regionInput">regionInput</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterTimeouts">RamResourceShareAccepterTimeouts</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.region">region</a></code> | <code>string</code> | *No description.* |
...
##### `regionInput`<sup>Optional</sup> <a name="regionInput" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.regionInput"></a>
...
- *Type:* cdktf.IResolvable | <a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterTimeouts">RamResourceShareAccepterTimeouts</a>
...
##### `region`<sup>Required</sup> <a name="region" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepter.property.region"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.shareArn">shareArn</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#share_arn RamResourceShareAccepter#share_arn}. |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#id RamResourceShareAccepter#id}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#share_arn RamResourceShareAccepter#share_arn}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#id RamResourceShareAccepter#id}.
...
##### `region`<sup>Optional</sup> <a name="region" id="@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterConfig.property.region"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#region RamResourceShareAccepter#region}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#timeouts RamResourceShareAccepter#timeouts}
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterTimeouts.property.create">create</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#create RamResourceShareAccepter#create}. |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterTimeouts.property.delete">delete</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#delete RamResourceShareAccepter#delete}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#create RamResourceShareAccepter#create}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/ram_resource_share_accepter#delete RamResourceShareAccepter#delete}.
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.ramResourceShareAccepter.RamResourceShareAccepterTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktf.IInterpolatingParent</code> | The parent resource. |
