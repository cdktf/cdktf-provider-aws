...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/vpcrouteservervpcassociation"
...
&vpcrouteservervpcassociation.VpcRouteServerVpcAssociationConfig {
	...
	VpcId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.vpcRouteServerVpcAssociation.VpcRouteServerVpcAssociationTimeouts,
}
```
