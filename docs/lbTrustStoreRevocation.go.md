...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/lbtruststorerevocation"
...
&lbtruststorerevocation.LbTrustStoreRevocationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.lbTrustStoreRevocation.LbTrustStoreRevocationTimeouts,
}
```
