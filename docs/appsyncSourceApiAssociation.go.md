...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/appsyncsourceapiassociation"
...
&appsyncsourceapiassociation.AppsyncSourceApiAssociationConfig {
	...
	SourceApiId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.appsyncSourceApiAssociation.AppsyncSourceApiAssociationTimeouts,
}
```
