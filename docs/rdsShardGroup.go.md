...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/rdsshardgroup"
...
&rdsshardgroup.RdsShardGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.rdsShardGroup.RdsShardGroupTimeouts,
}
```
