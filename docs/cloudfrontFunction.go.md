...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/cloudfrontfunction"
...
| <code><a href="#@cdktf/provider-aws.cloudfrontFunction.CloudfrontFunctionConfig.property.publish">Publish</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cloudfront_function#publish CloudfrontFunction#publish}. |
