...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsec2localgateways"
...
&dataawsec2localgateways.DataAwsEc2LocalGatewaysConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsEc2LocalGateways.DataAwsEc2LocalGatewaysTimeouts,
}
```
