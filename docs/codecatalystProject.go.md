...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/codecatalystproject"
...
&codecatalystproject.CodecatalystProjectConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.codecatalystProject.CodecatalystProjectTimeouts,
}
```
