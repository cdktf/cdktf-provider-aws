...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/codecatalystproject"
...
&codecatalystproject.CodecatalystProjectConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.codecatalystProject.CodecatalystProjectTimeouts,
}
```
