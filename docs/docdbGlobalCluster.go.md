...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/docdbglobalcluster"
...
&docdbglobalcluster.DocdbGlobalClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.docdbGlobalCluster.DocdbGlobalClusterTimeouts,
}
```
