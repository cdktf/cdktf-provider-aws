...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/docdbglobalcluster"
...
&docdbglobalcluster.DocdbGlobalClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.docdbGlobalCluster.DocdbGlobalClusterTimeouts,
}
```
