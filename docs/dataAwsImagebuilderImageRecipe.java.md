...
Refer to the Terraform Registory for docs: [`data_aws_imagebuilder_image_recipe`](https://registry.terraform.io/providers/hashicorp/aws/5.11.0/docs/data-sources/imagebuilder_image_recipe).
