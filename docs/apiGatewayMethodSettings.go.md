...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/apigatewaymethodsettings"
...
&apigatewaymethodsettings.ApiGatewayMethodSettingsConfig {
	...
	MethodPath: *string,
	RestApiId: *string,
	Settings: github.com/cdktf/cdktf-provider-aws-go/aws/v13.apiGatewayMethodSettings.ApiGatewayMethodSettingsSettings,
	StageName: *string,
	Id: *string,
}
```
