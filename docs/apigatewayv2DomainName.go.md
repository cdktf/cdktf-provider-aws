...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/apigatewayv2domainname"
...
&apigatewayv2domainname.Apigatewayv2DomainNameConfig {
	...
	DomainName: *string,
	DomainNameConfiguration: github.com/cdktf/cdktf-provider-aws-go/aws/v13.apigatewayv2DomainName.Apigatewayv2DomainNameDomainNameConfiguration,
	Id: *string,
	MutualTlsAuthentication: github.com/cdktf/cdktf-provider-aws-go/aws/v13.apigatewayv2DomainName.Apigatewayv2DomainNameMutualTlsAuthentication,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.apigatewayv2DomainName.Apigatewayv2DomainNameTimeouts,
}
```
