...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/servicecatalogprovisioningartifact"
...
&servicecatalogprovisioningartifact.ServicecatalogProvisioningArtifactConfig {
	...
	TemplateUrl: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.servicecatalogProvisioningArtifact.ServicecatalogProvisioningArtifactTimeouts,
	Type: *string,
}
```
