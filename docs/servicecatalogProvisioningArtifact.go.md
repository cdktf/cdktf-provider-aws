...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/servicecatalogprovisioningartifact"
...
&servicecatalogprovisioningartifact.ServicecatalogProvisioningArtifactConfig {
	...
	TemplateUrl: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.servicecatalogProvisioningArtifact.ServicecatalogProvisioningArtifactTimeouts,
	Type: *string,
}
```
