...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/gameliftbuild"
...
&gameliftbuild.GameliftBuildConfig {
	...
	StorageLocation: github.com/cdktf/cdktf-provider-aws-go/aws/v13.gameliftBuild.GameliftBuildStorageLocation,
	Id: *string,
