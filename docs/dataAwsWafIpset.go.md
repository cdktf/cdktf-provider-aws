...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawswafipset"
...
| <code><a href="#@cdktf/provider-aws.dataAwsWafIpset.DataAwsWafIpset.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsWafIpset.DataAwsWafIpsetConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
