...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/vpcsecuritygroupvpcassociation"
...
&vpcsecuritygroupvpcassociation.VpcSecurityGroupVpcAssociationConfig {
	...
	VpcId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.vpcSecurityGroupVpcAssociation.VpcSecurityGroupVpcAssociationTimeouts,
}
```
