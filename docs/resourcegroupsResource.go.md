...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/resourcegroupsresource"
...
&resourcegroupsresource.ResourcegroupsResourceConfig {
	...
	ResourceArn: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.resourcegroupsResource.ResourcegroupsResourceTimeouts,
}
```
