...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/resourcegroupsresource"
...
&resourcegroupsresource.ResourcegroupsResourceConfig {
	...
	ResourceArn: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.resourcegroupsResource.ResourcegroupsResourceTimeouts,
}
```
