...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/proxyprotocolpolicy"
...
| <code><a href="#@cdktf/provider-aws.proxyProtocolPolicy.ProxyProtocolPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/proxy_protocol_policy#id ProxyProtocolPolicy#id}. |
