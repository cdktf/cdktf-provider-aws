...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsec2instancetypeoffering"
...
&dataawsec2instancetypeoffering.DataAwsEc2InstanceTypeOfferingConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEc2InstanceTypeOffering.DataAwsEc2InstanceTypeOfferingTimeouts,
}
```
