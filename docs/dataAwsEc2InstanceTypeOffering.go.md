...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2instancetypeoffering"
...
&dataawsec2instancetypeoffering.DataAwsEc2InstanceTypeOfferingConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2InstanceTypeOffering.DataAwsEc2InstanceTypeOfferingTimeouts,
}
```
