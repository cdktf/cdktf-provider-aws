...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/controltowercontrol"
...
| <code><a href="#@cdktf/provider-aws.controltowerControl.ControltowerControl.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&controltowercontrol.ControltowerControlConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.controltowerControl.ControltowerControlTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.controltowerControl.ControltowerControlConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
