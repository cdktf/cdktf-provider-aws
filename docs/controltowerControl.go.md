...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/controltowercontrol"
...
&controltowercontrol.ControltowerControlConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.controltowerControl.ControltowerControlTimeouts,
}
```
