...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dxtransitvirtualinterface"
...
&dxtransitvirtualinterface.DxTransitVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dxTransitVirtualInterface.DxTransitVirtualInterfaceTimeouts,
}
```
