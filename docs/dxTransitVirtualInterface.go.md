...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dxtransitvirtualinterface"
...
&dxtransitvirtualinterface.DxTransitVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dxTransitVirtualInterface.DxTransitVirtualInterfaceTimeouts,
}
```
