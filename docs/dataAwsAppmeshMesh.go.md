...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/dataawsappmeshmesh"
...
| <code><a href="#@cdktf/provider-aws.dataAwsAppmeshMesh.DataAwsAppmeshMeshConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/data-sources/appmesh_mesh#tags DataAwsAppmeshMesh#tags}. |
