...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/transcribelanguagemodel"
...
&transcribelanguagemodel.TranscribeLanguageModelConfig {
	...
	InputDataConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.transcribeLanguageModel.TranscribeLanguageModelInputDataConfig,
	LanguageCode: *string,
	ModelName: *string,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.transcribeLanguageModel.TranscribeLanguageModelTimeouts,
}
```
