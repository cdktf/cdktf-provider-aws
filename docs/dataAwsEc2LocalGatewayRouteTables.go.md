...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsec2localgatewayroutetables"
...
&dataawsec2localgatewayroutetables.DataAwsEc2LocalGatewayRouteTablesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEc2LocalGatewayRouteTables.DataAwsEc2LocalGatewayRouteTablesTimeouts,
}
```
