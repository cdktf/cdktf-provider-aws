...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawslblistener"
...
&dataawslblistener.DataAwsLbListenerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsLbListener.DataAwsLbListenerTimeouts,
}
```
