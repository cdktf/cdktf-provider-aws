...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawslblistener"
...
&dataawslblistener.DataAwsLbListenerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsLbListener.DataAwsLbListenerTimeouts,
}
```
