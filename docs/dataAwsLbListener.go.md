...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawslblistener"
...
&dataawslblistener.DataAwsLbListenerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsLbListener.DataAwsLbListenerTimeouts,
}
```
