...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/gluesecurityconfiguration"
...
| <code><a href="#@cdktf/provider-aws.glueSecurityConfiguration.GlueSecurityConfiguration.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&gluesecurityconfiguration.GlueSecurityConfigurationConfig {
	...
	EncryptionConfiguration: github.com/cdktf/cdktf-provider-aws-go/aws/v17.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfiguration,
	Name: *string,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.glueSecurityConfiguration.GlueSecurityConfigurationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&gluesecurityconfiguration.GlueSecurityConfigurationEncryptionConfiguration {
	CloudwatchEncryption: github.com/cdktf/cdktf-provider-aws-go/aws/v17.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationCloudwatchEncryption,
	JobBookmarksEncryption: github.com/cdktf/cdktf-provider-aws-go/aws/v17.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationJobBookmarksEncryption,
	S3Encryption: github.com/cdktf/cdktf-provider-aws-go/aws/v17.glueSecurityConfiguration.GlueSecurityConfigurationEncryptionConfigurationS3Encryption,
}
```
