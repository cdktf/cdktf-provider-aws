...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawstransferserver"
...
| <code><a href="#@cdktf/provider-aws.dataAwsTransferServer.DataAwsTransferServerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.84.0/docs/data-sources/transfer_server#tags DataAwsTransferServer#tags}. |
