...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawseksaddon"
...
| <code><a href="#@cdktf/provider-aws.dataAwsEksAddon.DataAwsEksAddonConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.63.0/docs/data-sources/eks_addon#tags DataAwsEksAddon#tags}. |
