...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsnatgateways"
...
&dataawsnatgateways.DataAwsNatGatewaysConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsNatGateways.DataAwsNatGatewaysTimeouts,
	VpcId: *string,
}
```
