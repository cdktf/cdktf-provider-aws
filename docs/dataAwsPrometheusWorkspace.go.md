...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsprometheusworkspace"
...
| <code><a href="#@cdktf/provider-aws.dataAwsPrometheusWorkspace.DataAwsPrometheusWorkspaceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.80.0/docs/data-sources/prometheus_workspace#tags DataAwsPrometheusWorkspace#tags}. |
