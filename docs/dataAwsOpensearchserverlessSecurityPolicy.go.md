...
Refer to the Terraform Registory for docs: [`data_aws_opensearchserverless_security_policy`](https://registry.terraform.io/providers/hashicorp/aws/5.11.0/docs/data-sources/opensearchserverless_security_policy).
