...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/finspacekxuser"
...
&finspacekxuser.FinspaceKxUserConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v18.finspaceKxUser.FinspaceKxUserTimeouts,
}
```
