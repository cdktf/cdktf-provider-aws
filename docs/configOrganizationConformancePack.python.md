...
Refer to the Terraform Registory for docs: [`aws_config_organization_conformance_pack`](https://registry.terraform.io/providers/hashicorp/aws/5.11.0/docs/resources/config_organization_conformance_pack).
