...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/flowlog"
...
&flowlog.FlowLogConfig {
	...
	DestinationOptions: github.com/cdktf/cdktf-provider-aws-go/aws/v12.flowLog.FlowLogDestinationOptions,
	EniId: *string,
	IamRoleArn: *string,
	Id: *string,
