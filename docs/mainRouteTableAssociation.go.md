...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/mainroutetableassociation"
...
&mainroutetableassociation.MainRouteTableAssociationConfig {
	...
	VpcId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.mainRouteTableAssociation.MainRouteTableAssociationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociationConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/main_route_table_association#id MainRouteTableAssociation#id}. |
