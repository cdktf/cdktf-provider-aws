...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain aws_codeartifact_domain}.
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.toHclTerraform">toHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.addMoveTarget">addMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.hasResourceMove">hasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.importFrom">importFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveTo">moveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.resetRegion">resetRegion</a></code> | *No description.* |
...
##### `toHclTerraform` <a name="toHclTerraform" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.toHclTerraform"></a>
...
##### `addMoveTarget` <a name="addMoveTarget" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.addMoveTarget.parameter.moveTarget"></a>
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.hasResourceMove"></a>

```typescript
public hasResourceMove(): TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `importFrom` <a name="importFrom" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.importFrom"></a>

```typescript
public importFrom(id: string, provider?: TerraformProvider): void
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.importFrom.parameter.id"></a>

- *Type:* string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.importFrom.parameter.provider"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveFromId.parameter.id"></a>
...
##### `moveTo` <a name="moveTo" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveTo.parameter.index"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.moveToId.parameter.id"></a>
...
##### `resetRegion` <a name="resetRegion" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.generateConfigForImport">generateConfigForImport</a></code> | Generates CDKTF code for importing a CodeartifactDomain resource upon running "cdktf plan <stack-name>". |
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing CodeartifactDomain that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.assetSizeBytes">assetSizeBytes</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.s3BucketArn">s3BucketArn</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.regionInput">regionInput</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.region">region</a></code> | <code>string</code> | *No description.* |
...
```typescript
public readonly assetSizeBytes: string;
```
...
##### `s3BucketArn`<sup>Required</sup> <a name="s3BucketArn" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.s3BucketArn"></a>
...
##### `regionInput`<sup>Optional</sup> <a name="regionInput" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.regionInput"></a>
...
##### `region`<sup>Required</sup> <a name="region" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomain.property.region"></a>
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomainConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomainConfig.property.domain">domain</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#domain CodeartifactDomain#domain}. |
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomainConfig.property.encryptionKey">encryptionKey</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#encryption_key CodeartifactDomain#encryption_key}. |
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomainConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#id CodeartifactDomain#id}. |
...
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomainConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#tags CodeartifactDomain#tags}. |
| <code><a href="#@cdktf/provider-aws.codeartifactDomain.CodeartifactDomainConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#tags_all CodeartifactDomain#tags_all}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#domain CodeartifactDomain#domain}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#encryption_key CodeartifactDomain#encryption_key}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#id CodeartifactDomain#id}.
...
##### `region`<sup>Optional</sup> <a name="region" id="@cdktf/provider-aws.codeartifactDomain.CodeartifactDomainConfig.property.region"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#region CodeartifactDomain#region}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#tags CodeartifactDomain#tags}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/codeartifact_domain#tags_all CodeartifactDomain#tags_all}.
