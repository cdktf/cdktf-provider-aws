...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawsecscluster"
...
| <code><a href="#@cdktf/provider-aws.dataAwsEcsCluster.DataAwsEcsClusterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.19.0/docs/data-sources/ecs_cluster#tags DataAwsEcsCluster#tags}. |
