...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/appfabricappauthorizationconnection"
...
&appfabricappauthorizationconnection.AppfabricAppAuthorizationConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.appfabricAppAuthorizationConnection.AppfabricAppAuthorizationConnectionTimeouts,
}
```
