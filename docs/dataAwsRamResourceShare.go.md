...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsramresourceshare"
...
| <code><a href="#@cdktf/provider-aws.dataAwsRamResourceShare.DataAwsRamResourceShareConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/data-sources/ram_resource_share#tags DataAwsRamResourceShare#tags}. |
