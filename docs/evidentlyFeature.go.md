...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/evidentlyfeature"
...
&evidentlyfeature.EvidentlyFeatureConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.evidentlyFeature.EvidentlyFeatureTimeouts,
}
```
...
&evidentlyfeature.EvidentlyFeatureVariations {
	Name: *string,
	Value: github.com/cdktf/cdktf-provider-aws-go/aws/v15.evidentlyFeature.EvidentlyFeatureVariationsValue,
}
```
