...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/evidentlyfeature"
...
&evidentlyfeature.EvidentlyFeatureConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.evidentlyFeature.EvidentlyFeatureTimeouts,
}
```
...
&evidentlyfeature.EvidentlyFeatureVariations {
	Name: *string,
	Value: github.com/cdktf/cdktf-provider-aws-go/aws/v13.evidentlyFeature.EvidentlyFeatureVariationsValue,
}
```
