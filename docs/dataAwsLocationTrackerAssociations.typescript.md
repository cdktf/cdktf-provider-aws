...
Refer to the Terraform Registory for docs: [`data_aws_location_tracker_associations`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/location_tracker_associations).
