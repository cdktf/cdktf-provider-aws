...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsvpcipampool"
...
&dataawsvpcipampool.DataAwsVpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsVpcIpamPool.DataAwsVpcIpamPoolTimeouts,
}
```
