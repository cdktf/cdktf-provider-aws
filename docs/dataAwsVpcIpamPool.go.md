...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsvpcipampool"
...
&dataawsvpcipampool.DataAwsVpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsVpcIpamPool.DataAwsVpcIpamPoolTimeouts,
}
```
