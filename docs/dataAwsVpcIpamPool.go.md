...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsvpcipampool"
...
&dataawsvpcipampool.DataAwsVpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsVpcIpamPool.DataAwsVpcIpamPoolTimeouts,
}
```
