...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/configconfigurationrecorder"
...
&configconfigurationrecorder.ConfigConfigurationRecorderConfig {
	...
	Id: *string,
	Name: *string,
	RecordingGroup: github.com/cdktf/cdktf-provider-aws-go/aws/v12.configConfigurationRecorder.ConfigConfigurationRecorderRecordingGroup,
}
```
