...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsnetworkinterfaces"
...
&dataawsnetworkinterfaces.DataAwsNetworkInterfacesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsNetworkInterfaces.DataAwsNetworkInterfacesTimeouts,
}
```
