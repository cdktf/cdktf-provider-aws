...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/locationgeofencecollection"
...
&locationgeofencecollection.LocationGeofenceCollectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.locationGeofenceCollection.LocationGeofenceCollectionTimeouts,
}
```
