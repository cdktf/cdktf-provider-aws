...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/locationgeofencecollection"
...
&locationgeofencecollection.LocationGeofenceCollectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.locationGeofenceCollection.LocationGeofenceCollectionTimeouts,
}
```
