...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/s3controlbucketlifecycleconfiguration"
...
&s3controlbucketlifecycleconfiguration.S3ControlBucketLifecycleConfigurationRule {
	Id: *string,
	AbortIncompleteMultipartUpload: github.com/cdktf/cdktf-provider-aws-go/aws/v19.s3ControlBucketLifecycleConfiguration.S3ControlBucketLifecycleConfigurationRuleAbortIncompleteMultipartUpload,
	Expiration: github.com/cdktf/cdktf-provider-aws-go/aws/v19.s3ControlBucketLifecycleConfiguration.S3ControlBucketLifecycleConfigurationRuleExpiration,
	Filter: github.com/cdktf/cdktf-provider-aws-go/aws/v19.s3ControlBucketLifecycleConfiguration.S3ControlBucketLifecycleConfigurationRuleFilter,
	Status: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.s3ControlBucketLifecycleConfiguration.S3ControlBucketLifecycleConfigurationRuleExpiration.property.expiredObjectDeleteMarker">ExpiredObjectDeleteMarker</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.96.0/docs/resources/s3control_bucket_lifecycle_configuration#expired_object_delete_marker S3ControlBucketLifecycleConfiguration#expired_object_delete_marker}. |
