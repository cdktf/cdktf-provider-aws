...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/kendrathesaurus"
...
&kendrathesaurus.KendraThesaurusConfig {
	...
	Name: *string,
	RoleArn: *string,
	SourceS3Path: github.com/cdktf/cdktf-provider-aws-go/aws/v13.kendraThesaurus.KendraThesaurusSourceS3Path,
	Description: *string,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.kendraThesaurus.KendraThesaurusTimeouts,
}
```
