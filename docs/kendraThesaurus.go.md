...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/kendrathesaurus"
...
&kendrathesaurus.KendraThesaurusConfig {
	...
	Name: *string,
	RoleArn: *string,
	SourceS3Path: github.com/cdktf/cdktf-provider-aws-go/aws/v17.kendraThesaurus.KendraThesaurusSourceS3Path,
	Description: *string,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.kendraThesaurus.KendraThesaurusTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.kendraThesaurus.KendraThesaurusConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.14.0/docs/resources/kendra_thesaurus#tags KendraThesaurus#tags}. |
| <code><a href="#@cdktf/provider-aws.kendraThesaurus.KendraThesaurusConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.14.0/docs/resources/kendra_thesaurus#tags_all KendraThesaurus#tags_all}. |
