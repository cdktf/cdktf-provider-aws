...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2transitgatewaypeeringattachment"
...
&dataawsec2transitgatewaypeeringattachment.DataAwsEc2TransitGatewayPeeringAttachmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2TransitGatewayPeeringAttachment.DataAwsEc2TransitGatewayPeeringAttachmentTimeouts,
}
```
