...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsec2transitgatewaypeeringattachment"
...
&dataawsec2transitgatewaypeeringattachment.DataAwsEc2TransitGatewayPeeringAttachmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEc2TransitGatewayPeeringAttachment.DataAwsEc2TransitGatewayPeeringAttachmentTimeouts,
}
```
