...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/servicecatalogtagoption"
...
servicecatalogtagoption.ServicecatalogTagOption_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| <code><a href="#@cdktf/provider-aws.servicecatalogTagOption.ServicecatalogTagOption.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&servicecatalogtagoption.ServicecatalogTagOptionConfig {
	...
	Active: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.servicecatalogTagOption.ServicecatalogTagOptionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.servicecatalogTagOption.ServicecatalogTagOptionConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.servicecatalogTagOption.ServicecatalogTagOptionConfig.property.active">Active</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/servicecatalog_tag_option#active ServicecatalogTagOption#active}. |
