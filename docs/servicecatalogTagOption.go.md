...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/servicecatalogtagoption"
...
&servicecatalogtagoption.ServicecatalogTagOptionConfig {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.servicecatalogTagOption.ServicecatalogTagOptionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.servicecatalogTagOption.ServicecatalogTagOptionConfig.property.active">Active</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.10.0/docs/resources/servicecatalog_tag_option#active ServicecatalogTagOption#active}. |
