...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/connectphonenumber"
...
&connectphonenumber.ConnectPhoneNumberConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.connectPhoneNumber.ConnectPhoneNumberTimeouts,
}
```
