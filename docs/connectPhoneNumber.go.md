...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/connectphonenumber"
...
&connectphonenumber.ConnectPhoneNumberConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.connectPhoneNumber.ConnectPhoneNumberTimeouts,
}
```
