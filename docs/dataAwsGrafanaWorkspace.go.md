...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawsgrafanaworkspace"
...
| <code><a href="#@cdktf/provider-aws.dataAwsGrafanaWorkspace.DataAwsGrafanaWorkspaceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/data-sources/grafana_workspace#tags DataAwsGrafanaWorkspace#tags}. |
