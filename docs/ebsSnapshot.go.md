...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/ebssnapshot"
...
&ebssnapshot.EbsSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.ebsSnapshot.EbsSnapshotTimeouts,
}
```
