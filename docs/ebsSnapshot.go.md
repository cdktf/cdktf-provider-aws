...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/ebssnapshot"
...
&ebssnapshot.EbsSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.ebsSnapshot.EbsSnapshotTimeouts,
}
```
