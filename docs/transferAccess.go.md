...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/transferaccess"
...
&transferaccess.TransferAccessConfig {
	...
	Id: *string,
	Policy: *string,
	PosixProfile: github.com/cdktf/cdktf-provider-aws-go/aws/v12.transferAccess.TransferAccessPosixProfile,
	Role: *string,
}
```
