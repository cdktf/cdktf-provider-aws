...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/transferaccess"
...
&transferaccess.TransferAccessConfig {
	...
	Id: *string,
	Policy: *string,
	PosixProfile: github.com/cdktf/cdktf-provider-aws-go/aws/v15.transferAccess.TransferAccessPosixProfile,
	Role: *string,
}
```
