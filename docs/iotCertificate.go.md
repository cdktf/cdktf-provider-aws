...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/iotcertificate"
...
| <code><a href="#@cdktf/provider-aws.iotCertificate.IotCertificateConfig.property.active">Active</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/resources/iot_certificate#active IotCertificate#active}. |
