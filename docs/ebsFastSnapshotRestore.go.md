...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/ebsfastsnapshotrestore"
...
&ebsfastsnapshotrestore.EbsFastSnapshotRestoreConfig {
	...
	SnapshotId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.ebsFastSnapshotRestore.EbsFastSnapshotRestoreTimeouts,
}
```
