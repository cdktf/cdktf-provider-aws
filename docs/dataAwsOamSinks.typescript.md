...
```typescript
import { dataAwsOamSinks } from '@cdktf/provider-aws'

new dataAwsOamSinks.DataAwsOamSinks(scope: Construct, id: string, config?: DataAwsOamSinksConfig)
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinks.resetRegion">resetRegion</a></code> | *No description.* |
...
##### `resetRegion` <a name="resetRegion" id="@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinks.resetRegion"></a>
...
dataAwsOamSinks.DataAwsOamSinks.isConstruct(x: any)
```
...
dataAwsOamSinks.DataAwsOamSinks.isTerraformElement(x: any)
```
...
dataAwsOamSinks.DataAwsOamSinks.isTerraformDataSource(x: any)
```
...
dataAwsOamSinks.DataAwsOamSinks.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinks.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinks.property.regionInput">regionInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinks.property.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinks.property.region">region</a></code> | <code>string</code> | *No description.* |
...
##### `regionInput`<sup>Optional</sup> <a name="regionInput" id="@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinks.property.regionInput"></a>
...
const dataAwsOamSinksConfig: dataAwsOamSinks.DataAwsOamSinksConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsOamSinks.DataAwsOamSinksConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/data-sources/oam_sinks#id DataAwsOamSinks#id}. |
