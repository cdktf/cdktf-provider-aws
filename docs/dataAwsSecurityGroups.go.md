...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dataawssecuritygroups"
...
&dataawssecuritygroups.DataAwsSecurityGroupsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.dataAwsSecurityGroups.DataAwsSecurityGroupsTimeouts,
}
```
