...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawssecuritygroups"
...
&dataawssecuritygroups.DataAwsSecurityGroupsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsSecurityGroups.DataAwsSecurityGroupsTimeouts,
}
```
