...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawssecuritygroup"
...
&dataawssecuritygroup.DataAwsSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsSecurityGroup.DataAwsSecurityGroupTimeouts,
	VpcId: *string,
}
```
