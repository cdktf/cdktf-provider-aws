...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawsbatchjobqueue"
...
| <code><a href="#@cdktf/provider-aws.dataAwsBatchJobQueue.DataAwsBatchJobQueueConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.66.0/docs/data-sources/batch_job_queue#tags DataAwsBatchJobQueue#tags}. |
