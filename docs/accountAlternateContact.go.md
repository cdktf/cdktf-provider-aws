...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/accountalternatecontact"
...
&accountalternatecontact.AccountAlternateContactConfig {
	...
	AccountId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.accountAlternateContact.AccountAlternateContactTimeouts,
}
```
