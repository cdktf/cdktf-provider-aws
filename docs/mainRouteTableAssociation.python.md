...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/main_route_table_association#id MainRouteTableAssociation#id}. |
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.addMoveTarget">add_move_target</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.hasResourceMove">has_resource_move</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.importFrom">import_from</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.moveFromId">move_from_id</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.moveTo">move_to</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.moveToId">move_to_id</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.resetRegion">reset_region</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.toHclTerraform"></a>
...
##### `add_move_target` <a name="add_move_target" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.addMoveTarget"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.addMoveTarget.parameter.moveTarget"></a>
...
##### `has_resource_move` <a name="has_resource_move" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.hasResourceMove"></a>

```python
def has_resource_move() -> typing.Union[TerraformResourceMoveByTarget, TerraformResourceMoveById]
```

##### `import_from` <a name="import_from" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.importFrom"></a>
...
##### `move_from_id` <a name="move_from_id" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.moveFromId"></a>
...
##### `move_to` <a name="move_to" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.moveTo"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.moveTo.parameter.moveTarget"></a>
...
##### `move_to_id` <a name="move_to_id" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.moveToId"></a>
...
##### `reset_region` <a name="reset_region" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTF code for importing a MainRouteTableAssociation resource upon running "cdktf plan <stack-name>". |
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.generateConfigForImport"></a>

```python
from cdktf_cdktf_provider_aws import main_route_table_association

mainRouteTableAssociation.MainRouteTableAssociation.generate_config_for_import(
  scope: Construct,
  import_to_id: str,
  import_from_id: str,
  provider: TerraformProvider = None
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.property.regionInput">region_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.property.region">region</a></code> | <code>str</code> | *No description.* |
...
##### `region_input`<sup>Optional</sup> <a name="region_input" id="@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociation.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.mainRouteTableAssociation.MainRouteTableAssociationConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.12.0/docs/resources/main_route_table_association#id MainRouteTableAssociation#id}. |
