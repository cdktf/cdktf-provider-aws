...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawscustomergateway"
...
&dataawscustomergateway.DataAwsCustomerGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsCustomerGateway.DataAwsCustomerGatewayTimeouts,
}
```
