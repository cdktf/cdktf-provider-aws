...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/dataawscecostcategory"
...
| <code><a href="#@cdktf/provider-aws.dataAwsCeCostCategory.DataAwsCeCostCategoryConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.21.0/docs/data-sources/ce_cost_category#tags DataAwsCeCostCategory#tags}. |
