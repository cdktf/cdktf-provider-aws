...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsinstances"
...
&dataawsinstances.DataAwsInstancesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsInstances.DataAwsInstancesTimeouts,
}
```
