...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsinstances"
...
&dataawsinstances.DataAwsInstancesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsInstances.DataAwsInstancesTimeouts,
}
```
