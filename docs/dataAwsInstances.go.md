...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/dataawsinstances"
...
&dataawsinstances.DataAwsInstancesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v18.dataAwsInstances.DataAwsInstancesTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsInstances.DataAwsInstancesConfig.property.instanceTags">InstanceTags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.0/docs/data-sources/instances#instance_tags DataAwsInstances#instance_tags}. |
