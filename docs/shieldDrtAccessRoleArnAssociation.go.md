...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/shielddrtaccessrolearnassociation"
...
&shielddrtaccessrolearnassociation.ShieldDrtAccessRoleArnAssociationConfig {
	...
	RoleArn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.shieldDrtAccessRoleArnAssociation.ShieldDrtAccessRoleArnAssociationTimeouts,
}
```
