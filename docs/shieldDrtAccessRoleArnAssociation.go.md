...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/shielddrtaccessrolearnassociation"
...
&shielddrtaccessrolearnassociation.ShieldDrtAccessRoleArnAssociationConfig {
	...
	RoleArn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.shieldDrtAccessRoleArnAssociation.ShieldDrtAccessRoleArnAssociationTimeouts,
}
```
