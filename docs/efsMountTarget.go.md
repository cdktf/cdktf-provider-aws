...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/efsmounttarget"
...
&efsmounttarget.EfsMountTargetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.efsMountTarget.EfsMountTargetTimeouts,
}
```
