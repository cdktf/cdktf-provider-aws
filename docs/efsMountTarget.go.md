...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/efsmounttarget"
...
&efsmounttarget.EfsMountTargetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.efsMountTarget.EfsMountTargetTimeouts,
}
```
