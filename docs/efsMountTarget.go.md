...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/efsmounttarget"
...
&efsmounttarget.EfsMountTargetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.efsMountTarget.EfsMountTargetTimeouts,
}
```
