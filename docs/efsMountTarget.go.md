...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/efsmounttarget"
...
&efsmounttarget.EfsMountTargetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.efsMountTarget.EfsMountTargetTimeouts,
}
```
