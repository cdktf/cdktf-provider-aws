...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/efsmounttarget"
...
&efsmounttarget.EfsMountTargetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.efsMountTarget.EfsMountTargetTimeouts,
}
```
