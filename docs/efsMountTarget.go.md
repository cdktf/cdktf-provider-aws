...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/efsmounttarget"
...
| <code><a href="#@cdktf/provider-aws.efsMountTarget.EfsMountTarget.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&efsmounttarget.EfsMountTargetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.efsMountTarget.EfsMountTargetTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.efsMountTarget.EfsMountTargetConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
