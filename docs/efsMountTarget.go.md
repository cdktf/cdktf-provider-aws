...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/efsmounttarget"
...
&efsmounttarget.EfsMountTargetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.efsMountTarget.EfsMountTargetTimeouts,
}
```
