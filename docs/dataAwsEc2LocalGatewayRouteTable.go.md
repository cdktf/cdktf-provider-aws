...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2localgatewayroutetable"
...
&dataawsec2localgatewayroutetable.DataAwsEc2LocalGatewayRouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2LocalGatewayRouteTable.DataAwsEc2LocalGatewayRouteTableTimeouts,
}
```
