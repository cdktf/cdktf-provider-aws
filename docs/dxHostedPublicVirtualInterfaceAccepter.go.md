...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dxhostedpublicvirtualinterfaceaccepter"
...
&dxhostedpublicvirtualinterfaceaccepter.DxHostedPublicVirtualInterfaceAccepterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dxHostedPublicVirtualInterfaceAccepter.DxHostedPublicVirtualInterfaceAccepterTimeouts,
}
```
