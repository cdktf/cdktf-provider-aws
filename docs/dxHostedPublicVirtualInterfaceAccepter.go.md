...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dxhostedpublicvirtualinterfaceaccepter"
...
&dxhostedpublicvirtualinterfaceaccepter.DxHostedPublicVirtualInterfaceAccepterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dxHostedPublicVirtualInterfaceAccepter.DxHostedPublicVirtualInterfaceAccepterTimeouts,
}
```
