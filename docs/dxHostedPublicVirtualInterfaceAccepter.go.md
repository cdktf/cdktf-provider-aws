...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/dxhostedpublicvirtualinterfaceaccepter"
...
&dxhostedpublicvirtualinterfaceaccepter.DxHostedPublicVirtualInterfaceAccepterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v18.dxHostedPublicVirtualInterfaceAccepter.DxHostedPublicVirtualInterfaceAccepterTimeouts,
}
```
