...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dbclustersnapshot"
...
&dbclustersnapshot.DbClusterSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dbClusterSnapshot.DbClusterSnapshotTimeouts,
}
```
