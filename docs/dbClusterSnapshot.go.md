...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dbclustersnapshot"
...
&dbclustersnapshot.DbClusterSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dbClusterSnapshot.DbClusterSnapshotTimeouts,
}
```
