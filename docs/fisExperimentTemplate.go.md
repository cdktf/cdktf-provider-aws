...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/fisexperimenttemplate"
...
&fisexperimenttemplate.FisExperimentTemplateAction {
	...
	Parameter: interface{},
	StartAfter: *[]*string,
	Target: github.com/cdktf/cdktf-provider-aws-go/aws/v13.fisExperimentTemplate.FisExperimentTemplateActionTarget,
}
```
...
&fisexperimenttemplate.FisExperimentTemplateConfig {
	...
	Target: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.fisExperimentTemplate.FisExperimentTemplateTimeouts,
}
```
