...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/evidentlylaunch"
...
&evidentlylaunch.EvidentlyLaunchConfig {
	...
	ScheduledSplitsConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.evidentlyLaunch.EvidentlyLaunchScheduledSplitsConfig,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.evidentlyLaunch.EvidentlyLaunchTimeouts,
}
```
...
&evidentlylaunch.EvidentlyLaunchMetricMonitors {
	MetricDefinition: github.com/cdktf/cdktf-provider-aws-go/aws/v13.evidentlyLaunch.EvidentlyLaunchMetricMonitorsMetricDefinition,
}
```
