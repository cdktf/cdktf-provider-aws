...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/redshiftclusteriamroles"
...
&redshiftclusteriamroles.RedshiftClusterIamRolesConfig {
	...
	IamRoleArns: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.redshiftClusterIamRoles.RedshiftClusterIamRolesTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.redshiftClusterIamRoles.RedshiftClusterIamRolesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/redshift_cluster_iam_roles#id RedshiftClusterIamRoles#id}. |
