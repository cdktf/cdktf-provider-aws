...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/quicksightvpcconnection"
...
&quicksightvpcconnection.QuicksightVpcConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.quicksightVpcConnection.QuicksightVpcConnectionTimeouts,
}
```
