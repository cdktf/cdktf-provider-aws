...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/quicksightvpcconnection"
...
&quicksightvpcconnection.QuicksightVpcConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.quicksightVpcConnection.QuicksightVpcConnectionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.quicksightVpcConnection.QuicksightVpcConnectionConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.52.0/docs/resources/quicksight_vpc_connection#tags QuicksightVpcConnection#tags}. |
