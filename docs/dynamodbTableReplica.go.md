...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dynamodbtablereplica"
...
&dynamodbtablereplica.DynamodbTableReplicaAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.dynamodbTableReplica.DynamodbTableReplicaTimeouts,
}
```
