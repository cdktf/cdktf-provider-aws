...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dynamodbtablereplica"
...
&dynamodbtablereplica.DynamodbTableReplicaAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dynamodbTableReplica.DynamodbTableReplicaTimeouts,
}
```
