...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dynamodbtablereplica"
...
&dynamodbtablereplica.DynamodbTableReplicaAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dynamodbTableReplica.DynamodbTableReplicaTimeouts,
}
```
