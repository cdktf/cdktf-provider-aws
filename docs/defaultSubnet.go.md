...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/defaultsubnet"
...
&defaultsubnet.DefaultSubnetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.defaultSubnet.DefaultSubnetTimeouts,
}
```
