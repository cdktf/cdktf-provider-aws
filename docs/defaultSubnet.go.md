...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/defaultsubnet"
...
&defaultsubnet.DefaultSubnetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.defaultSubnet.DefaultSubnetTimeouts,
}
```
