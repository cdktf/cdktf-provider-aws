...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/quicksightaccountsubscription"
...
&quicksightaccountsubscription.QuicksightAccountSubscriptionConfig {
	...
	ReaderGroup: *[]*string,
	Realm: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.quicksightAccountSubscription.QuicksightAccountSubscriptionTimeouts,
}
```
