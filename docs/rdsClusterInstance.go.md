...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/rdsclusterinstance"
...
&rdsclusterinstance.RdsClusterInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.rdsClusterInstance.RdsClusterInstanceTimeouts,
}
```
