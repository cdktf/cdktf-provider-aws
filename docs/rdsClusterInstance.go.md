...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/rdsclusterinstance"
...
&rdsclusterinstance.RdsClusterInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.rdsClusterInstance.RdsClusterInstanceTimeouts,
}
```
