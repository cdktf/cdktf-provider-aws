...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/pinpointsmschannel"
...
| <code><a href="#@cdktf/provider-aws.pinpointSmsChannel.PinpointSmsChannelConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/pinpoint_sms_channel#enabled PinpointSmsChannel#enabled}. |
