...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/inspectorresourcegroup"
...
| <code><a href="#@cdktf/provider-aws.inspectorResourceGroup.InspectorResourceGroupConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.23.1/docs/resources/inspector_resource_group#tags InspectorResourceGroup#tags}. |
