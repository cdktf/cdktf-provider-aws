...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsroutetable"
...
&dataawsroutetable.DataAwsRouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.dataAwsRouteTable.DataAwsRouteTableTimeouts,
	VpcId: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsRouteTable.DataAwsRouteTableConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/data-sources/route_table#tags DataAwsRouteTable#tags}. |
