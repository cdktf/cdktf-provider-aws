...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsroutetable"
...
&dataawsroutetable.DataAwsRouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsRouteTable.DataAwsRouteTableTimeouts,
	VpcId: *string,
}
```
