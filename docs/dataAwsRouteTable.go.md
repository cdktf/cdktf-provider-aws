...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsroutetable"
...
&dataawsroutetable.DataAwsRouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsRouteTable.DataAwsRouteTableTimeouts,
	VpcId: *string,
}
```
