...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/s3bucketlogging"
...
&s3bucketlogging.S3BucketLoggingTargetGrant {
	Grantee: github.com/cdktf/cdktf-provider-aws-go/aws/v17.s3BucketLogging.S3BucketLoggingTargetGrantGrantee,
	Permission: *string,
}
```
