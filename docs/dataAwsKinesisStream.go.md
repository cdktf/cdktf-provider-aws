...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawskinesisstream"
...
| <code><a href="#@cdktf/provider-aws.dataAwsKinesisStream.DataAwsKinesisStreamConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.97.0/docs/data-sources/kinesis_stream#tags DataAwsKinesisStream#tags}. |
