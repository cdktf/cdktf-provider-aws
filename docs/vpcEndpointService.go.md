...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/vpcendpointservice"
...
&vpcendpointservice.VpcEndpointServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.vpcEndpointService.VpcEndpointServiceTimeouts,
}
```
