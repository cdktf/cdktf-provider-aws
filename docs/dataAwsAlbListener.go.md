...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsalblistener"
...
&dataawsalblistener.DataAwsAlbListenerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsAlbListener.DataAwsAlbListenerTimeouts,
}
```
