...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsalblistener"
...
&dataawsalblistener.DataAwsAlbListenerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsAlbListener.DataAwsAlbListenerTimeouts,
}
```
