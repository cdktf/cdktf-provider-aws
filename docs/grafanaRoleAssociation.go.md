...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/grafanaroleassociation"
...
&grafanaroleassociation.GrafanaRoleAssociationConfig {
	...
	GroupIds: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.grafanaRoleAssociation.GrafanaRoleAssociationTimeouts,
	UserIds: *[]*string,
}
```
