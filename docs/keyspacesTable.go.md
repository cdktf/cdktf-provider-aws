...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/keyspacestable"
...
```go
func PutClientSideTimestamps(value KeyspacesTableClientSideTimestamps)
```
...
```go
func ResetClientSideTimestamps()
```
...
keyspacestable.KeyspacesTable_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| <code><a href="#@cdktf/provider-aws.keyspacesTable.KeyspacesTable.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func ClientSideTimestamps() KeyspacesTableClientSideTimestampsOutputReference
```
...
```go
func ClientSideTimestampsInput() KeyspacesTableClientSideTimestamps
```
...
| <code><a href="#@cdktf/provider-aws.keyspacesTable.KeyspacesTableCapacitySpecification.property.writeCapacityUnits">WriteCapacityUnits</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/keyspaces_table#write_capacity_units KeyspacesTable#write_capacity_units}. |
...
&keyspacestable.KeyspacesTableConfig {
	...
	KeyspaceName: *string,
	SchemaDefinition: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTableSchemaDefinition,
	TableName: *string,
	CapacitySpecification: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTableCapacitySpecification,
	ClientSideTimestamps: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTableClientSideTimestamps,
	Comment: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTableComment,
	DefaultTimeToLive: *f64,
	EncryptionSpecification: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTableEncryptionSpecification,
	Id: *string,
	PointInTimeRecovery: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTablePointInTimeRecovery,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTableTimeouts,
	Ttl: github.com/cdktf/cdktf-provider-aws-go/aws/v20.keyspacesTable.KeyspacesTableTtl,
}
```
...
| <code><a href="#@cdktf/provider-aws.keyspacesTable.KeyspacesTableConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.keyspacesTable.KeyspacesTableConfig.property.defaultTimeToLive">DefaultTimeToLive</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/keyspaces_table#default_time_to_live KeyspacesTable#default_time_to_live}. |
...
| <code><a href="#@cdktf/provider-aws.keyspacesTable.KeyspacesTableConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/keyspaces_table#tags KeyspacesTable#tags}. |
| <code><a href="#@cdktf/provider-aws.keyspacesTable.KeyspacesTableConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/keyspaces_table#tags_all KeyspacesTable#tags_all}. |
...
keyspacestable.NewKeyspacesTableClientSideTimestampsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) KeyspacesTableClientSideTimestampsOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.keyspacesTable.KeyspacesTableClientSideTimestampsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IInterpolatingParent</code> | The parent resource. |
...
```go
func InternalValue() KeyspacesTableClientSideTimestamps
```
