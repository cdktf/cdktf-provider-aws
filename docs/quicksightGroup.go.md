...
Refer to the Terraform Registory for docs: [`aws_quicksight_group`](https://www.terraform.io/docs/providers/aws/r/quicksight_group).
...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/quicksightgroup"
