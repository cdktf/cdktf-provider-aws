...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/docdbclusterinstance"
...
&docdbclusterinstance.DocdbClusterInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.docdbClusterInstance.DocdbClusterInstanceTimeouts,
}
```
