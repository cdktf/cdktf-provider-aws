...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/docdbclusterinstance"
...
&docdbclusterinstance.DocdbClusterInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.docdbClusterInstance.DocdbClusterInstanceTimeouts,
}
```
