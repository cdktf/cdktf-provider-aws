...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/docdbclusterinstance"
...
&docdbclusterinstance.DocdbClusterInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.docdbClusterInstance.DocdbClusterInstanceTimeouts,
}
```
