...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/internetgateway"
...
&internetgateway.InternetGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.internetGateway.InternetGatewayTimeouts,
	VpcId: *string,
}
```
