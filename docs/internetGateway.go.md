...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/internetgateway"
...
&internetgateway.InternetGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.internetGateway.InternetGatewayTimeouts,
	VpcId: *string,
}
```
