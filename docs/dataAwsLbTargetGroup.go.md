...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawslbtargetgroup"
...
&dataawslbtargetgroup.DataAwsLbTargetGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsLbTargetGroup.DataAwsLbTargetGroupTimeouts,
}
```
