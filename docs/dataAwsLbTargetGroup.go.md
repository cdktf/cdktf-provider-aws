...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawslbtargetgroup"
...
&dataawslbtargetgroup.DataAwsLbTargetGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsLbTargetGroup.DataAwsLbTargetGroupTimeouts,
}
```
