...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawslbtargetgroup"
...
&dataawslbtargetgroup.DataAwsLbTargetGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsLbTargetGroup.DataAwsLbTargetGroupTimeouts,
}
```
