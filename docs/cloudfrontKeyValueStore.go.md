...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/cloudfrontkeyvaluestore"
...
&cloudfrontkeyvaluestore.CloudfrontKeyValueStoreConfig {
	...
	Name: *string,
	Comment: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.cloudfrontKeyValueStore.CloudfrontKeyValueStoreTimeouts,
}
```
