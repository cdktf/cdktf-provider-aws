...
Refer to the Terraform Registory for docs: [`aws_lightsail_lb`](https://www.terraform.io/docs/providers/aws/r/lightsail_lb).
...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/lightsaillb"
