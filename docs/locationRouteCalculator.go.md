...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/locationroutecalculator"
...
&locationroutecalculator.LocationRouteCalculatorConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.locationRouteCalculator.LocationRouteCalculatorTimeouts,
}
```
