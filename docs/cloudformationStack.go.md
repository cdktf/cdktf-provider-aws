...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/cloudformationstack"
...
&cloudformationstack.CloudformationStackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.cloudformationStack.CloudformationStackTimeouts,
}
```
