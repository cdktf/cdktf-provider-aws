...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/cloudformationstack"
...
&cloudformationstack.CloudformationStackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.cloudformationStack.CloudformationStackTimeouts,
}
```
