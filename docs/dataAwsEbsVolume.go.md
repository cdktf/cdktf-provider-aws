...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsebsvolume"
...
&dataawsebsvolume.DataAwsEbsVolumeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsEbsVolume.DataAwsEbsVolumeTimeouts,
}
```
