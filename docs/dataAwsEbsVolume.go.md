...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsebsvolume"
...
&dataawsebsvolume.DataAwsEbsVolumeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEbsVolume.DataAwsEbsVolumeTimeouts,
}
```
