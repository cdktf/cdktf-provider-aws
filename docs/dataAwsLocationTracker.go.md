...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawslocationtracker"
...
| <code><a href="#@cdktf/provider-aws.dataAwsLocationTracker.DataAwsLocationTrackerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.16.0/docs/data-sources/location_tracker#tags DataAwsLocationTracker#tags}. |
