...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/apigatewayintegration"
...
&apigatewayintegration.ApiGatewayIntegrationConfig {
	...
	TlsConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.apiGatewayIntegration.ApiGatewayIntegrationTlsConfig,
	Uri: *string,
}
```
