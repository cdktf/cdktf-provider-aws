...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsqldbledger"
...
| <code><a href="#@cdktf/provider-aws.dataAwsQldbLedger.DataAwsQldbLedgerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.82.1/docs/data-sources/qldb_ledger#tags DataAwsQldbLedger#tags}. |
