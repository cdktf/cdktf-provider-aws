...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/apprunnerdeployment"
...
&apprunnerdeployment.ApprunnerDeploymentConfig {
	...
	ServiceArn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.apprunnerDeployment.ApprunnerDeploymentTimeouts,
}
```
