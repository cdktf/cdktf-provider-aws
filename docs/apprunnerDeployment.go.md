...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/apprunnerdeployment"
...
&apprunnerdeployment.ApprunnerDeploymentConfig {
	...
	ServiceArn: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.apprunnerDeployment.ApprunnerDeploymentTimeouts,
}
```
