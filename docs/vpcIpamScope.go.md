...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/vpcipamscope"
...
&vpcipamscope.VpcIpamScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.vpcIpamScope.VpcIpamScopeTimeouts,
}
```
