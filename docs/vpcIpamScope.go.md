...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/vpcipamscope"
...
| <code><a href="#@cdktf/provider-aws.vpcIpamScope.VpcIpamScope.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&vpcipamscope.VpcIpamScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.vpcIpamScope.VpcIpamScopeTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.vpcIpamScope.VpcIpamScopeConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpamScope.VpcIpamScopeConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_ipam_scope#tags VpcIpamScope#tags}. |
| <code><a href="#@cdktf/provider-aws.vpcIpamScope.VpcIpamScopeConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/aws/r/vpc_ipam_scope#tags_all VpcIpamScope#tags_all}. |
