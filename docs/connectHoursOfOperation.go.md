...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/connecthoursofoperation"
...
&connecthoursofoperation.ConnectHoursOfOperationConfigA {
	Day: *string,
	EndTime: github.com/cdktf/cdktf-provider-aws-go/aws/v12.connectHoursOfOperation.ConnectHoursOfOperationConfigEndTime,
	StartTime: github.com/cdktf/cdktf-provider-aws-go/aws/v12.connectHoursOfOperation.ConnectHoursOfOperationConfigStartTime,
}
```
