...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/connecthoursofoperation"
...
&connecthoursofoperation.ConnectHoursOfOperationConfigA {
	Day: *string,
	EndTime: github.com/cdktf/cdktf-provider-aws-go/aws/v13.connectHoursOfOperation.ConnectHoursOfOperationConfigEndTime,
	StartTime: github.com/cdktf/cdktf-provider-aws-go/aws/v13.connectHoursOfOperation.ConnectHoursOfOperationConfigStartTime,
}
```
