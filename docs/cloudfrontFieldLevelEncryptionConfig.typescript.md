...
Refer to the Terraform Registory for docs: [`aws_cloudfront_field_level_encryption_config`](https://registry.terraform.io/providers/hashicorp/aws/5.5.0/docs/resources/cloudfront_field_level_encryption_config).
