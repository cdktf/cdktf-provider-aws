...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/rdsinstancestate"
...
&rdsinstancestate.RdsInstanceStateConfig {
	...
	Identifier: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.rdsInstanceState.RdsInstanceStateTimeouts,
}
```
