...
```typescript
import { workspaceswebNetworkSettingsAssociation } from '@cdktf/provider-aws'

new workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation(scope: Construct, id: string, config: WorkspaceswebNetworkSettingsAssociationConfig)
```
...
workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.isConstruct(x: any)
```
...
workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.isTerraformElement(x: any)
```
...
workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.isTerraformResource(x: any)
```
...
workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociation.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
const workspaceswebNetworkSettingsAssociationConfig: workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociationConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociationConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociationConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociationConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociationConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.workspaceswebNetworkSettingsAssociation.WorkspaceswebNetworkSettingsAssociationConfig.property.networkSettingsArn">networkSettingsArn</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/workspacesweb_network_settings_association#network_settings_arn WorkspaceswebNetworkSettingsAssociation#network_settings_arn}. |
