...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/sagemakermodel"
...
&sagemakermodel.SagemakerModelConfig {
	...
	Id: *string,
	InferenceExecutionConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v16.sagemakerModel.SagemakerModelInferenceExecutionConfig,
	Name: *string,
	PrimaryContainer: github.com/cdktf/cdktf-provider-aws-go/aws/v16.sagemakerModel.SagemakerModelPrimaryContainer,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	VpcConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v16.sagemakerModel.SagemakerModelVpcConfig,
}
```
...
| <code><a href="#@cdktf/provider-aws.sagemakerModel.SagemakerModelConfig.property.enableNetworkIsolation">EnableNetworkIsolation</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/resources/sagemaker_model#enable_network_isolation SagemakerModel#enable_network_isolation}. |
...
| <code><a href="#@cdktf/provider-aws.sagemakerModel.SagemakerModelConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/resources/sagemaker_model#tags SagemakerModel#tags}. |
| <code><a href="#@cdktf/provider-aws.sagemakerModel.SagemakerModelConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/resources/sagemaker_model#tags_all SagemakerModel#tags_all}. |
...
&sagemakermodel.SagemakerModelContainer {
	...
	Image: *string,
	ImageConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v16.sagemakerModel.SagemakerModelContainerImageConfig,
	Mode: *string,
	ModelDataUrl: *string,
...
| <code><a href="#@cdktf/provider-aws.sagemakerModel.SagemakerModelContainer.property.environment">Environment</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/resources/sagemaker_model#environment SagemakerModel#environment}. |
...
&sagemakermodel.SagemakerModelContainerImageConfig {
	...
	RepositoryAuthConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v16.sagemakerModel.SagemakerModelContainerImageConfigRepositoryAuthConfig,
}
```
...
&sagemakermodel.SagemakerModelPrimaryContainer {
	...
	Environment: *map[string]*string,
	Image: *string,
	ImageConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v16.sagemakerModel.SagemakerModelPrimaryContainerImageConfig,
	Mode: *string,
	ModelDataUrl: *string,
	ModelPackageName: *string,
}
...
| <code><a href="#@cdktf/provider-aws.sagemakerModel.SagemakerModelPrimaryContainer.property.environment">Environment</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/resources/sagemaker_model#environment SagemakerModel#environment}. |
...
&sagemakermodel.SagemakerModelPrimaryContainerImageConfig {
	RepositoryAccessMode: *string,
	RepositoryAuthConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v16.sagemakerModel.SagemakerModelPrimaryContainerImageConfigRepositoryAuthConfig,
}
```
