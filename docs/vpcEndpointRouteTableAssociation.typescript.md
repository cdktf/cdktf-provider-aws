...
Refer to the Terraform Registory for docs: [`aws_vpc_endpoint_route_table_association`](https://www.terraform.io/docs/providers/aws/r/vpc_endpoint_route_table_association).
