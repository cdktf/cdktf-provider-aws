...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsservicecatalogproduct"
...
&dataawsservicecatalogproduct.DataAwsServicecatalogProductConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsServicecatalogProduct.DataAwsServicecatalogProductTimeouts,
}
```
