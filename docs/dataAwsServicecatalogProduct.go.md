...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsservicecatalogproduct"
...
&dataawsservicecatalogproduct.DataAwsServicecatalogProductConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsServicecatalogProduct.DataAwsServicecatalogProductTimeouts,
}
```
