...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/connectvocabulary"
...
&connectvocabulary.ConnectVocabularyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.connectVocabulary.ConnectVocabularyTimeouts,
}
```
