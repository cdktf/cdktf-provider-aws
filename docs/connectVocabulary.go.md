...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/connectvocabulary"
...
&connectvocabulary.ConnectVocabularyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.connectVocabulary.ConnectVocabularyTimeouts,
}
```
