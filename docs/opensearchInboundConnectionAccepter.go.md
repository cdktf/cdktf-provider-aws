...
Refer to the Terraform Registory for docs: [`aws_opensearch_inbound_connection_accepter`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/resources/opensearch_inbound_connection_accepter).
