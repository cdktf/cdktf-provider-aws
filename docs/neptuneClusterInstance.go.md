...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/neptuneclusterinstance"
...
&neptuneclusterinstance.NeptuneClusterInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.neptuneClusterInstance.NeptuneClusterInstanceTimeouts,
}
```
