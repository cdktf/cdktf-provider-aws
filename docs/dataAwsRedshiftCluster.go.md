...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawsredshiftcluster"
...
| <code><a href="#@cdktf/provider-aws.dataAwsRedshiftCluster.DataAwsRedshiftClusterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/redshift_cluster#tags DataAwsRedshiftCluster#tags}. |
