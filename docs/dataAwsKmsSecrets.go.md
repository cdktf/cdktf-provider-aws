...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dataawskmssecrets"
...
| <code><a href="#@cdktf/provider-aws.dataAwsKmsSecrets.DataAwsKmsSecretsSecret.property.context">Context</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.10.0/docs/data-sources/kms_secrets#context DataAwsKmsSecrets#context}. |
