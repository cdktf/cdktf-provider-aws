...
Refer to the Terraform Registory for docs: [`aws_ssoadmin_permissions_boundary_attachment`](https://registry.terraform.io/providers/hashicorp/aws/5.9.0/docs/resources/ssoadmin_permissions_boundary_attachment).
