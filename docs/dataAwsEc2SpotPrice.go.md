...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsec2spotprice"
...
| <code><a href="#@cdktf/provider-aws.dataAwsEc2SpotPrice.DataAwsEc2SpotPrice.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataawsec2spotprice.DataAwsEc2SpotPriceConfig {
	...
	Id: *string,
	InstanceType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsEc2SpotPrice.DataAwsEc2SpotPriceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsEc2SpotPrice.DataAwsEc2SpotPriceConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
