...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsvpcdhcpoptions"
...
&dataawsvpcdhcpoptions.DataAwsVpcDhcpOptionsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsVpcDhcpOptions.DataAwsVpcDhcpOptionsTimeouts,
}
```
