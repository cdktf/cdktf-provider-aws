...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsvpcdhcpoptions"
...
&dataawsvpcdhcpoptions.DataAwsVpcDhcpOptionsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsVpcDhcpOptions.DataAwsVpcDhcpOptionsTimeouts,
}
```
