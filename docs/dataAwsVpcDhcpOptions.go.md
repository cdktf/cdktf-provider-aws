...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsvpcdhcpoptions"
...
&dataawsvpcdhcpoptions.DataAwsVpcDhcpOptionsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsVpcDhcpOptions.DataAwsVpcDhcpOptionsTimeouts,
}
```
