...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsvpcpeeringconnections"
...
&dataawsvpcpeeringconnections.DataAwsVpcPeeringConnectionsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsVpcPeeringConnections.DataAwsVpcPeeringConnectionsTimeouts,
}
```
