...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/inspector2enabler"
...
inspector2enabler.Inspector2Enabler_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| <code><a href="#@cdktf/provider-aws.inspector2Enabler.Inspector2Enabler.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&inspector2enabler.Inspector2EnablerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.inspector2Enabler.Inspector2EnablerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.inspector2Enabler.Inspector2EnablerConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
