...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/datazoneformtype"
...
&datazoneformtype.DatazoneFormTypeConfig {
	...
	Model: interface{},
	Status: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.datazoneFormType.DatazoneFormTypeTimeouts,
}
```
