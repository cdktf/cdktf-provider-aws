...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/ssmresourcedatasync"
...
&ssmresourcedatasync.SsmResourceDataSyncConfig {
	...
	Name: *string,
	S3Destination: github.com/cdktf/cdktf-provider-aws-go/aws/v17.ssmResourceDataSync.SsmResourceDataSyncS3Destination,
	Id: *string,
}
```
