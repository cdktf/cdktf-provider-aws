...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/ssmresourcedatasync"
...
| <code><a href="#@cdktf/provider-aws.ssmResourceDataSync.SsmResourceDataSync.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&ssmresourcedatasync.SsmResourceDataSyncConfig {
	...
	Name: *string,
	S3Destination: github.com/cdktf/cdktf-provider-aws-go/aws/v21.ssmResourceDataSync.SsmResourceDataSyncS3Destination,
	Id: *string,
	Region: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.ssmResourceDataSync.SsmResourceDataSyncConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
