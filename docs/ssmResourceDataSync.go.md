...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/ssmresourcedatasync"
...
&ssmresourcedatasync.SsmResourceDataSyncConfig {
	...
	Name: *string,
	S3Destination: github.com/cdktf/cdktf-provider-aws-go/aws/v16.ssmResourceDataSync.SsmResourceDataSyncS3Destination,
	Id: *string,
}
```
