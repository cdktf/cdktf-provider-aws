...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/ssmresourcedatasync"
...
&ssmresourcedatasync.SsmResourceDataSyncConfig {
	...
	Name: *string,
	S3Destination: github.com/cdktf/cdktf-provider-aws-go/aws/v15.ssmResourceDataSync.SsmResourceDataSyncS3Destination,
	Id: *string,
}
```
