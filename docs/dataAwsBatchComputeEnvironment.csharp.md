...
Refer to the Terraform Registory for docs: [`data_aws_batch_compute_environment`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/batch_compute_environment).
