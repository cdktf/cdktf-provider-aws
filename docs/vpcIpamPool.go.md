...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/vpcipampool"
...
&vpcipampool.VpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.vpcIpamPool.VpcIpamPoolTimeouts,
}
```
