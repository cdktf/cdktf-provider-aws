...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/vpcipampool"
...
&vpcipampool.VpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.vpcIpamPool.VpcIpamPoolTimeouts,
}
```
