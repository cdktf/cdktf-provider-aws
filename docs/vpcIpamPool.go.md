...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/vpcipampool"
...
&vpcipampool.VpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.vpcIpamPool.VpcIpamPoolTimeouts,
}
```
