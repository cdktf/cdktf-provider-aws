...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawskeypair"
...
&dataawskeypair.DataAwsKeyPairConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsKeyPair.DataAwsKeyPairTimeouts,
}
```
