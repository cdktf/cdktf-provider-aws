...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawskeypair"
...
&dataawskeypair.DataAwsKeyPairConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsKeyPair.DataAwsKeyPairTimeouts,
}
```
