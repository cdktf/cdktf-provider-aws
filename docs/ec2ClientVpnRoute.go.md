...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/ec2clientvpnroute"
...
&ec2clientvpnroute.Ec2ClientVpnRouteConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.ec2ClientVpnRoute.Ec2ClientVpnRouteTimeouts,
}
```
