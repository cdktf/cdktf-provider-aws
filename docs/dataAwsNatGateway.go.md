...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsnatgateway"
...
&dataawsnatgateway.DataAwsNatGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.dataAwsNatGateway.DataAwsNatGatewayTimeouts,
	VpcId: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsNatGateway.DataAwsNatGatewayConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.35.0/docs/data-sources/nat_gateway#tags DataAwsNatGateway#tags}. |
