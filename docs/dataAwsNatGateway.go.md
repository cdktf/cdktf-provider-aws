...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsnatgateway"
...
&dataawsnatgateway.DataAwsNatGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsNatGateway.DataAwsNatGatewayTimeouts,
	VpcId: *string,
}
```
