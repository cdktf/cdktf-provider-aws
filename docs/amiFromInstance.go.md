...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/amifrominstance"
...
&amifrominstance.AmiFromInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.amiFromInstance.AmiFromInstanceTimeouts,
}
```
