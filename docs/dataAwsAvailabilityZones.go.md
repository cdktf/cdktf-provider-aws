...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsavailabilityzones"
...
&dataawsavailabilityzones.DataAwsAvailabilityZonesConfig {
	...
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsAvailabilityZones.DataAwsAvailabilityZonesTimeouts,
}
```
