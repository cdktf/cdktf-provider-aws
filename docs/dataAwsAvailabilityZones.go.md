...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsavailabilityzones"
...
&dataawsavailabilityzones.DataAwsAvailabilityZonesConfig {
	...
	Id: *string,
	State: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsAvailabilityZones.DataAwsAvailabilityZonesTimeouts,
}
```
