...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsroute"
...
&dataawsroute.DataAwsRouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsRoute.DataAwsRouteTimeouts,
