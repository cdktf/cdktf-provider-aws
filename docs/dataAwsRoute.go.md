...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawsroute"
...
&dataawsroute.DataAwsRouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsRoute.DataAwsRouteTimeouts,
