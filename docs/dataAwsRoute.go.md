...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsroute"
...
&dataawsroute.DataAwsRouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsRoute.DataAwsRouteTimeouts,
