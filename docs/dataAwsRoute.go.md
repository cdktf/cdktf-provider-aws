...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawsroute"
...
&dataawsroute.DataAwsRouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.dataAwsRoute.DataAwsRouteTimeouts,
