...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/acmpca_policy aws_acmpca_policy}.

#### Initializers <a name="Initializers" id="@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicy.Initializer"></a>

```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/acmpcapolicy"
...
| <code><a href="#@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicy.resetRegion">ResetRegion</a></code> | *No description.* |
...
##### `ResetRegion` <a name="ResetRegion" id="@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicy.resetRegion"></a>
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/acmpca_policy#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicy.property.regionInput">RegionInput</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicy.property.region">Region</a></code> | <code>*string</code> | *No description.* |
...
##### `RegionInput`<sup>Optional</sup> <a name="RegionInput" id="@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicy.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicyConfig.property.policy">Policy</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/acmpca_policy#policy AcmpcaPolicy#policy}. |
| <code><a href="#@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicyConfig.property.resourceArn">ResourceArn</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/acmpca_policy#resource_arn AcmpcaPolicy#resource_arn}. |
| <code><a href="#@cdktf/provider-aws.acmpcaPolicy.AcmpcaPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/resources/acmpca_policy#id AcmpcaPolicy#id}. |
