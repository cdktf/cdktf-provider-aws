...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/rdsreservedinstance"
...
&rdsreservedinstance.RdsReservedInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.rdsReservedInstance.RdsReservedInstanceTimeouts,
}
```
