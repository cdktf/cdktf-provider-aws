...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/vpcendpointsubnetassociation"
...
&vpcendpointsubnetassociation.VpcEndpointSubnetAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.vpcEndpointSubnetAssociation.VpcEndpointSubnetAssociationTimeouts,
}
```
