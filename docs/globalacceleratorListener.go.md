...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/globalacceleratorlistener"
...
&globalacceleratorlistener.GlobalacceleratorListenerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.globalacceleratorListener.GlobalacceleratorListenerTimeouts,
}
```
