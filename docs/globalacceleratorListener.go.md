...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/globalacceleratorlistener"
...
&globalacceleratorlistener.GlobalacceleratorListenerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.globalacceleratorListener.GlobalacceleratorListenerTimeouts,
}
```
