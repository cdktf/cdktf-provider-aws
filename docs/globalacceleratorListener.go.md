...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/globalacceleratorlistener"
...
&globalacceleratorlistener.GlobalacceleratorListenerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.globalacceleratorListener.GlobalacceleratorListenerTimeouts,
}
```
