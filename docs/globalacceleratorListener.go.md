...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/globalacceleratorlistener"
...
&globalacceleratorlistener.GlobalacceleratorListenerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.globalacceleratorListener.GlobalacceleratorListenerTimeouts,
}
```
