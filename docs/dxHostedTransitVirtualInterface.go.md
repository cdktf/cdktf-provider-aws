...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dxhostedtransitvirtualinterface"
...
&dxhostedtransitvirtualinterface.DxHostedTransitVirtualInterfaceConfig {
	...
	Id: *string,
	Mtu: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dxHostedTransitVirtualInterface.DxHostedTransitVirtualInterfaceTimeouts,
}
```
