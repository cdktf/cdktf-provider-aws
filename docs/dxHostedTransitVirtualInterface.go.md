...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dxhostedtransitvirtualinterface"
...
&dxhostedtransitvirtualinterface.DxHostedTransitVirtualInterfaceConfig {
	...
	Id: *string,
	Mtu: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.dxHostedTransitVirtualInterface.DxHostedTransitVirtualInterfaceTimeouts,
}
```
