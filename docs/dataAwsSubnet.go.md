...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawssubnet"
...
&dataawssubnet.DataAwsSubnetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsSubnet.DataAwsSubnetTimeouts,
	VpcId: *string,
}
```
