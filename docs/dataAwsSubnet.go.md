...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dataawssubnet"
...
&dataawssubnet.DataAwsSubnetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dataAwsSubnet.DataAwsSubnetTimeouts,
	VpcId: *string,
}
```
