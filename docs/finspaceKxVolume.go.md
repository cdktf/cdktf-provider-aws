...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/finspacekxvolume"
...
&finspacekxvolume.FinspaceKxVolumeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.finspaceKxVolume.FinspaceKxVolumeTimeouts,
}
```
