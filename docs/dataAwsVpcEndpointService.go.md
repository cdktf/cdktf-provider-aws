...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsvpcendpointservice"
...
&dataawsvpcendpointservice.DataAwsVpcEndpointServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.dataAwsVpcEndpointService.DataAwsVpcEndpointServiceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsVpcEndpointService.DataAwsVpcEndpointServiceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.72.1/docs/data-sources/vpc_endpoint_service#tags DataAwsVpcEndpointService#tags}. |
