...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dataawsvpcendpointservice"
...
&dataawsvpcendpointservice.DataAwsVpcEndpointServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dataAwsVpcEndpointService.DataAwsVpcEndpointServiceTimeouts,
}
```
