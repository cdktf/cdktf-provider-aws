...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsvpcendpointservice"
...
&dataawsvpcendpointservice.DataAwsVpcEndpointServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsVpcEndpointService.DataAwsVpcEndpointServiceTimeouts,
}
```
