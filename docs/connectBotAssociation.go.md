...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/connectbotassociation"
...
&connectbotassociation.ConnectBotAssociationConfig {
	...
	InstanceId: *string,
	LexBot: github.com/cdktf/cdktf-provider-aws-go/aws/v12.connectBotAssociation.ConnectBotAssociationLexBot,
	Id: *string,
}
```
