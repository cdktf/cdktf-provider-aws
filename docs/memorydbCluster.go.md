...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/memorydbcluster"
...
&memorydbcluster.MemorydbClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.memorydbCluster.MemorydbClusterTimeouts,
