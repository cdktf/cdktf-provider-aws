...
```csharp
private void PutEmailMfaConfiguration(CognitoUserPoolEmailMfaConfiguration Value)
```
...
```csharp
private void PutSignInPolicy(CognitoUserPoolSignInPolicy Value)
```
...
```csharp
private void PutWebAuthnConfiguration(CognitoUserPoolWebAuthnConfiguration Value)
```
...
```csharp
private void ResetEmailMfaConfiguration()
```
...
```csharp
private void ResetSignInPolicy()
```
...
```csharp
private void ResetUserPoolTier()
```
...
```csharp
private void ResetWebAuthnConfiguration()
```
...
CognitoUserPool.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPool.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
```csharp
public CognitoUserPoolEmailMfaConfigurationOutputReference EmailMfaConfiguration { get; }
```
...
```csharp
public CognitoUserPoolSignInPolicyOutputReference SignInPolicy { get; }
```
...
```csharp
public CognitoUserPoolWebAuthnConfigurationOutputReference WebAuthnConfiguration { get; }
```
...
```csharp
public CognitoUserPoolEmailMfaConfiguration EmailMfaConfigurationInput { get; }
```
...
```csharp
public CognitoUserPoolSignInPolicy SignInPolicyInput { get; }
```
...
```csharp
public string UserPoolTierInput { get; }
```
...
```csharp
public CognitoUserPoolWebAuthnConfiguration WebAuthnConfigurationInput { get; }
```
...
```csharp
public string UserPoolTier { get; }
```
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolAccountRecoverySettingRecoveryMechanism.property.priority">Priority</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#priority CognitoUserPool#priority}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolAdminCreateUserConfig.property.allowAdminCreateUserOnly">AllowAdminCreateUserOnly</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#allow_admin_create_user_only CognitoUserPool#allow_admin_create_user_only}. |
...
new CognitoUserPoolConfig {
    ...
    CognitoUserPoolEmailMfaConfiguration EmailMfaConfiguration = null,
    ...
    object Schema = null,
    CognitoUserPoolSignInPolicy SignInPolicy = null,
    ...
    string UserPoolTier = null,
    CognitoUserPoolVerificationMessageTemplate VerificationMessageTemplate = null,
    CognitoUserPoolWebAuthnConfiguration WebAuthnConfiguration = null
};
```
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolConfig.property.tags">Tags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#tags CognitoUserPool#tags}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolConfig.property.tagsAll">TagsAll</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#tags_all CognitoUserPool#tags_all}. |
...
```csharp
public CognitoUserPoolEmailMfaConfiguration EmailMfaConfiguration { get; set; }
```
...
```csharp
public CognitoUserPoolSignInPolicy SignInPolicy { get; set; }
```
...
```csharp
public CognitoUserPoolWebAuthnConfiguration WebAuthnConfiguration { get; set; }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolDeviceConfiguration.property.challengeRequiredOnNewDevice">ChallengeRequiredOnNewDevice</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#challenge_required_on_new_device CognitoUserPool#challenge_required_on_new_device}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolDeviceConfiguration.property.deviceOnlyRememberedOnUserPrompt">DeviceOnlyRememberedOnUserPrompt</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#device_only_remembered_on_user_prompt CognitoUserPool#device_only_remembered_on_user_prompt}. |
...
new CognitoUserPoolEmailMfaConfiguration {
    string Message = null,
    string Subject = null
};
```
...
new CognitoUserPoolLambdaConfig {
    ...
    CognitoUserPoolLambdaConfigPreTokenGenerationConfig PreTokenGenerationConfig = null,
...
```csharp
public CognitoUserPoolLambdaConfigPreTokenGenerationConfig PreTokenGenerationConfig { get; set; }
```
...
new CognitoUserPoolLambdaConfigPreTokenGenerationConfig {
    string LambdaArn,
    string LambdaVersion
};
```
...
new CognitoUserPoolPasswordPolicy {
    ...
    double PasswordHistorySize = null,
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicy.property.minimumLength">MinimumLength</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#minimum_length CognitoUserPool#minimum_length}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicy.property.passwordHistorySize">PasswordHistorySize</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#password_history_size CognitoUserPool#password_history_size}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicy.property.requireLowercase">RequireLowercase</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#require_lowercase CognitoUserPool#require_lowercase}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicy.property.requireNumbers">RequireNumbers</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#require_numbers CognitoUserPool#require_numbers}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicy.property.requireSymbols">RequireSymbols</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#require_symbols CognitoUserPool#require_symbols}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicy.property.requireUppercase">RequireUppercase</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#require_uppercase CognitoUserPool#require_uppercase}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicy.property.temporaryPasswordValidityDays">TemporaryPasswordValidityDays</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#temporary_password_validity_days CognitoUserPool#temporary_password_validity_days}. |
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolSchema.property.developerOnlyAttribute">DeveloperOnlyAttribute</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#developer_only_attribute CognitoUserPool#developer_only_attribute}. |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolSchema.property.mutable">Mutable</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#mutable CognitoUserPool#mutable}. |
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolSchema.property.required">Required</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#required CognitoUserPool#required}. |
...
new CognitoUserPoolSignInPolicy {
    string[] AllowedFirstAuthFactors = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolSoftwareTokenMfaConfiguration.property.enabled">Enabled</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#enabled CognitoUserPool#enabled}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolUsernameConfiguration.property.caseSensitive">CaseSensitive</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/cognito_user_pool#case_sensitive CognitoUserPool#case_sensitive}. |
...
new CognitoUserPoolUserPoolAddOns {
    ...
    CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlows AdvancedSecurityAdditionalFlows = null
};
```
...
```csharp
public CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlows AdvancedSecurityAdditionalFlows { get; set; }
```
...
new CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlows {
    string CustomAuthMode = null
};
```
...
new CognitoUserPoolWebAuthnConfiguration {
...
new CognitoUserPoolEmailMfaConfigurationOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolEmailMfaConfigurationOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolEmailMfaConfigurationOutputReference.resolve.parameter._context"></a>
...
```csharp
public CognitoUserPoolEmailMfaConfiguration InternalValue { get; }
```
...
```csharp
private void PutPreTokenGenerationConfig(CognitoUserPoolLambdaConfigPreTokenGenerationConfig Value)
```
...
```csharp
public CognitoUserPoolLambdaConfigPreTokenGenerationConfigOutputReference PreTokenGenerationConfig { get; }
```
...
```csharp
public CognitoUserPoolLambdaConfigPreTokenGenerationConfig PreTokenGenerationConfigInput { get; }
```
...
new CognitoUserPoolLambdaConfigPreTokenGenerationConfigOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolLambdaConfigPreTokenGenerationConfigOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolLambdaConfigPreTokenGenerationConfigOutputReference.resolve.parameter._context"></a>
...
```csharp
public CognitoUserPoolLambdaConfigPreTokenGenerationConfig InternalValue { get; }
```
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicyOutputReference.property.passwordHistorySizeInput">PasswordHistorySizeInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolPasswordPolicyOutputReference.property.passwordHistorySize">PasswordHistorySize</a></code> | <code>double</code> | *No description.* |
...
```csharp
public double PasswordHistorySizeInput { get; }
```
...
```csharp
public double PasswordHistorySize { get; }
```
...
new CognitoUserPoolSignInPolicyOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolSignInPolicyOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolSignInPolicyOutputReference.resolve.parameter._context"></a>
...
```csharp
private void ResetAllowedFirstAuthFactors()
```
...
```csharp
public string[] AllowedFirstAuthFactorsInput { get; }
```
...
```csharp
public string[] AllowedFirstAuthFactors { get; }
```
...
```csharp
public CognitoUserPoolSignInPolicy InternalValue { get; }
```
...
new CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlowsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlowsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlowsOutputReference.resolve.parameter._context"></a>
...
```csharp
private void ResetCustomAuthMode()
```
...
```csharp
public string CustomAuthModeInput { get; }
```
...
```csharp
public string CustomAuthMode { get; }
```
...
```csharp
public CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlows InternalValue { get; }
```
...
```csharp
private void PutAdvancedSecurityAdditionalFlows(CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlows Value)
```
...
```csharp
private void ResetAdvancedSecurityAdditionalFlows()
```
...
```csharp
public CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlowsOutputReference AdvancedSecurityAdditionalFlows { get; }
```
...
```csharp
public CognitoUserPoolUserPoolAddOnsAdvancedSecurityAdditionalFlows AdvancedSecurityAdditionalFlowsInput { get; }
```
...
new CognitoUserPoolWebAuthnConfigurationOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolWebAuthnConfigurationOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-aws.cognitoUserPool.CognitoUserPoolWebAuthnConfigurationOutputReference.resolve.parameter._context"></a>
...
```csharp
private void ResetRelyingPartyId()
```
...
```csharp
private void ResetUserVerification()
```
...
```csharp
public string RelyingPartyIdInput { get; }
```
...
```csharp
public string UserVerificationInput { get; }
```
...
```csharp
public CognitoUserPoolWebAuthnConfiguration InternalValue { get; }
```
