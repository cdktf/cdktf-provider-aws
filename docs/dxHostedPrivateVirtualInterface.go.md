...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dxhostedprivatevirtualinterface"
...
&dxhostedprivatevirtualinterface.DxHostedPrivateVirtualInterfaceConfig {
	...
	Id: *string,
	Mtu: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterfaceTimeouts,
}
```
