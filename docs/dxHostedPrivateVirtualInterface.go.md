...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/dxhostedprivatevirtualinterface"
...
&dxhostedprivatevirtualinterface.DxHostedPrivateVirtualInterfaceConfig {
	...
	Id: *string,
	Mtu: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterfaceTimeouts,
}
```
