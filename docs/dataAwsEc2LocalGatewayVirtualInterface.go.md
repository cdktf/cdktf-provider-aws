...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dataawsec2localgatewayvirtualinterface"
...
&dataawsec2localgatewayvirtualinterface.DataAwsEc2LocalGatewayVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.dataAwsEc2LocalGatewayVirtualInterface.DataAwsEc2LocalGatewayVirtualInterfaceTimeouts,
}
```
