...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dmsreplicationsubnetgroup"
...
&dmsreplicationsubnetgroup.DmsReplicationSubnetGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dmsReplicationSubnetGroup.DmsReplicationSubnetGroupTimeouts,
}
```
