...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dmsreplicationsubnetgroup"
...
&dmsreplicationsubnetgroup.DmsReplicationSubnetGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dmsReplicationSubnetGroup.DmsReplicationSubnetGroupTimeouts,
}
```
