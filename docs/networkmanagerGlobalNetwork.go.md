...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/networkmanagerglobalnetwork"
...
&networkmanagerglobalnetwork.NetworkmanagerGlobalNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.networkmanagerGlobalNetwork.NetworkmanagerGlobalNetworkTimeouts,
}
```
