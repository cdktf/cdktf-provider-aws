...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/networkmanagerglobalnetwork"
...
&networkmanagerglobalnetwork.NetworkmanagerGlobalNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.networkmanagerGlobalNetwork.NetworkmanagerGlobalNetworkTimeouts,
}
```
