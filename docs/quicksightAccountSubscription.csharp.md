...
Refer to the Terraform Registory for docs: [`aws_quicksight_account_subscription`](https://registry.terraform.io/providers/hashicorp/aws/5.6.1/docs/resources/quicksight_account_subscription).
