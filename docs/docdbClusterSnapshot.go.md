...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/docdbclustersnapshot"
...
&docdbclustersnapshot.DocdbClusterSnapshotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.docdbClusterSnapshot.DocdbClusterSnapshotTimeouts,
}
```
