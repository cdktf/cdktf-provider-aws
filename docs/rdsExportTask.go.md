...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/rdsexporttask"
...
&rdsexporttask.RdsExportTaskConfig {
	...
	ExportOnly: *[]*string,
	S3Prefix: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.rdsExportTask.RdsExportTaskTimeouts,
}
```
