...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/rdsexporttask"
...
&rdsexporttask.RdsExportTaskConfig {
	...
	ExportOnly: *[]*string,
	S3Prefix: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v19.rdsExportTask.RdsExportTaskTimeouts,
}
```
