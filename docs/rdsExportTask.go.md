...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/rdsexporttask"
...
&rdsexporttask.RdsExportTaskConfig {
	...
	Region: *string,
	S3Prefix: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.rdsExportTask.RdsExportTaskTimeouts,
}
```
