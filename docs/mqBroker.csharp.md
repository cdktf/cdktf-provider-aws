...
```csharp
private void ResetDataReplicationMode()
```
...
```csharp
private void ResetDataReplicationPrimaryBrokerArn()
```
...
MqBroker.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBroker.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
```csharp
public string PendingDataReplicationMode { get; }
```
...
```csharp
public string DataReplicationModeInput { get; }
```
...
```csharp
public string DataReplicationPrimaryBrokerArnInput { get; }
```
...
```csharp
public string DataReplicationMode { get; }
```
...
```csharp
public string DataReplicationPrimaryBrokerArn { get; }
```
...
new MqBrokerConfig {
    ...
    string DataReplicationMode = null,
    string DataReplicationPrimaryBrokerArn = null,
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerConfig.property.applyImmediately">ApplyImmediately</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#apply_immediately MqBroker#apply_immediately}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerConfig.property.autoMinorVersionUpgrade">AutoMinorVersionUpgrade</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#auto_minor_version_upgrade MqBroker#auto_minor_version_upgrade}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerConfig.property.publiclyAccessible">PubliclyAccessible</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#publicly_accessible MqBroker#publicly_accessible}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerConfig.property.tags">Tags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#tags MqBroker#tags}. |
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerConfig.property.tagsAll">TagsAll</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#tags_all MqBroker#tags_all}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerConfiguration.property.revision">Revision</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#revision MqBroker#revision}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerEncryptionOptions.property.useAwsOwnedKey">UseAwsOwnedKey</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#use_aws_owned_key MqBroker#use_aws_owned_key}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerLdapServerMetadata.property.roleSearchSubtree">RoleSearchSubtree</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#role_search_subtree MqBroker#role_search_subtree}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerLdapServerMetadata.property.userSearchSubtree">UserSearchSubtree</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#user_search_subtree MqBroker#user_search_subtree}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerLogs.property.general">General</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#general MqBroker#general}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerUser.property.consoleAccess">ConsoleAccess</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#console_access MqBroker#console_access}. |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerUser.property.replicationUser">ReplicationUser</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.94.0/docs/resources/mq_broker#replication_user MqBroker#replication_user}. |
...
```csharp
public object ReplicationUser { get; set; }
```
...
```csharp
private void ResetReplicationUser()
```
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerUserOutputReference.property.replicationUserInput">ReplicationUserInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.mqBroker.MqBrokerUserOutputReference.property.replicationUser">ReplicationUser</a></code> | <code>object</code> | *No description.* |
...
```csharp
public object ReplicationUserInput { get; }
```
...
```csharp
public object ReplicationUser { get; }
```
