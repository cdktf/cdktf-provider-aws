...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/cloudsearchdomainserviceaccesspolicy"
...
&cloudsearchdomainserviceaccesspolicy.CloudsearchDomainServiceAccessPolicyConfig {
	...
	DomainName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.cloudsearchDomainServiceAccessPolicy.CloudsearchDomainServiceAccessPolicyTimeouts,
}
```
