...
Refer to the Terraform Registory for docs: [`aws_ec2_transit_gateway_policy_table_association`](https://registry.terraform.io/providers/hashicorp/aws/5.16.2/docs/resources/ec2_transit_gateway_policy_table_association).
