...
new DynamodbContributorInsights(Construct Scope, string Id, DynamodbContributorInsightsConfig Config);
```
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.importFrom">ImportFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.resetMode">ResetMode</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.resetRegion">ResetRegion</a></code> | *No description.* |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.addMoveTarget"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.hasResourceMove"></a>

```csharp
private object HasResourceMove()
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.importFrom"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.moveFromId"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.moveTo"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.moveTo.parameter.moveTarget"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.moveToId"></a>
...
```csharp
private void PutTimeouts(DynamodbContributorInsightsTimeouts Value)
```
...
##### `ResetMode` <a name="ResetMode" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.resetMode"></a>

```csharp
private void ResetMode()
```

##### `ResetRegion` <a name="ResetRegion" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a DynamodbContributorInsights resource upon running "cdktf plan <stack-name>". |
...
DynamodbContributorInsights.IsConstruct(object X);
```
...
DynamodbContributorInsights.IsTerraformElement(object X);
```
...
DynamodbContributorInsights.IsTerraformResource(object X);
```
...
DynamodbContributorInsights.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
###### `ImportToId`<sup>Required</sup> <a name="ImportToId" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.generateConfigForImport.parameter.importToId"></a>
...
###### `ImportFromId`<sup>Required</sup> <a name="ImportFromId" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.cdktfStack">CdktfStack</a></code> | <code>HashiCorp.Cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>HashiCorp.Cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.count">Count</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.modeInput">ModeInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.regionInput">RegionInput</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.timeoutsInput">TimeoutsInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.mode">Mode</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.region">Region</a></code> | <code>string</code> | *No description.* |
...
```csharp
public DynamodbContributorInsightsTimeoutsOutputReference Timeouts { get; }
```
...
##### `ModeInput`<sup>Optional</sup> <a name="ModeInput" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.modeInput"></a>
...
##### `RegionInput`<sup>Optional</sup> <a name="RegionInput" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsights.property.regionInput"></a>
...
new DynamodbContributorInsightsConfig {
    ...
    string Mode = null,
    string Region = null,
    DynamodbContributorInsightsTimeouts Timeouts = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.connection">Connection</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.count">Count</a></code> | <code>object</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.dependsOn">DependsOn</a></code> | <code>HashiCorp.Cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.forEach">ForEach</a></code> | <code>HashiCorp.Cdktf.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.lifecycle">Lifecycle</a></code> | <code>HashiCorp.Cdktf.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.provider">Provider</a></code> | <code>HashiCorp.Cdktf.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.provisioners">Provisioners</a></code> | <code>object[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.tableName">TableName</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/dynamodb_contributor_insights#table_name DynamodbContributorInsights#table_name}. |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.0/docs/resources/dynamodb_contributor_insights#id DynamodbContributorInsights#id}. |
...
```csharp
public DynamodbContributorInsightsTimeouts Timeouts { get; set; }
```
...
new DynamodbContributorInsightsTimeouts {
    string Create = null,
    string Delete = null
};
```
...
new DynamodbContributorInsightsTimeoutsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsTimeoutsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>HashiCorp.Cdktf.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsTimeoutsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktf/provider-aws.dynamodbContributorInsights.DynamodbContributorInsightsTimeoutsOutputReference.property.internalValue">InternalValue</a></code> | <code>object</code> | *No description.* |
