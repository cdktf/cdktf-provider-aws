...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/transcribemedicalvocabulary"
...
&transcribemedicalvocabulary.TranscribeMedicalVocabularyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.transcribeMedicalVocabulary.TranscribeMedicalVocabularyTimeouts,
}
```
