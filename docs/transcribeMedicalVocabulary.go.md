...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/transcribemedicalvocabulary"
...
&transcribemedicalvocabulary.TranscribeMedicalVocabularyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.transcribeMedicalVocabulary.TranscribeMedicalVocabularyTimeouts,
}
```
