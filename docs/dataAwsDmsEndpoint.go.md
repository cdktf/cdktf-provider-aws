...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsdmsendpoint"
...
| <code><a href="#@cdktf/provider-aws.dataAwsDmsEndpoint.DataAwsDmsEndpointConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.11.0/docs/data-sources/dms_endpoint#tags DataAwsDmsEndpoint#tags}. |
