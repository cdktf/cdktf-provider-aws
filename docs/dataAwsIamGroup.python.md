...
| <code><a href="#@cdktf/provider-aws.dataAwsIamGroup.DataAwsIamGroup.Initializer.parameter.groupName">group_name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/iam_group#group_name DataAwsIamGroup#group_name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsIamGroup.DataAwsIamGroup.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/iam_group#id DataAwsIamGroup#id}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsIamGroup.DataAwsIamGroupConfig.property.groupName">group_name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/iam_group#group_name DataAwsIamGroup#group_name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsIamGroup.DataAwsIamGroupConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.55.0/docs/data-sources/iam_group#id DataAwsIamGroup#id}. |
