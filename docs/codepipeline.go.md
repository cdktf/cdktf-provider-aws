...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/codepipeline"
...
&codepipeline.CodepipelineArtifactStore {
	Location: *string,
	Type: *string,
	EncryptionKey: github.com/cdktf/cdktf-provider-aws-go/aws/v15.codepipeline.CodepipelineArtifactStoreEncryptionKey,
	Region: *string,
}
```
