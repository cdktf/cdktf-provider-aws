...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/dbeventsubscription"
...
&dbeventsubscription.DbEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.dbEventSubscription.DbEventSubscriptionTimeouts,
}
```
