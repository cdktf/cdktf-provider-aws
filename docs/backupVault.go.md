...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/backupvault"
...
&backupvault.BackupVaultConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.backupVault.BackupVaultTimeouts,
}
```
