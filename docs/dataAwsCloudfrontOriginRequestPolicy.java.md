...
Refer to the Terraform Registory for docs: [`data_aws_cloudfront_origin_request_policy`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/data-sources/cloudfront_origin_request_policy).
