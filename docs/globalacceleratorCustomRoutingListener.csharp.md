...
Refer to the Terraform Registory for docs: [`aws_globalaccelerator_custom_routing_listener`](https://registry.terraform.io/providers/hashicorp/aws/5.20.0/docs/resources/globalaccelerator_custom_routing_listener).
