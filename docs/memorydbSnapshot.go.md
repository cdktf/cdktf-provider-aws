...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/memorydbsnapshot"
...
&memorydbsnapshot.MemorydbSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.memorydbSnapshot.MemorydbSnapshotTimeouts,
}
```
