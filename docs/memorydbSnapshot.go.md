...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/memorydbsnapshot"
...
&memorydbsnapshot.MemorydbSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.memorydbSnapshot.MemorydbSnapshotTimeouts,
}
```
