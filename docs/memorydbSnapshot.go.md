...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/memorydbsnapshot"
...
&memorydbsnapshot.MemorydbSnapshotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v16.memorydbSnapshot.MemorydbSnapshotTimeouts,
}
```
