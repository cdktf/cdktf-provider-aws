...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/networkmanagerdevice"
...
&networkmanagerdevice.NetworkmanagerDeviceConfig {
	...
	AwsLocation: github.com/cdktf/cdktf-provider-aws-go/aws/v13.networkmanagerDevice.NetworkmanagerDeviceAwsLocation,
	Description: *string,
	Id: *string,
	Location: github.com/cdktf/cdktf-provider-aws-go/aws/v13.networkmanagerDevice.NetworkmanagerDeviceLocation,
	Model: *string,
	SerialNumber: *string,
	SiteId: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.networkmanagerDevice.NetworkmanagerDeviceTimeouts,
	Type: *string,
	Vendor: *string,
}
```
