...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/datazoneglossaryterm"
...
&datazoneglossaryterm.DatazoneGlossaryTermConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.datazoneGlossaryTerm.DatazoneGlossaryTermTimeouts,
}
```
