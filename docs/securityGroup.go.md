...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/securitygroup"
...
&securitygroup.SecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.securityGroup.SecurityGroupTimeouts,
	VpcId: *string,
}
```
