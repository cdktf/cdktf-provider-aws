...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/securitygroup"
...
&securitygroup.SecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.securityGroup.SecurityGroupTimeouts,
	VpcId: *string,
}
```
