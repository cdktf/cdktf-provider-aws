...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/timestreaminfluxdbdbinstance"
...
&timestreaminfluxdbdbinstance.TimestreaminfluxdbDbInstanceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.timestreaminfluxdbDbInstance.TimestreaminfluxdbDbInstanceTimeouts,
}
```
