...
| <code><a href="#@cdktf/provider-aws.dataAwsDbParameterGroup.DataAwsDbParameterGroup.Initializer.parameter.name">name</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/data-sources/db_parameter_group#name DataAwsDbParameterGroup#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsDbParameterGroup.DataAwsDbParameterGroup.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/data-sources/db_parameter_group#id DataAwsDbParameterGroup#id}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsDbParameterGroup.DataAwsDbParameterGroupConfig.property.name">name</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/data-sources/db_parameter_group#name DataAwsDbParameterGroup#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsDbParameterGroup.DataAwsDbParameterGroupConfig.property.id">id</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.58.0/docs/data-sources/db_parameter_group#id DataAwsDbParameterGroup#id}. |
