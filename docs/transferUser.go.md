...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/transferuser"
...
&transferuser.TransferUserConfig {
	...
	Id: *string,
	Policy: *string,
	PosixProfile: github.com/cdktf/cdktf-provider-aws-go/aws/v17.transferUser.TransferUserPosixProfile,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v17.transferUser.TransferUserTimeouts,
}
```
