...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/emrcontainersvirtualcluster"
...
&emrcontainersvirtualcluster.EmrcontainersVirtualClusterConfig {
	...
	ContainerProvider: github.com/cdktf/cdktf-provider-aws-go/aws/v15.emrcontainersVirtualCluster.EmrcontainersVirtualClusterContainerProvider,
	Name: *string,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.emrcontainersVirtualCluster.EmrcontainersVirtualClusterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.emrcontainersVirtualCluster.EmrcontainersVirtualClusterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/emrcontainers_virtual_cluster#tags EmrcontainersVirtualCluster#tags}. |
| <code><a href="#@cdktf/provider-aws.emrcontainersVirtualCluster.EmrcontainersVirtualClusterConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/resources/emrcontainers_virtual_cluster#tags_all EmrcontainersVirtualCluster#tags_all}. |
...
&emrcontainersvirtualcluster.EmrcontainersVirtualClusterContainerProvider {
	Id: *string,
	Info: github.com/cdktf/cdktf-provider-aws-go/aws/v15.emrcontainersVirtualCluster.EmrcontainersVirtualClusterContainerProviderInfo,
	Type: *string,
}
```
...
&emrcontainersvirtualcluster.EmrcontainersVirtualClusterContainerProviderInfo {
	EksInfo: github.com/cdktf/cdktf-provider-aws-go/aws/v15.emrcontainersVirtualCluster.EmrcontainersVirtualClusterContainerProviderInfoEksInfo,
}
```
