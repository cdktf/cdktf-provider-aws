...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/emrcontainersvirtualcluster"
...
&emrcontainersvirtualcluster.EmrcontainersVirtualClusterConfig {
	...
	ContainerProvider: github.com/cdktf/cdktf-provider-aws-go/aws/v12.emrcontainersVirtualCluster.EmrcontainersVirtualClusterContainerProvider,
	Name: *string,
	Id: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.emrcontainersVirtualCluster.EmrcontainersVirtualClusterTimeouts,
}
```
...
&emrcontainersvirtualcluster.EmrcontainersVirtualClusterContainerProvider {
	Id: *string,
	Info: github.com/cdktf/cdktf-provider-aws-go/aws/v12.emrcontainersVirtualCluster.EmrcontainersVirtualClusterContainerProviderInfo,
	Type: *string,
}
```
...
&emrcontainersvirtualcluster.EmrcontainersVirtualClusterContainerProviderInfo {
	EksInfo: github.com/cdktf/cdktf-provider-aws-go/aws/v12.emrcontainersVirtualCluster.EmrcontainersVirtualClusterContainerProviderInfoEksInfo,
}
```
