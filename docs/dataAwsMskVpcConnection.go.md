...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/dataawsmskvpcconnection"
...
| <code><a href="#@cdktf/provider-aws.dataAwsMskVpcConnection.DataAwsMskVpcConnectionConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.99.1/docs/data-sources/msk_vpc_connection#tags DataAwsMskVpcConnection#tags}. |
