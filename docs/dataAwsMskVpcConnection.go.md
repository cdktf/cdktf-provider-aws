...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v19/dataawsmskvpcconnection"
...
| <code><a href="#@cdktf/provider-aws.dataAwsMskVpcConnection.DataAwsMskVpcConnectionConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.32.0/docs/data-sources/msk_vpc_connection#tags DataAwsMskVpcConnection#tags}. |
