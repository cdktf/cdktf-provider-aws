...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/eipdomainname"
...
&eipdomainname.EipDomainNameConfig {
	...
	AllocationId: *string,
	DomainName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.eipDomainName.EipDomainNameTimeouts,
}
```
