...
```csharp
public DataAwsSsoadminApplicationProvidersApplicationProvidersDisplayData InternalValue { get; }
```
...
```csharp
public DataAwsSsoadminApplicationProvidersApplicationProviders InternalValue { get; }
```
