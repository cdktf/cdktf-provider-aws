...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v18/ssoadminaccountassignment"
...
&ssoadminaccountassignment.SsoadminAccountAssignmentConfig {
	...
	Id: *string,
	TargetType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v18.ssoadminAccountAssignment.SsoadminAccountAssignmentTimeouts,
}
```
