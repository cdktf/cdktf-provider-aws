...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v17/dataawsmqbroker"
...
| <code><a href="#@cdktf/provider-aws.dataAwsMqBroker.DataAwsMqBrokerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.14.0/docs/data-sources/mq_broker#tags DataAwsMqBroker#tags}. |
