...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/vpcblockpublicaccessoptions"
...
&vpcblockpublicaccessoptions.VpcBlockPublicAccessOptionsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.vpcBlockPublicAccessOptions.VpcBlockPublicAccessOptionsTimeouts,
}
```
