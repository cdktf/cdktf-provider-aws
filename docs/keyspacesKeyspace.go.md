...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/keyspaceskeyspace"
...
&keyspaceskeyspace.KeyspacesKeyspaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.keyspacesKeyspace.KeyspacesKeyspaceTimeouts,
}
```
