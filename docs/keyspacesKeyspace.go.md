...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/keyspaceskeyspace"
...
&keyspaceskeyspace.KeyspacesKeyspaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.keyspacesKeyspace.KeyspacesKeyspaceTimeouts,
}
```
