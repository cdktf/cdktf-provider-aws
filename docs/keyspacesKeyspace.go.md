...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/keyspaceskeyspace"
...
&keyspaceskeyspace.KeyspacesKeyspaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v13.keyspacesKeyspace.KeyspacesKeyspaceTimeouts,
}
```
