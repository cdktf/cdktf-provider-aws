...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2transitgateway"
...
&dataawsec2transitgateway.DataAwsEc2TransitGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2TransitGateway.DataAwsEc2TransitGatewayTimeouts,
}
```
