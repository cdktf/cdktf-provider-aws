...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/apigatewayv2authorizer"
...
&apigatewayv2authorizer.Apigatewayv2AuthorizerConfig {
	...
	JwtConfiguration: github.com/cdktf/cdktf-provider-aws-go/aws/v13.apigatewayv2Authorizer.Apigatewayv2AuthorizerJwtConfiguration,
}
```
