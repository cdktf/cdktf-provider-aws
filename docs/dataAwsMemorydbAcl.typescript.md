...
Refer to the Terraform Registory for docs: [`data_aws_memorydb_acl`](https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/memorydb_acl).
...
| <code><a href="#@cdktf/provider-aws.dataAwsMemorydbAcl.DataAwsMemorydbAclConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/memorydb_acl#name DataAwsMemorydbAcl#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsMemorydbAcl.DataAwsMemorydbAclConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/memorydb_acl#id DataAwsMemorydbAcl#id}. |
| <code><a href="#@cdktf/provider-aws.dataAwsMemorydbAcl.DataAwsMemorydbAclConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.67.0/docs/data-sources/memorydb_acl#tags DataAwsMemorydbAcl#tags}. |
