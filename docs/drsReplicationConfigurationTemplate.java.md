...
##### `stagingAreaTags`<sup>Optional</sup> <a name="stagingAreaTags" id="@cdktf/provider-aws.drsReplicationConfigurationTemplate.DrsReplicationConfigurationTemplate.Initializer.parameter.stagingAreaTags"></a>
...
```java
public void resetStagingAreaTags()
```
