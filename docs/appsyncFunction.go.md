...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/appsyncfunction"
...
&appsyncfunction.AppsyncFunctionConfig {
	...
	Runtime: github.com/cdktf/cdktf-provider-aws-go/aws/v13.appsyncFunction.AppsyncFunctionRuntime,
	SyncConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.appsyncFunction.AppsyncFunctionSyncConfig,
}
```
...
&appsyncfunction.AppsyncFunctionSyncConfig {
	...
	LambdaConflictHandlerConfig: github.com/cdktf/cdktf-provider-aws-go/aws/v13.appsyncFunction.AppsyncFunctionSyncConfigLambdaConflictHandlerConfig,
}
```
