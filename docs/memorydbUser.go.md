...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/memorydbuser"
...
| <code><a href="#@cdktf/provider-aws.memorydbUser.MemorydbUser.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&memorydbuser.MemorydbUserConfig {
	...
	AccessString: *string,
	AuthenticationMode: github.com/cdktf/cdktf-provider-aws-go/aws/v20.memorydbUser.MemorydbUserAuthenticationMode,
	UserName: *string,
	Id: *string,
...
| <code><a href="#@cdktf/provider-aws.memorydbUser.MemorydbUserConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.memorydbUser.MemorydbUserConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/memorydb_user#tags MemorydbUser#tags}. |
| <code><a href="#@cdktf/provider-aws.memorydbUser.MemorydbUserConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.100.0/docs/resources/memorydb_user#tags_all MemorydbUser#tags_all}. |
