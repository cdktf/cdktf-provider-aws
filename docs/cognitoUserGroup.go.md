...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/cognitousergroup"
...
| <code><a href="#@cdktf/provider-aws.cognitoUserGroup.CognitoUserGroupConfig.property.precedence">Precedence</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.66.1/docs/resources/cognito_user_group#precedence CognitoUserGroup#precedence}. |
