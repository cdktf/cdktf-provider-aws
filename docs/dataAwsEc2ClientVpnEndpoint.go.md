...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/dataawsec2clientvpnendpoint"
...
&dataawsec2clientvpnendpoint.DataAwsEc2ClientVpnEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.dataAwsEc2ClientVpnEndpoint.DataAwsEc2ClientVpnEndpointTimeouts,
}
```
