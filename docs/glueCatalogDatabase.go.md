...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/gluecatalogdatabase"
...
&gluecatalogdatabase.GlueCatalogDatabaseConfig {
	...
	TargetDatabase: github.com/cdktf/cdktf-provider-aws-go/aws/v15.glueCatalogDatabase.GlueCatalogDatabaseTargetDatabase,
}
```
...
&gluecatalogdatabase.GlueCatalogDatabaseCreateTableDefaultPermission {
	Permissions: *[]*string,
	Principal: github.com/cdktf/cdktf-provider-aws-go/aws/v15.glueCatalogDatabase.GlueCatalogDatabaseCreateTableDefaultPermissionPrincipal,
}
```
