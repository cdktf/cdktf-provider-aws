...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v13/gluecatalogdatabase"
...
&gluecatalogdatabase.GlueCatalogDatabaseConfig {
	...
	TargetDatabase: github.com/cdktf/cdktf-provider-aws-go/aws/v13.glueCatalogDatabase.GlueCatalogDatabaseTargetDatabase,
}
```
...
&gluecatalogdatabase.GlueCatalogDatabaseCreateTableDefaultPermission {
	Permissions: *[]*string,
	Principal: github.com/cdktf/cdktf-provider-aws-go/aws/v13.glueCatalogDatabase.GlueCatalogDatabaseCreateTableDefaultPermissionPrincipal,
}
```
