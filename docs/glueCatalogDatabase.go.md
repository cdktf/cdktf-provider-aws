...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/gluecatalogdatabase"
...
&gluecatalogdatabase.GlueCatalogDatabaseConfig {
	...
	TargetDatabase: github.com/cdktf/cdktf-provider-aws-go/aws/v14.glueCatalogDatabase.GlueCatalogDatabaseTargetDatabase,
}
```
...
&gluecatalogdatabase.GlueCatalogDatabaseCreateTableDefaultPermission {
	Permissions: *[]*string,
	Principal: github.com/cdktf/cdktf-provider-aws-go/aws/v14.glueCatalogDatabase.GlueCatalogDatabaseCreateTableDefaultPermissionPrincipal,
}
```
