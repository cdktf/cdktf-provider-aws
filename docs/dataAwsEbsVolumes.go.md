...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v14/dataawsebsvolumes"
...
&dataawsebsvolumes.DataAwsEbsVolumesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v14.dataAwsEbsVolumes.DataAwsEbsVolumesTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsEbsVolumes.DataAwsEbsVolumesConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/4.64.0/docs/data-sources/ebs_volumes#tags DataAwsEbsVolumes#tags}. |
