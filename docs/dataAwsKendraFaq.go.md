...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v16/dataawskendrafaq"
...
| <code><a href="#@cdktf/provider-aws.dataAwsKendraFaq.DataAwsKendraFaqConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/5.12.0/docs/data-sources/kendra_faq#tags DataAwsKendraFaq#tags}. |
