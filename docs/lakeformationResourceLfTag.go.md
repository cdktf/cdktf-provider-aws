...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/lakeformationresourcelftag"
...
&lakeformationresourcelftag.LakeformationResourceLfTagConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.lakeformationResourceLfTag.LakeformationResourceLfTagTimeouts,
}
```
