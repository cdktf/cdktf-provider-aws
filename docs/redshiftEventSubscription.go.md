...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v15/redshifteventsubscription"
...
&redshifteventsubscription.RedshiftEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v15.redshiftEventSubscription.RedshiftEventSubscriptionTimeouts,
}
```
