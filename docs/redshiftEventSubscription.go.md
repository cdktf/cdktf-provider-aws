...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v20/redshifteventsubscription"
...
&redshifteventsubscription.RedshiftEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v20.redshiftEventSubscription.RedshiftEventSubscriptionTimeouts,
}
```
