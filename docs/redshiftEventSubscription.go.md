...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v12/redshifteventsubscription"
...
&redshifteventsubscription.RedshiftEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v12.redshiftEventSubscription.RedshiftEventSubscriptionTimeouts,
}
```
